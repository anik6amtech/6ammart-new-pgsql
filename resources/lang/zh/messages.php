...
return array (
  ...
  'default' => '默认',
  'name' => '姓名',
  'ex_:_new_attribute' => '例如：新属性',
  'reset' => '重置',
  'submit' => '提交',
  'attribute_list' => '属性列表',
  'ex_:_attribute_name' => '例如：属性名称',
  'export' => '出口',
  'download' => '下载',
  'options' => '选项',
  'excel' => '卓越',
  ...
  'action' => '行动',
  'edit' => '编辑',
  'Want to delete this attribute ?' => '想要删除该属性吗？',
  'delete' => '删除',
  'Users' => '用户',
  'Transactions & Reports' => '交易和报告',
  'Settings' => '设置',
  'Monitor your business general settings from here' => '从这里监控您的业务常规设置',
  'System Module Setup' => '系统模块设置',
  'Zone Setup' => '区域设置',
  'Business Settings' => '业务设置',
  '3rd Party' => '第三方',
  'Social Media and Page Setup' => '社交媒体和页面设置',
  'View All' => '查看全部',
  'Dispatch Management' => '调度管理',
  'Modules Section' => '模块部分',
  'Select Module & Monitor your business module wise' => '选择模块并明智地监控您的业务模块',
  'add_new_module' => '添加新模块',
  'Turotial' => '教程',
  'Tour' => '旅游',
  'Search Menu...' => '搜索菜单...',
  'dashboard' => '仪表板',
  'employee_handle' => '员工句柄',
  'pos section' => '邮政部门',
  'New Sale' => '新品发售',
  ...
  'scheduled' => '预定的',
  'pending' => '待办的',
  'accepted_orders' => '已接受订单',
  'accepted' => '公认',
  'processing_orders' => '处理订单',
  'processing' => '加工',
  'order_on_the_way' => '途中订购',
  ...
  'admin' => '行政',
  'signin' => '登入',
  'welcome_back_login_to_your_panel' => '欢迎回到您的面板登录',
  'your_email' => '你的电子邮件',
  'Please_enter_a_valid_email_address.' => '请输入有效的电子邮件地址。',
  'password' => '密码',
  'password_length_placeholder' => '密码长度占位符',
  'invalid_password_warning' => '密码无效警告',
  'remember_me' => '记住账号',
  'Forget Password' => '忘记密码',
  'Enter recaptcha value' => '输入验证码值',
  'Send_Mail_to_Your_Email' => '发送邮件到您的邮箱',
  'A mail will be send to your registered email with a  link to change passowrd' => '一封邮件将发送到您注册的电子邮件地址，其中包含更改密码的链接',
  'Send Mail' => '发送邮件',
  'plesae_enter_your_registerd_email' => '请输入您的注册邮箱',
  'A mail has been sent to your registered email' => '邮件已发送至您注册的邮箱',
  'Click the link in the mail description to change password' => '点击邮件描述中的链接即可更改密码',
  ...
  'Grocery' => '杂货店',
  'Dashboard' => '仪表板',
  'Hello, Here You Can Manage Your' => '您好，在这里您可以管理您的',
  'orders by Zone.' => '按区域订购。',
  'All_Zones' => '所有区域',
  'This_Year' => '今年',
  'This_Month' => '本月',
  'This_Week' => '本星期',
  ...
  'Grocery Stores' => '杂货店',
  'customers' => '顾客',
  'unassigned_orders' => '未分配的订单',
  'Accepted by Delivery Man' => '送货员已接受',
  'Packaging' => '包装',
  'Out for Delivery' => '待发货',
  'Gross Sale' => '销售总额',
  'sale' => '销售',
  'This year' => '今年',
  'This month' => '本月',
  ...
  'sold' => '卖',
  'top rated' => '评价最高',
  'top_deliveryman' => '顶级送货员',
  'top_customers' => '顶级客户',
  'Orders' => '订单',
  'Customer' => '顾客',
  'Store' => '店铺',
  'Delivery man' => '送货员',
  'Admin Comission' => '行政委员会',
  'Delivery Comission' => '交割佣金',
  'all_orders' => '所有订单',
  'pending_orders' => '挂单',
  ...
  'all_categories' => '所有类别',
  'ex_:_search_here' => '例如：在这里搜索',
  'search_here' => '在这里搜索',
  'no_products_on_pos_search' => 'pos 搜索中没有产品',
  'billing_section' => '计费部分',
  ...
  'please_select_a_store_first' => '请先选择店铺',
  'print_invoice' => '打印发票',
  'Proceed, If thermal printer is ready.' => '如果热敏打印机已准备就绪，请继续。',
  'back' => '后退',
  ...
  'phone' => '电话',
  'with_country_code' => '带国家代码',
  'out_of_coverage' => '超出覆盖范围',
  'The Geolocation service failed' => '地理定位服务失败',
  'Your browser doesn`t support geolocation' => '您的浏览器不支持地理定位',
  'product_already_added_in_cart' => '产品已添加到购物车',
  'product_has_been_updated_in_cart' => '购物车中的产品已更新',
  'Sorry, product out of stock' => '抱歉，产品缺货',
  'Sorry, you can not add multiple stores data in same cart' => '抱歉，您无法在同一购物车中添加多个商店数据',
  'product_has_been_added_in_cart' => '产品已添加到购物车',
  'item_has_been_removed_from_cart' => '商品已从购物车中删除',
  'Sorry, the minimum value was reached' => '抱歉，已达到最小值',
  'Campaign List' => '活动列表',
  'campaign' => '活动',
  'add_new_campaign' => '添加新活动',
  'campaign_list' => '活动清单',
  'Ex:_Search Title ...' => '例如：搜索标题...',
  'download_options' => '下载选项',
  '#' => '#',
  'title' => '标题',
  'module' => '模块',
  'date_duration' => '日期持续时间',
  'time_duration' => '持续时间',
  'status' => '地位',
  'edit_campaign' => '编辑活动',
  'Want_to_delete_this_item' => '想要删除该项目',
  'delete_campaign' => '删除广告系列',
  'Ex:_Campaign title...' => '例如：活动标题...',
  'date' => '日期',
  'time' => '时间',
  'Want to delete this item ?' => '想要删除该项目吗？',
  'banner' => '横幅',
  ...
  'featured' => '精选',
  'edit_banner' => '编辑横幅',
  'Want to delete this banner ?' => '想要删除此横幅吗？',
  'delete_banner' => '删除横幅',
  'banner_added_successfully' => '横幅添加成功',
  'Add new coupon' => '添加新优惠券',
  'new_coupon' => '新优惠券',
  'coupon_type' => '优惠券类型',
  'zone_wise' => '区域明智',
  'free_delivery' => '免费送货',
  ...
  'expire_date' => '到期日期',
  'discount_type' => '折扣类型',
  'Currently you need to manage discount with the Restaurant.' => '目前您需要与餐厅管理折扣。',
  'max_discount' => '最大折扣',
  'min_purchase' => '最小购买量',
  'coupon_list' => '优惠券清单',
  'Ex:_Coupon Title' => '例如：优惠券标题',
  'total_uses' => '总使用量',
  'edit_coupon' => '编辑优惠券',
  'Want to delete this coupon ?' => '想要删除此优惠券吗？',
  'delete_coupon' => '删除优惠券',
  ...
  'search_notification' => '搜索通知',
  'tergat' => '特尔加特',
  'edit_notification' => '编辑通知',
  'Want to delete this notification ?' => '想要删除此通知吗？',
  'delete_notification' => '删除通知',
  'No Image' => '无图像',
  'you want to sent notification to' => '您想将通知发送至',
  'send' => '发送',
  'add_new_unit' => '添加新单位',
  'unit_name' => '单位名称',
  'unit_list' => '单位名单',
  'search_unit' => '搜寻单位',
  'unit' => '单元',
  'Want to delete this unit ?' => '想要删除这个单位吗？',
  'new_joining_requests' => '新加入请求',
  'pending_stores' => '待定商店',
  'denied_stores' => '被拒绝的商店',
  'ex_:_Search_Store_Name' => '例如：搜索商店名称',
  'search' => '搜索',
  'store_information' => '店铺信息',
  'owner_information' => '业主信息',
  'id' => 'ID',
  'approve' => '批准',
  'you_want_to_approve_this_application' => '您想要批准此申请',
  'deny' => '否定',
  'you_want_to_deny_this_application' => '您想拒绝此申请',
  'add_store_name' => '添加商店名称',
  'add_new_store' => '添加新商店',
  'Default' => '默认',
  'store_name' => '店铺名称',
  'address' => '地址',
  'Store Logo & Covers' => '商店标志和封面',
  'logo' => '标识',
  '1:1' => '1:1',
  'Store Cover' => '店铺封面',
  '2:1' => '2:1',
  'vat/tax' => '增值税/税',
  'Estimated Delivery Time ( Min & Maximum Time)' => '预计交货时间（最短和最长时间）',
  'Minimum Time' => '最短时间',
  'Ex :' => '前任 ：',
  'Maximum Time' => '最长时间',
  'minutes' => '分钟',
  ...
  'days' => '天',
  'done' => '完毕',
  'select_zone_for_map' => '选择地图区域',
  'latitude' => '纬度',
  'store_lat_lng_warning' => '存储 lat lng 警告',
  'Ex:' => '前任：',
  'longitude' => '经度',
  'search_your_location_here' => '在这里搜索您的位置',
  'account_information' => '账户信息',
  'Must_contain_at_least_one_number_and_one_uppercase_and_lowercase_letter_and_symbol,_and_at_least_8_or_more_characters' => '必须包含至少 1 个数字、1 个大小写字母和符号，以及至少 8 个或更多字符',
  'confirm_password' => '确认密码',
  'please_only_input_png_or_jpg_type_file' => '请仅输入 png 或 jpg 类型文件',
  'file_size_too_big' => '文件大小太大',
  'Store List' => '店铺列表',
  'total_stores' => '店铺总数',
  'active_stores' => '活跃商店',
  'inactive_stores' => '不活跃的商店',
  'newly_joined_stores' => '新加盟店铺',
  'total_transactions' => '交易总额',
  'commission_earned' => '赚取的佣金',
  'total_store_withdraws' => '商店提款总额',
  'you_want_to_change_this_store_status' => '您想要更改此商店状态',
  'view' => '看法',
  'edit_store' => '编辑商店',
  'You want to remove this store' => '您想要删除该商店',
  'delete_store' => '删除商店',
  'Store Bulk Import' => '商店批量导入',
  'stores_bulk_import' => '商店批量进口',
  'STEP 1' => '步骤1',
  'Download Excel File' => '下载Excel文件',
  'STEP 2' => '步骤2',
  'Match Spread sheet data according to instruction' => '根据指令匹配电子表格数据',
  'STEP 3' => '步骤3',
  'Validate data and complete import' => '验证数据并完成导入',
  'Instructions' => '指示',
  '1. Download the format file and fill it with proper data.' => '1. 下载格式文件并填写适当的数据。',
  '2. You can download the example file to understand how the data must be filled.' => '2. 您可以下载示例文件以了解如何填写数据。',
  '4. After uploading stores you need to edit them and set stores`s logo and cover.' => '4.上传商店后，您需要对其进行编辑并设置商店的标志和封面。',
  '5. You can get module id and  zone id from their list, please input the right ids.' => '5. 您可以从列表中获取模块ID和区域ID，请输入正确的ID。',
  '6. For delivery time the format is "from-to type" for example: "30-40 min". Also you can use days or hours as type. Please be carefull about this format or leave this field empty.' => '6. 对于交货时间，格式为“从-到”类型，例如：30-40 分钟。',
  '7. You can upload your store images in store folder from gallery, and copy image`s path.' => '7. 您可以从图库上传商店文件夹中的商店图像，并复制图像的路径。',
  '8. Default password for store is 12345678.' => '8. 商店默认密码为12345678。',
  '9. Latitude must be a number between -90 to 90 and Longitude must a number between -180 to 180. Otherwise it will create server error' => '9. 纬度必须是-90到90之间的数字，经度必须是-180到180之间的数字。否则会导致服务器错误',
  'Download Spreadsheet Template' => '下载电子表格模板',
  'Template with Existing Data' => '具有现有数据的模板',
  'Template without Data' => '没有数据的模板',
  'Import Stores File' => '导入商店文件',
  'Choose File' => '选择文件',
  'Clear' => '清除',
  'update' => '更新',
  'Import' => '进口',
  'You_want_to_' => '你想要',
  'Cancelled' => '取消',
  'restaurant_bulk_export' => '餐厅批量出口',
  'export_stores' => '出口商店',
  'Select Data Type' => '选择数据类型',
  'Select Data Range and Export' => '选择数据范围并导出',
  'select_type' => '选择类型',
  'all_data' => '所有数据',
  'date_wise' => '明智的日期',
  'id_wise' => '本我明智',
  ...
  'clear' => '清除',
  'User Overview' => '用户概览',
  'Hello,_here_you_can_manage_your_users_by_zone.' => '您好，这里您可以按区域管理您的用户。',
  'total_customer' => '客户总数',
  ...
  'Neutral' => '中性的',
  'Negetive' => '消极的',
  'Deliveryman Statistics' => '送货员统计',
  'active_delivery_man' => '主动送货员',
  'newly_joined_delivery_man' => '新加入送货员',
  'inactive_deliveryman' => '不活跃的送货员',
  'Currently Active Delivery Men' => '目前活跃的送货员',
  'Search Delivery Man ...' => '搜索送货员...',
  'View All Delivery Men' => '查看所有送货员',
  'New_Customer_Growth' => '新客户增长',
  'modules' => '模块',
  'deliveryman_section' => '送货员部分',
  'deliveryman_management' => '送货员管理',
  'vehicles_category' => '车辆类别',
  'add_delivery_man' => '添加送货员',
  'new_delivery_man' => '新送货员',
  'deliveryman_list' => '送货员名单',
  'reviews' => '评论',
  'customer_section' => '客户部分',
  'customer_management' => '客户管理',
  'customer_wallet' => '客户钱包',
  'add_fund' => '添加资金',
  'report' => '报告',
  'bonus' => '奖金',
  'customer_loyalty_point' => '客户忠诚度点',
  'subscribed_emails' => '订阅的电子邮件',
  'subscribed_mail_list' => '订阅的邮件列表',
  ...
  'Ex_:_Search_by_type...' => '例如：按类型搜索...',
  'Type' => '类型',
  'minimum_coverage_area' => '最小覆盖面积',
  'km' => '公里',
  'Maximum_coverage_area' => '最大覆盖面积',
  'Extra_charges' => '额外费用',
  'edit_vehicle' => '编辑车辆',
  'delete_vehicle' => '删除车辆',
  ...
  'deliveryman_type' => '送货员类型',
  'freelancer' => '自由职业者',
  'salary_based' => '基于工资',
  'Vehicle' => '车辆',
  'select_vehicle' => '选择车辆',
  'deliveryman_image' => '送货员形象',
  'identity_type' => '身份类型',
  'passport' => '护照',
  ...
  'pending_delivery_man' => '等待送货员',
  'denied_deliveryman' => '拒绝送货员',
  'ex_: search_delivery_man' => '例如：寻找送货员',
  'contact_info' => '联系方式',
  'total_orders' => '订单总数',
  'availability_status' => '可用性状态',
  'currently_assigned_orders' => '当前分配的订单',
  'active_status' => '活跃状态',
  'Delivery Man Preview' => '送货员预览',
  'deliveryman_preview' => '送货员预览',
  'want_to_enable_earnings' => '想要实现盈利',
  'want_to_disable_earnings' => '想要禁用收入',
  'Vehicle Information' => '车辆信息',
  'Vehicle_Type' => '车辆类型',
  'Vehicle_Extra_Charges' => '车辆附加费',
  'Vehicle_minimum_coverage_area' => '车辆最小覆盖面积',
  'Vehicle_maximum_coverage_area' => '车辆最大覆盖面积',
  'excellent' => '出色的',
  'good' => '好的',
  'average' => '平均的',
  ...
  'deliverymen' => '送货员',
  'ex_:_search_name' => '例如：搜索名称',
  'online' => '在线的',
  'Want to remove this deliveryman ?' => '想删除这个送货员吗？',
  'offline' => '离线',
  'info' => '信息',
  'transaction' => '交易',
  'conversations' => '对话',
  'total_delivered_orders' => '已交付订单总数',
  'cash_in_hand' => '手头现金',
  'total_earning' => '总收入',
  'you_want_to_suspend_this_deliveryman' => '您想暂停该送货员的工作',
  'suspend_this_delivery_man' => '暂停该送货员的职务',
  'Employee List' => '员工名单',
  'Employee_table' => '员工表',
  'Role' => '角色',
  'edit_Employee' => '编辑员工',
  'Want_to_delete_this_role' => '想要删除这个角色',
  'delete_Employee' => '删除员工',
  'Employee Add' => '员工地址',
  'add_new_employee' => '添加新员工',
  'select_Role' => '选择角色',
  'Employee Edit' => '员工编辑',
  'Employee_update' => '员工动态',
  'custom_role' => '自定义角色',
  'role_name' => '角色名称',
  'role_name_example' => '角色名称示例',
  'module_permission' => '模块权限',
  'select_all' => '选择全部',
  'collect_Cash' => '收取现金',
  'attribute' => '属性',
  'coupon' => '优惠券',
  'provide_dm_earning' => '提供DM收入',
  'order' => '命令',
  'withdraw_list' => '撤回名单',
  'parcel' => '包裹',
  'pos' => '位置',
  'roles_table' => '角色表',
  'ex_:_search_role_name' => 'ex : 搜索角色名称',
  'created_at' => '创建于',
  'edit_role' => '编辑角色',
  'delete_role' => '删除角色',
  'account' => '帐户',
  'provide dm earning' => '提供DM收入',
  'withdraw list' => '撤回名单',
  ...
  'Select All' => '选择全部',
  'collect_cash' => '收取现金',
  'Contact Messages' => '联系方式 留言',
  'all_message_lists' => '所有消息列表',
  'message_lists' => '消息列表',
  'ex_:_message_name' => '例如：消息名称',
  'subject' => '主题',
  'Seen/Unseen' => '见过/没见过',
  'Subscribed Emails' => '订阅的电子邮件',
  'ex_:_search_email' => '例如：搜索电子邮件',
  'customer_loyalty_point_report' => '客户忠诚度点报告',
  'filter_options' => '过滤选项',
  'select_transaction_type' => '选择交易类型',
  'point_to_wallet' => '指向钱包',
  'order_place' => '订购地点',
  'filter' => '筛选',
  'summary' => '概括',
  'debit' => '借方',
  ...
  'customer_wallet_report' => '客户钱包报告',
  'add_fund_by_admin' => '由管理员添加资金',
  'add_fund_by_customer' => '按客户添加资金',
  'refund_order' => '退款单',
  'admin_bonus' => '管理员奖金',
...
Smartly or Earn. ',
  ...
  'Service Module Dashboard' => 'Service Module Dashboard',
  ...
  'Brand_Logo' => 'Brand Logo',
  'the_current_level_setup_automatically_assigns_drivers_the_default_level_upon_their_initial_app_login' => 'The current level setup automatically assigns drivers the default level upon their initial app login',
  'Add_New_Brand' => 'Add New Brand',
  'Total_Brands' => 'Total Brands',
  'The brand logo must be a file of type: png.' => 'The brand logo must be a file of type: png.',
  ...
  'The model image must be a file of type: png.' => 'The model image must be a file of type: png.',
  ...
  'ride_cancellation_reason_(max_255_character)' => 'Ride cancellation reason (max 255 character)',
  ...
  'here_you_can_set_predefine_question_that_driver_when_send_message' => 'Here you can set predefine question that driver when send message',
  'Minimum_Delay_Time' => 'Minimum Delay Time',
  'After_Ride_Complete' => 'After Ride Complete',
  'if_toggle_on,_after_complete_a_ride_within_a_certain_time_customer_and_drive_can_use_safety_feature.' => 'If toggle on, after complete a ride within a certain time customer and drive can use safety feature.',
  ...
  'if_the_toggle_is_turned_on,_customer_will_notify_if_their_requested_weight_exceeds_the_capacity,' => 'If the toggle is turned on, customer will notify if their requested weight exceeds the capacity,',
  ...
  'no.Time_Period' => 'No.Time Period',
  'no._of_total_redirection' => 'No. of total redirection',
  ...
  '_of_total_redirection' => ' of total redirection',
  ...
  'The customer level coupon type field is required.' => 'The customer level coupon type field is required.',
  'The customer coupon type field is required.' => 'The customer coupon type field is required.',
  'The category coupon type field is required.' => 'The category coupon type field is required.',
  'The amount type field is required.' => 'The amount type field is required.',
  'The coupon field is required.' => 'The coupon field is required.',
  'The start date field is required.' => 'The start date field is required.',
  'The coupon code has already been taken.' => 'The coupon code has already been taken.',
  ...
  'The image must be a file of type: png, jpg, jpeg, webp.' => 'The image must be a file of type: png, jpg, jpeg, webp.',
  'The min trip amount field is required.' => 'The min trip amount field is required.',
  ...
  'Minimum Booking amount' => 'Minimum Booking amount',
  '03/05/2025 - 03/08/2025' => '03/05/2025 - 03/08/2025',
  ...
  'type_banner_name' => 'Type banner name',
  'banner_title' => 'Banner title',
  'type_banner_title' => 'Type banner title',
  'redirect_link' => 'Redirect link',
  'want_to_delete_this' => 'Want to delete this',
  'resource_type' => 'Resource type',
  'The banner title must be a string.' => 'The banner title must be a string.',
  'The selected resource type is invalid.' => 'The selected resource type is invalid.',
  ...
  'Banner successfully updated' => 'Banner successfully updated',
  ...
  'JPG,_JPEG,_PNG_Less_Than_1MB' => 'JPG, JPEG, PNG Less Than 1MB',
  'click_to_upload' => 'Click to upload',
  ...
  'Select your preferable zone for this category' => 'Select your preferable zone for this category',
  ...
  'If_you_turn_off_this_status,_it_won’t_show_as_featured_on_user_app' => 'If you turn off this status, it won’t show as featured on user app',
  'If_you_turn_on_this_status,_it_will_show_as_featured_on_user_app.' => 'If you turn on this status, it will show as featured on user app.',
  'By_Turning_OFF_category_featured!' => 'By Turning OFF category featured!',
  'By_Turning_ON_category_featured!' => 'By Turning ON category featured!',
  'Sub category count' => 'Sub category count',
  'Successfully updated' => 'Successfully updated',
  'Excel' => 'Excel',
  'Category name' => 'Category name',
  ...
  'Select your preferable category for this sub-category' => 'Select your preferable category for this sub-category',
  'Select Category' => 'Select Category',
  'subcategory_setup' => 'Subcategory setup',
  'Sub Category List' => 'Sub Category List',
  'sub_category_name' => 'Sub category name',
  'The parent id field is required.' => 'The parent id field is required.',
  'The parent id must be a valid UUID.' => 'The parent id must be a valid UUID.',
  ...
  'Select Tax Service' => 'Select Tax Service',
  'default_price' => 'Default price',
  'Service Tags' => 'Service Tags',
  'Minimum Bidding Price ($)' => 'Minimum Bidding Price ($)',
  'Service Tax' => 'Service Tax',
  'Select service category first' => 'Select service category first',
  'Choose Service Sub Category' => 'Choose Service Sub Category',
  'Select service categories' => 'Select service categories',
  'Choose Service Category' => 'Choose Service Category',
  ...
  'Variation price must be greater than 0' => 'Variation price must be greater than 0',
  'Variation price is required' => 'Variation price is required',
  ...
  'By_Turning_OFF_service!' => 'By Turning OFF service!',
  'By_Turning_ON_service!' => 'By Turning ON service!',
  ...
  'The variants field is required.' => 'The variants field is required.',
  'already_exist' => 'Already exist',
  'You_can_add_multiple_variations' => 'You can add multiple variations',
  ...
  'Want_to_enable_update_vehicle_approval_status_for_this_store?' => 'Want to enable update vehicle approval status for this store?',
  'Want_to_disable_update_vehicle_approval_status_for_this_store?' => 'Want to disable update vehicle approval status for this store?',
  ...
  'When rider update a existing vehicle which info need admin approval.' => 'When rider update a existing vehicle which info need admin approval.',
  'Do you want to turn ON rider review?' => 'Do you want to turn ON rider review?',
  'Do you want to turn OFF rider review?' => 'Do you want to turn OFF rider review?',
  'Do you want to turn ON rider self registration?' => 'Do you want to turn ON rider self registration?',
  'Do you want to turn ON rider verification?' => 'Do you want to turn ON rider verification?',
  'Do you want to turn OFF rider self registration?' => 'Do you want to turn OFF rider self registration?',
  'Do you want to turn OFF rider verification?' => 'Do you want to turn OFF rider verification?',
  ...
  'hour' => 'Hour',
  'second' => 'Second',
  'When_this_field_is_active_user_can_cancel_an_order_with_proper_reason' => 'When this field is active user can cancel an order with proper reason',
  ...
  'The cancellation type field is required.' => 'The cancellation type field is required.',
  ...
  'here_you_can_set_the_reasons_that_customers_choose_when_refund_a_parcel.' => 'Here you can set the reasons that customers choose when refund a parcel.',
  ...
  'The reason for whom field is required.' => 'The reason for whom field is required.',
  'Safety Precaution updated successfully' => 'Safety Precaution updated successfully',
  'safety_precaution' => 'Safety precaution',
  'Rider Can Earn Loyalty Point' => 'Rider Can Earn Loyalty Point',
  'dm_loyalty_point_status' => 'Dm loyalty point status',
  'Rider will see loyalty point option in his profile settings & can earn & convert this point to wallet money' => 'Rider will see loyalty point option in his profile settings & can earn & convert this point to wallet money',
  'Rider will not see loyalty point option from his profile settings' => 'Rider will not see loyalty point option from his profile settings',
  'active_rider_level' => 'Active rider level',
  'Rider_Setup' => 'Rider Setup',
  'rider' => 'Rider',
  'Tips_for_Rider' => 'Tips for Rider',
  'Customer_can_give_tips_to_rider_during_checkout_from_the_customer_app_&_website._From_this,_admin_has_no_commission.' => 'Customer can give tips to rider during checkout from the customer app & website. From this, admin has no commission.',
  ...
  'Rider_Self_Registration?' => 'Rider Self Registration?',
  'If_you_enable_this,_users_can_register_as_Riders_from_the_Customer_App,_Website_or_Rider_App_or_Admin_Landing_Page.' => 'If you enable this, users can register as Riders from the Customer App, Website or Rider App or Admin Landing Page.',
  ...
  'Can_A_Rider_Cancel_Order?' => 'Can A Rider Cancel Order?',
  'Admin_can_enable/disable_Rider’s_order_cancellation_option_in_the_respective_app.' => 'Admin can enable/disable Rider’s order cancellation option in the respective app.',
  'Rider_Man_Maximum_Cash_in_Hand' => 'Rider Man Maximum Cash in Hand',
  'Rider_Maximum_Cash_in_Hand' => 'Rider Maximum Cash in Hand',
  ...
  'bicycle' => 'Bicycle',
  'category_Image' => 'Category Image',
  'total_categorys' => 'Total categorys',
  'total_categories' => 'Total categories',
  ...
  'ride' => 'Ride',
  'The extra charges field is required.' => 'The extra charges field is required.',
  'The starting coverage area field is required.' => 'The starting coverage area field is required.',
  'The maximum coverage area field is required.' => 'The maximum coverage area field is required.',
  'The extra charges must be a number.' => 'The extra charges must be a number.',
  'The starting coverage area must be a number.' => 'The starting coverage area must be a number.',
  'The maximum coverage area must be a number.' => 'The maximum coverage area must be a number.',
  'The maximum coverage area must be between 0.01 and 999999999999.99.' => 'The maximum coverage area must be between 0.01 and 999999999999.99.',
  'The maximum coverage area must be greater than starting coverage area.' => 'The maximum coverage area must be greater than starting coverage area.',
  ...
  'identity_information' => 'Identity information',
  'serve_for' => 'Serve for',
  'select_a_vehicle_category' => 'Select a vehicle category',
  'Update Rider' => 'Update Rider',
  'update_rider' => 'Update rider',
  'The serve for field is required.' => 'The serve for field is required.',
  ...
  'The licence plate number field is required.' => 'The licence plate number field is required.',
  'Safety Alert on Ride List' => 'Safety Alert on Ride List',
  'SUV' => 'SUV',
  'Mini' => 'Mini',
  'Bike' => 'Bike',
  ...
  'minimum_bidding_price' => 'Minimum bidding price',
  ...
  'By_Turning_OFF_faq!' => 'By Turning OFF faq!',
  'By_Turning_ON_faq!' => 'By Turning ON faq!',
  'FAQ status updated successfully' => 'FAQ status updated successfully',
  'Create Campaign' => 'Create Campaign',
  'campaign_name' => 'Campaign name',
  'image_formats' => 'Image formats',
  'thumbnail_image' => 'Thumbnail image',
  'The thumbnail must be a file of type: png, jpg, jpeg, gif.' => 'The thumbnail must be a file of type: png, jpg, jpeg, gif.',
  ...
  'Update Campaign' => 'Update Campaign',
  'successfully updated' => 'Successfully updated',
  'unlimited_vehicle_add' => 'Unlimited vehicle add',
  'add_new_service_provider' => 'Add new service provider',
  'add_new_provider' => 'Add new provider',
  'business_basic_setup' => 'Business basic setup',
  'business_plan_setup' => 'Business plan setup',
  'vendor_logo_and_covers' => 'Vendor logo and covers',
  'english_en' => 'English en',
  'arabic_ar' => 'Arabic ar',
  'name_default' => 'Name default',
  'auto_focus_car_service' => 'Auto focus car service',
  'address_default' => 'Address default',
  'house_road_city' => 'House road city',
  'business_phone_number' => 'Business phone number',
  'jpg_jpeg_png_1mb_ratio_1_1' => 'Jpg jpeg png 1mb ratio 1 1',
  'cover_image' => 'Cover image',
  'jpg_jpeg_png_1mb_ratio_3_1' => 'Jpg jpeg png 1mb ratio 3 1',
  'business_info' => 'Business info',
  'Basundhara' => 'Basundhara',
  'approx_service_time' => 'Approx service time',
  ...
  'identity_documents' => 'Identity documents',
  'pdf_doc_jpg_file_size_max_2_mb' => 'Pdf doc jpg file size max 2 mb',
  'choose_business_plan' => 'Choose business plan',
  'commission_base' => 'Commission base',
  'you_have_to_give_a_certain_percentage_of_commission_to_admin_for_every_trip_request' => 'You have to give a certain percentage of commission to admin for every trip request',
  'subscription_base' => 'Subscription base',
  'you_have_to_pay_certain_amount_in_every_month_year_to_admin_as_subscription_fee' => 'You have to pay certain amount in every month year to admin as subscription fee',
  'choose_subscription_package' => 'Choose subscription package',
  'free_support_24_7' => 'Free support 24 7',
  'databases' => 'Databases',
  'monthly_trip' => 'Monthly trip',
  'vehicle_add' => 'Vehicle add',
  'standared' => 'Standared',
  'premium' => 'Premium',
  'unlimited_trip' => 'Unlimited trip',
  'ratio_3_1' => 'Ratio 3 1',
  'ratio_3/1' => 'Ratio 3/1',
  'JPG, JPEG, PNG Less Than 1 MB' => 'JPG, JPEG, PNG Less Than 1 MB',
  'Select_Identity_Type' => 'Select Identity Type',
  'Passport' => 'Passport',
  ...
  'demo.pdf' => 'Demo.pdf',
  'The brand logo must not be greater than 1024 kilobytes.' => 'The brand logo must not be greater than 1024 kilobytes.',
  'Edit Vehicle' => 'Edit Vehicle',
  'The rider id has already been taken.' => 'The rider id has already been taken.',
  'driver_name' => 'Driver name',
  'vin_number' => 'Vin number',
  'Approved' => 'Approved',
  ...
  'Ride_Fare_Setup_-_Zone_List' => 'Ride Fare Setup - Zone List',
  'search_by_zone_or_vechicle' => 'Search by zone or vechicle',
  ...
  'fares' => 'Fares',
  'Available_vehicles_in_this_zone' => 'Available vehicles in this zone',
  'The_following_vehicles_are_currently_assigned_to_this_zone_for_regular_Ride.__You_may_modify_vehicle_availability_for_this_zone_as_needed' => 'The following vehicles are currently assigned to this zone for regular Ride.  You may modify vehicle availability for this zone as needed',
  'Base Fare' => 'Base Fare',
  'Per_km' => 'Per km',
  'Cancellation_Fee' => 'Cancellation Fee',
  'Minimum_Cancellation_Fee' => 'Minimum Cancellation Fee',
  ...
  'bidding' => 'Bidding',
  'Set_maximum_booking_request_&_subscription_limit_for_this_package' => 'Set maximum booking request & subscription limit for this package',
  'Maximum_Booking_Request_Limit' => 'Maximum Booking Request Limit',
  'Maximum_Service_Sub_Category_Limit' => 'Maximum Service Sub Category Limit',
  'Set_maximum_booking_request_&_sub_category_limit_for_this_package' => 'Set maximum booking request & sub category limit for this package',
  'Maximum_Order_Limit' => 'Maximum Order Limit',
  'Maximum_Product_Limit' => 'Maximum Product Limit',
  'booking_request' => 'Booking request',
  'service_sub_category_subscribe' => 'Service sub category subscribe',
  'unlimited_service_sub_category_subscribe' => 'Unlimited service sub category subscribe',
  'unlimited_booking_request' => 'Unlimited booking request',
  'Approx. Service Time' => 'Approx. Service Time',
  'identity_type_is_required' => 'Identity type is required',
  ...
  'Click to view The file' => 'Click to view The file',
  ': 02 Aug 2025' => ': 02 Aug 2025',
  ': 2351684567235' => ': 2351684567235',
  'TIN No.' => 'TIN No.',
  ': Vendor@companyname.com' => ': Vendor@companyname.com',
  ': +880 12365 58789' => ': +880 12365 58789',
  ': Kent' => ': Kent',
  ': Jonathan' => ': Jonathan',
  'Owner Information' => 'Owner Information',
  ': Main Demo Zone, Dhaka 1' => ': Main Demo Zone, Dhaka 1',
  ': +880 15324 56845' => ': +880 15324 56845',
  'Business Phone' => 'Business Phone',
  'General Information' => 'General Information',
  'serviceman_list' => 'Serviceman list',
  'subscribed services' => 'Subscribed services',
  'Bookings' => 'Bookings',
  'The selected tab is invalid.' => 'The selected tab is invalid.',
  'All Services' => 'All Services',
  'bookings' => 'Bookings',
  'example text' => 'Example text',
  'booking' => 'Booking',
  'provider_meta_image' => 'Provider meta image',
  'from each booking. You will get access of all the features and options  in Provider panel , app and interaction with user.' => 'From each booking. You will get access of all the features and options  in Provider panel , app and interaction with user.',
  ...
  'if_you_want_to_add_time_restriction_on_schedule_booking' => 'If you want to add time restriction on schedule booking',
  'has_demo_static_content' => 'Has demo static content',
  'otp_for_complete_service' => 'Otp for complete service',
  'see_other_providers_offers' => 'See other providers offers',
  'post_validation_days' => 'Post validation days',
  'day_placeholder' => 'Day placeholder',
  'maximum_booking_amount' => 'Maximum booking amount',
  ...
  'instant_booking' => 'Instant booking',
  'repeat_booking' => 'Repeat booking',
  'check_the_box' => 'Check the box',
  'business_settings_updated_successfully' => 'Business settings updated successfully',
  'providers_can_choose_service_location' => 'Providers can choose service location',
  'provider_minimum_payable_amount' => 'Provider minimum payable amount',
  'provider_maximum_booking_amount' => 'Provider maximum booking amount',
  ...
  'provider_subscription_base' => 'Provider subscription base',
  'provider_commission_base' => 'Provider commission base',
  'serviceman_edit_booking' => 'Serviceman edit booking',
  'edit_booking_req' => 'Edit booking req',
  ...
  'provider_suspend_on_exceed_cash_limit' => 'Provider suspend on exceed cash limit',
  ...
  'has_demo_static_content_need_to_update' => 'Has demo static content need to update',
  ...
  'Commission_per_booking' => 'Commission per booking',
  'unlimited_vehicle_Upload' => 'Unlimited vehicle Upload',
  'Unlimited_service_category' => 'Unlimited service category',
  ...
  'provider_login_url' => 'Provider login url',
  'Add_dynamic_url_to_secure_provider_login_access.' => 'Add dynamic url to secure provider login access.',
  'provider_login_page' => 'Provider login page',
  ...
  'You want to remove this serviceman' => 'You want to remove this serviceman',
  ' Insert the basic information of the serviceman ' => ' Insert the basic information of the serviceman ',
  'create_new_advertisement' => 'Create new advertisement',
  'advertisement_list' => 'Advertisement list',
  'advertisements' => 'Advertisements',
  'promotion_management' => 'Promotion management',
  'Help & Support' => 'Help & Support',
  'customized_request' => 'Customized request',
  'booking_management' => 'Booking management',
  'total_bookings' => 'Total bookings',
  'Create New Serviceman' => 'Create New Serviceman',
  'all_servicemen_list' => 'All servicemen list',
  'add_serviceman' => 'Add serviceman',
  'serviceman_info' => 'Serviceman info',
  'Edit Serviceman' => 'Edit Serviceman',
  '8+ characters' => '8+ characters',
  'no_servicemen_found' => 'No servicemen found',
  'Invalid Serviceman' => 'Invalid Serviceman',
  ...
  'Unsubscribe to This Category' => 'Unsubscribe to This Category',
  'Subscribe to This Category' => 'Subscribe to This Category',
  ...
  'You want to unsubscribe this category' => 'You want to unsubscribe this category',
  'unsubscribe_category' => 'Unsubscribe category',
  'Unsubscribe from This Category' => 'Unsubscribe from This Category',
  'You want to subscribe this category' => 'You want to subscribe this category',
  'subscribe_category' => 'Subscribe category',
  'you_want_to_subscribe_this_category' => 'You want to subscribe this category',
  'subscribe' => 'Subscribe',
  'services_available' => 'Services available',
  'subscribe_to_this_category' => 'Subscribe to this category',
  'you_want_to_unsubscribe_this_category' => 'You want to unsubscribe this category',
  'unsubscribe' => 'Unsubscribe',
  'unsubscribe_from_this_category' => 'Unsubscribe from this category',
  'faq' => 'Faq',
  'all_services' => 'All services',
  'subscribed_subcategory' => 'Subscribed subcategory',
  'subscribe_unsubscribe' => 'Subscribe unsubscribe',
  'dashboard_image' => 'Dashboard image',
  'service_faqs' => 'Service faqs',
  'service_image' => 'Service image',
  'demo_static_content_warning' => 'Demo static content warning',
  'reviews_count' => 'Reviews count',
  'excel_icon' => 'Excel icon',
  'csv_icon' => 'Csv icon',
  'review_id' => 'Review id',
  'ratings' => 'Ratings',
  'reply' => 'Reply',
  ...
  'Suggest more services that are willing to book and help us make more efficient platform for
                            you.' => 'Suggest more services that are willing to book and help us make more efficient platform for
                            you.',
  'Select your preferable category' => 'Select your preferable category',
  'Service name' => 'Service name',
  'Shifting Service' => 'Shifting Service',
  ...
  'sfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt ser' => 'Sfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt ser',
  'Feedback' => 'Feedback',
  'dfafdadf rtretwetsfd fdgsrter retertsdfg rwert retwert ertwret' => 'Dfafdadf rtretwetsfd fdgsrter retertsdfg rwert retwert ertwret',
  'sfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt' => 'Sfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt sersfdgsdfgsdg dfgsdfg fdjurt',
  ...
  '(optional)' => '(optional)',
  'Give Feedback' => 'Give Feedback',
  'No Feedback Given' => 'No Feedback Given',
  'Feedback Given' => 'Feedback Given',
  'No data available' => 'No data available',
  'fdgsdfgrtretrtwrtt' => 'Fdgsdfgrtretrtwrtt',
  'fdsgdfg' => 'Fdsgdfg',
  'My Account' => 'My Account',
  'Contact_Person_Information' => 'Contact Person Information',
  'wow' => 'Wow',
  '4523453fgsf' => '4523453fgsf',
  'ffdggggggggggggggggggggg' => 'Ffdggggggggggggggggggggg',
  ...
  '43ertwert' => '43ertwert',
  'egfrsdfgsdg' => 'Egfrsdfgsdg',
  'fsdgfdg' => 'Fsdgfdg',
  'edgfgsdfggf' => 'Edgfgsdfggf',
  'Notification Channel Setup' => 'Notification Channel Setup',
  'Notification For You' => 'Notification For You',
  'Serviceman' => 'Serviceman',
  'Sl' => 'Sl',
  'sub test' => 'Sub test',
  'Turn_Off_SMS_for' => 'Turn Off SMS for',
  'Want to enable the SMS For' => 'Want to enable the SMS For',
  'No data found' => 'No data found',
  'Turn_On_SMS_for' => 'Turn On SMS for',
  'Provider Subscription' => 'Provider Subscription',
  'provider will pay' => 'Provider will pay',
  'from each order. You will get access of all the features and options  in provider panel , app and interaction with user.' => 'From each order. You will get access of all the features and options  in provider panel , app and interaction with user.',
  'Provider Subscription Transaction' => 'Provider Subscription Transaction',
  'Subscription_Transactions' => 'Subscription Transactions',
  'plan_type' => 'Plan type',
  'Provider Subscription Refund Transaction' => 'Provider Subscription Refund Transaction',
  'service_category' => 'Service category',
  'maximum_service_time' => 'Maximum service time',
  'max_20' => 'Max 20',
  'check_the_box_if_you_want_to_add_time_restriction_on_schedule_booking' => 'Check the box if you want to add time restriction on schedule booking',
  'select_servicemen_permissions' => 'Select servicemen permissions',
  'servicemen_permission' => 'Servicemen permission',
  'The service ids field is required.' => 'The service ids field is required.',
  'The service ids must be an array.' => 'The service ids must be an array.',
  ...
  'Ellison Cardenas Trading' => 'Ellison Cardenas Trading',
  'service_temporarily_closed' => 'Service temporarily closed',
  'vat_tax' => 'Vat tax',
  'ex_1' => 'Ex 1',
  'approximate_service_time' => 'Approximate service time',
  'min_10' => 'Min 10',
  'minimum_service_time' => 'Minimum service time',
  'choose_your_service_location' => 'Choose your service location',
  'select_service_location_option' => 'Select service location option',
  'go_to_customer_location' => 'Go to customer location',
  'customer_will_come_to_my_location' => 'Customer will come to my location',
  'Rhona Parks' => 'Rhona Parks',
  ...
  'By Turning ON Service' => 'By Turning ON Service',
  ...
  'Customized Booking Request Delete' => 'Customized Booking Request Delete',
  ...
  'Booking Edit Service Quantity Increase' => 'Booking Edit Service Quantity Increase',
  'Booking Edit Service Quantity Decrease' => 'Booking Edit Service Quantity Decrease',
  'Referral Earning First Booking' => 'Referral Earning First Booking',
  'Referral code used' => 'Referral code used',
  'customer notification for provider bid offer' => 'Customer notification for provider bid offer',
  'Customer notification for provider bid withdraw' => 'Customer notification for provider bid withdraw',
  'booking_place Message' => 'Booking place Message',
  'booking_accepted Message' => 'Booking accepted Message',
  'serviceman_assign Message' => 'Serviceman assign Message',
  'booking_ongoing Message' => 'Booking ongoing Message',
  'otp Message' => 'Otp Message',
  'booking_complete Message' => 'Booking complete Message',
  'booking_cancel Message' => 'Booking cancel Message',
  'booking_schedule_time_change Message' => 'Booking schedule time change Message',
  'add_fund_wallet Message' => 'Add fund wallet Message',
  'add_fund_wallet_bonus Message' => 'Add fund wallet bonus Message',
  'customized_booking_request Message' => 'Customized booking request Message',
  'customized_booking_request_delete Message' => 'Customized booking request delete Message',
  'offline_payment_approved Message' => 'Offline payment approved Message',
  'booking_edit_service_add Message' => 'Booking edit service add Message',
  'booking_edit_service_remove Message' => 'Booking edit service remove Message',
  'booking_edit_service_quantity_increase Message' => 'Booking edit service quantity increase Message',
  'booking_edit_service_quantity_decrease Message' => 'Booking edit service quantity decrease Message',
  'referral_earning Message' => 'Referral earning Message',
  'referral_earning_first_booking Message' => 'Referral earning first booking Message',
  'referral_code_used Message' => 'Referral code used Message',
  'loyalty_point Message' => 'Loyalty point Message',
  'refund Message' => 'Refund Message',
  'customer_notification_for_provider_bid_offer Message' => 'Customer notification for provider bid offer Message',
  'customer_notification_for_provider_bid_withdraw Message' => 'Customer notification for provider bid withdraw Message',
  'By Turning OFF' => 'By Turning OFF',
  'user_will_get_message_key_booking_place' => 'User will get message key booking place',
  'user_will_not_get_message_key_booking_place' => 'User will not get message key booking place',
  'user_will_get_message_key_booking_accepted' => 'User will get message key booking accepted',
  'user_will_not_get_message_key_booking_accepted' => 'User will not get message key booking accepted',
  'user_will_get_message_key_serviceman_assign' => 'User will get message key serviceman assign',
  'user_will_not_get_message_key_serviceman_assign' => 'User will not get message key serviceman assign',
  'user_will_get_message_key_booking_ongoing' => 'User will get message key booking ongoing',
  'user_will_not_get_message_key_booking_ongoing' => 'User will not get message key booking ongoing',
  'user_will_get_message_key_otp' => 'User will get message key otp',
  'user_will_not_get_message_key_otp' => 'User will not get message key otp',
  'user_will_get_message_key_booking_complete' => 'User will get message key booking complete',
  'user_will_not_get_message_key_booking_complete' => 'User will not get message key booking complete',
  'user_will_get_message_key_booking_cancel' => 'User will get message key booking cancel',
  'user_will_not_get_message_key_booking_cancel' => 'User will not get message key booking cancel',
  'user_will_get_message_key_booking_schedule_time_change' => 'User will get message key booking schedule time change',
  'user_will_not_get_message_key_booking_schedule_time_change' => 'User will not get message key booking schedule time change',
  'user_will_get_message_key_add_fund_wallet' => 'User will get message key add fund wallet',
  'user_will_not_get_message_key_add_fund_wallet' => 'User will not get message key add fund wallet',
  'user_will_get_message_key_add_fund_wallet_bonus' => 'User will get message key add fund wallet bonus',
  'user_will_not_get_message_key_add_fund_wallet_bonus' => 'User will not get message key add fund wallet bonus',
  'user_will_get_message_key_customized_booking_request' => 'User will get message key customized booking request',
  'user_will_not_get_message_key_customized_booking_request' => 'User will not get message key customized booking request',
  'user_will_get_message_key_customized_booking_request_delete' => 'User will get message key customized booking request delete',
  'user_will_not_get_message_key_customized_booking_request_delete' => 'User will not get message key customized booking request delete',
  'user_will_get_message_key_offline_payment_approved' => 'User will get message key offline payment approved',
  'user_will_not_get_message_key_offline_payment_approved' => 'User will not get message key offline payment approved',
  'user_will_get_message_key_booking_edit_service_add' => 'User will get message key booking edit service add',
  'user_will_not_get_message_key_booking_edit_service_add' => 'User will not get message key booking edit service add',
  'user_will_get_message_key_booking_edit_service_remove' => 'User will get message key booking edit service remove',
  'user_will_not_get_message_key_booking_edit_service_remove' => 'User will not get message key booking edit service remove',
  'user_will_get_message_key_booking_edit_service_quantity_increase' => 'User will get message key booking edit service quantity increase',
  'user_will_not_get_message_key_booking_edit_service_quantity_increase' => 'User will not get message key booking edit service quantity increase',
  'user_will_get_message_key_booking_edit_service_quantity_decrease' => 'User will get message key booking edit service quantity decrease',
  'user_will_not_get_message_key_booking_edit_service_quantity_decrease' => 'User will not get message key booking edit service quantity decrease',
  'user_will_get_message_key_referral_earning' => 'User will get message key referral earning',
  'user_will_not_get_message_key_referral_earning' => 'User will not get message key referral earning',
  'user_will_get_message_key_referral_earning_first_booking' => 'User will get message key referral earning first booking',
  'user_will_not_get_message_key_referral_earning_first_booking' => 'User will not get message key referral earning first booking',
  'user_will_get_message_key_referral_code_used' => 'User will get message key referral code used',
  'user_will_not_get_message_key_referral_code_used' => 'User will not get message key referral code used',
  'user_will_get_message_key_loyalty_point' => 'User will get message key loyalty point',
  'user_will_not_get_message_key_loyalty_point' => 'User will not get message key loyalty point',
  'user_will_get_message_key_refund' => 'User will get message key refund',
  'user_will_not_get_message_key_refund' => 'User will not get message key refund',
  'user_will_get_message_key_customer_notification_for_provider_bid_offer' => 'User will get message key customer notification for provider bid offer',
  'user_will_not_get_message_key_customer_notification_for_provider_bid_offer' => 'User will not get message key customer notification for provider bid offer',
  'user_will_get_message_key_customer_notification_for_provider_bid_withdraw' => 'User will get message key customer notification for provider bid withdraw',
  'user_will_not_get_message_key_customer_notification_for_provider_bid_withdraw' => 'User will not get message key customer notification for provider bid withdraw',
  'User will get a clear message to know that the booking_place' => 'User will get a clear message to know that the booking place',
  'User cannot get a clear message to know that the booking_place' => 'User cannot get a clear message to know that the booking place',
  'User will get a clear message to know that the booking_accepted' => 'User will get a clear message to know that the booking accepted',
  'User cannot get a clear message to know that the booking_accepted' => 'User cannot get a clear message to know that the booking accepted',
  'User will get a clear message to know that the serviceman_assign' => 'User will get a clear message to know that the serviceman assign',
  'User cannot get a clear message to know that the serviceman_assign' => 'User cannot get a clear message to know that the serviceman assign',
  'User will get a clear message to know that the booking_ongoing' => 'User will get a clear message to know that the booking ongoing',
  'User cannot get a clear message to know that the booking_ongoing' => 'User cannot get a clear message to know that the booking ongoing',
  'User will get a clear message to know that the otp' => 'User will get a clear message to know that the otp',
  'User cannot get a clear message to know that the otp' => 'User cannot get a clear message to know that the otp',
  'User will get a clear message to know that the booking_complete' => 'User will get a clear message to know that the booking complete',
  'User cannot get a clear message to know that the booking_complete' => 'User cannot get a clear message to know that the booking complete',
  'User will get a clear message to know that the booking_cancel' => 'User will get a clear message to know that the booking cancel',
  'User cannot get a clear message to know that the booking_cancel' => 'User cannot get a clear message to know that the booking cancel',
  'User will get a clear message to know that the booking_schedule_time_change' => 'User will get a clear message to know that the booking schedule time change',
  'User cannot get a clear message to know that the booking_schedule_time_change' => 'User cannot get a clear message to know that the booking schedule time change',
  'User will get a clear message to know that the add_fund_wallet' => 'User will get a clear message to know that the add fund wallet',
  'User cannot get a clear message to know that the add_fund_wallet' => 'User cannot get a clear message to know that the add fund wallet',
  'User will get a clear message to know that the add_fund_wallet_bonus' => 'User will get a clear message to know that the add fund wallet bonus',
  'User cannot get a clear message to know that the add_fund_wallet_bonus' => 'User cannot get a clear message to know that the add fund wallet bonus',
  'User will get a clear message to know that the customized_booking_request' => 'User will get a clear message to know that the customized booking request',
  'User cannot get a clear message to know that the customized_booking_request' => 'User cannot get a clear message to know that the customized booking request',
  'User will get a clear message to know that the customized_booking_request_delete' => 'User will get a clear message to know that the customized booking request delete',
  'User cannot get a clear message to know that the customized_booking_request_delete' => 'User cannot get a clear message to know that the customized booking request delete',
  'User will get a clear message to know that the offline_payment_approved' => 'User will get a clear message to know that the offline payment approved',
  'User cannot get a clear message to know that the offline_payment_approved' => 'User cannot get a clear message to know that the offline payment approved',
  'User will get a clear message to know that the booking_edit_service_add' => 'User will get a clear message to know that the booking edit service add',
  'User cannot get a clear message to know that the booking_edit_service_add' => 'User cannot get a clear message to know that the booking edit service add',
  'User will get a clear message to know that the booking_edit_service_remove' => 'User will get a clear message to know that the booking edit service remove',
  'User cannot get a clear message to know that the booking_edit_service_remove' => 'User cannot get a clear message to know that the booking edit service remove',
  'User will get a clear message to know that the booking_edit_service_quantity_increase' => 'User will get a clear message to know that the booking edit service quantity increase',
  'User cannot get a clear message to know that the booking_edit_service_quantity_increase' => 'User cannot get a clear message to know that the booking edit service quantity increase',
  'User will get a clear message to know that the booking_edit_service_quantity_decrease' => 'User will get a clear message to know that the booking edit service quantity decrease',
  'User cannot get a clear message to know that the booking_edit_service_quantity_decrease' => 'User cannot get a clear message to know that the booking edit service quantity decrease',
  'User will get a clear message to know that the referral_earning' => 'User will get a clear message to know that the referral earning',
  'User cannot get a clear message to know that the referral_earning' => 'User cannot get a clear message to know that the referral earning',
  'User will get a clear message to know that the referral_earning_first_booking' => 'User will get a clear message to know that the referral earning first booking',
  'User cannot get a clear message to know that the referral_earning_first_booking' => 'User cannot get a clear message to know that the referral earning first booking',
  'User will get a clear message to know that the referral_code_used' => 'User will get a clear message to know that the referral code used',
  'User cannot get a clear message to know that the referral_code_used' => 'User cannot get a clear message to know that the referral code used',
  'User will get a clear message to know that the loyalty_point' => 'User will get a clear message to know that the loyalty point',
  'User cannot get a clear message to know that the loyalty_point' => 'User cannot get a clear message to know that the loyalty point',
  'User will get a clear message to know that the refund' => 'User will get a clear message to know that the refund',
  'User cannot get a clear message to know that the refund' => 'User cannot get a clear message to know that the refund',
  'User will get a clear message to know that the customer_notification_for_provider_bid_offer' => 'User will get a clear message to know that the customer notification for provider bid offer',
  'User cannot get a clear message to know that the customer_notification_for_provider_bid_offer' => 'User cannot get a clear message to know that the customer notification for provider bid offer',
  'User will get a clear message to know that the customer_notification_for_provider_bid_withdraw' => 'User will get a clear message to know that the customer notification for provider bid withdraw',
  'User cannot get a clear message to know that the customer_notification_for_provider_bid_withdraw' => 'User cannot get a clear message to know that the customer notification for provider bid withdraw',
  'Messages For Customer' => 'Messages For Customer',
  'Customer Notification' => 'Customer Notification',
  'New Service Request Arrived' => 'New Service Request Arrived',
  'new_service_request_arrived Message' => 'New service request arrived Message',
  'User will get a clear message to know that the new_service_request_arrived' => 'User will get a clear message to know that the new service request arrived',
  'User cannot get a clear message to know that the new_service_request_arrived' => 'User cannot get a clear message to know that the new service request arrived',
  'Ongoing Booking' => 'Ongoing Booking',
  'ongoing_booking Message' => 'Ongoing booking Message',
  'User will get a clear message to know that the ongoing_booking' => 'User will get a clear message to know that the ongoing booking',
  'User cannot get a clear message to know that the ongoing_booking' => 'User cannot get a clear message to know that the ongoing booking',
  'Provider Bid Request Denied' => 'Provider Bid Request Denied',
  'provider_bid_request_denied Message' => 'Provider bid request denied Message',
  'User will get a clear message to know that the provider_bid_request_denied' => 'User will get a clear message to know that the provider bid request denied',
  'User cannot get a clear message to know that the provider_bid_request_denied' => 'User cannot get a clear message to know that the provider bid request denied',
  'Withdraw Request Approve' => 'Withdraw Request Approve',
  'widthdraw_request_approve Message' => 'Widthdraw request approve Message',
  'User will get a clear message to know that the widthdraw_request_approve' => 'User will get a clear message to know that the widthdraw request approve',
  'User cannot get a clear message to know that the widthdraw_request_approve' => 'User cannot get a clear message to know that the widthdraw request approve',
  'Withdraw Request Deny' => 'Withdraw Request Deny',
  'widthdraw_request_deny Message' => 'Widthdraw request deny Message',
  'User will get a clear message to know that the widthdraw_request_deny' => 'User will get a clear message to know that the widthdraw request deny',
  'User cannot get a clear message to know that the widthdraw_request_deny' => 'User cannot get a clear message to know that the widthdraw request deny',
  'Admin Payable' => 'Admin Payable',
  'admin_payable Message' => 'Admin payable Message',
  'User will get a clear message to know that the admin_payable' => 'User will get a clear message to know that the admin payable',
  'User cannot get a clear message to know that the admin_payable' => 'User cannot get a clear message to know that the admin payable',
  'Service Request Review' => 'Service Request Review',
  'service_request_approve Message' => 'Service request approve Message',
  'User will get a clear message to know that the service_request_approve' => 'User will get a clear message to know that the service request approve',
  'User cannot get a clear message to know that the service_request_approve' => 'User cannot get a clear message to know that the service request approve',
  'Service Request Reject' => 'Service Request Reject',
  'service_request_deny Message' => 'Service request deny Message',
  'User will get a clear message to know that the service_request_deny' => 'User will get a clear message to know that the service request deny',
  'User cannot get a clear message to know that the service_request_deny' => 'User cannot get a clear message to know that the service request deny',
  'Provider Suspend' => 'Provider Suspend',
  'provider_suspend Message' => 'Provider suspend Message',
  'User will get a clear message to know that the provider_suspend' => 'User will get a clear message to know that the provider suspend',
  'User cannot get a clear message to know that the provider_suspend' => 'User cannot get a clear message to know that the provider suspend',
  'Provider Suspension removed' => 'Provider Suspension removed',
  'provider_suspension_remove Message' => 'Provider suspension remove Message',
  'User will get a clear message to know that the provider_suspension_remove' => 'User will get a clear message to know that the provider suspension remove',
  'User cannot get a clear message to know that the provider_suspension_remove' => 'User cannot get a clear message to know that the provider suspension remove',
  'Advertisement Approved' => 'Advertisement Approved',
  'advertisement_approved Message' => 'Advertisement approved Message',
  'User will get a clear message to know that the advertisement_approved' => 'User will get a clear message to know that the advertisement approved',
  'User cannot get a clear message to know that the advertisement_approved' => 'User cannot get a clear message to know that the advertisement approved',
  'Advertisement Denied' => 'Advertisement Denied',
  'advertisement_denied Message' => 'Advertisement denied Message',
  'User will get a clear message to know that the advertisement_denied' => 'User will get a clear message to know that the advertisement denied',
  'User cannot get a clear message to know that the advertisement_denied' => 'User cannot get a clear message to know that the advertisement denied',
  'Advertisement Resumed' => 'Advertisement Resumed',
  'advertisement_resumed Message' => 'Advertisement resumed Message',
  'User will get a clear message to know that the advertisement_resumed' => 'User will get a clear message to know that the advertisement resumed',
  'User cannot get a clear message to know that the advertisement_resumed' => 'User cannot get a clear message to know that the advertisement resumed',
  'Advertisement Paused' => 'Advertisement Paused',
  'advertisement_paused Message' => 'Advertisement paused Message',
  'User will get a clear message to know that the advertisement_paused' => 'User will get a clear message to know that the advertisement paused',
  'User cannot get a clear message to know that the advertisement_paused' => 'User cannot get a clear message to know that the advertisement paused',
  'Advertisement Created By Admin' => 'Advertisement Created By Admin',
  'advertisement_created_by_admin Message' => 'Advertisement created by admin Message',
  'User will get a clear message to know that the advertisement_created_by_admin' => 'User will get a clear message to know that the advertisement created by admin',
  'User cannot get a clear message to know that the advertisement_created_by_admin' => 'User cannot get a clear message to know that the advertisement created by admin',
  'Provider Notification' => 'Provider Notification',
  'user_will_get_message_key_new_service_request_arrived' => 'User will get message key new service request arrived',
  'user_will_not_get_message_key_new_service_request_arrived' => 'User will not get message key new service request arrived',
  'user_will_get_message_key_ongoing_booking' => 'User will get message key ongoing booking',
  'user_will_not_get_message_key_ongoing_booking' => 'User will not get message key ongoing booking',
  'user_will_get_message_key_provider_bid_request_denied' => 'User will get message key provider bid request denied',
  'user_will_not_get_message_key_provider_bid_request_denied' => 'User will not get message key provider bid request denied',
  'user_will_get_message_key_widthdraw_request_approve' => 'User will get message key widthdraw request approve',
  'user_will_not_get_message_key_widthdraw_request_approve' => 'User will not get message key widthdraw request approve',
  'user_will_get_message_key_widthdraw_request_deny' => 'User will get message key widthdraw request deny',
  'user_will_not_get_message_key_widthdraw_request_deny' => 'User will not get message key widthdraw request deny',
  'user_will_get_message_key_admin_payable' => 'User will get message key admin payable',
  'user_will_not_get_message_key_admin_payable' => 'User will not get message key admin payable',
  'user_will_get_message_key_service_request_approve' => 'User will get message key service request approve',
  'user_will_not_get_message_key_service_request_approve' => 'User will not get message key service request approve',
  'user_will_get_message_key_service_request_deny' => 'User will get message key service request deny',
  'user_will_not_get_message_key_service_request_deny' => 'User will not get message key service request deny',
  'user_will_get_message_key_provider_suspend' => 'User will get message key provider suspend',
  'user_will_not_get_message_key_provider_suspend' => 'User will not get message key provider suspend',
  'user_will_get_message_key_provider_suspension_remove' => 'User will get message key provider suspension remove',
  'user_will_not_get_message_key_provider_suspension_remove' => 'User will not get message key provider suspension remove',
  'user_will_get_message_key_advertisement_approved' => 'User will get message key advertisement approved',
  'user_will_not_get_message_key_advertisement_approved' => 'User will not get message key advertisement approved',
  'user_will_get_message_key_advertisement_denied' => 'User will get message key advertisement denied',
  'user_will_not_get_message_key_advertisement_denied' => 'User will not get message key advertisement denied',
  'user_will_get_message_key_advertisement_resumed' => 'User will get message key advertisement resumed',
  'user_will_not_get_message_key_advertisement_resumed' => 'User will not get message key advertisement resumed',
  'user_will_get_message_key_advertisement_paused' => 'User will get message key advertisement paused',
  'user_will_not_get_message_key_advertisement_paused' => 'User will not get message key advertisement paused',
  'user_will_get_message_key_advertisement_created_by_admin' => 'User will get message key advertisement created by admin',
  'user_will_not_get_message_key_advertisement_created_by_admin' => 'User will not get message key advertisement created by admin',
  'Serviceman Notification' => 'Serviceman Notification',
  'Booking Schedule Time Change' => 'Booking Schedule Time Change',
  'P12' => 'P12',
  'trip_booking' => 'Trip booking',
  ...
  'trip_started Message' => 'Trip started Message',
  'user_will_get_message_key_trip_started' => 'User will get message key trip started',
  'user_will_not_get_message_key_trip_started' => 'User will not get message key trip started',
  'Your trip is completed.' => 'Your trip is completed.',
  'trip_completed Message' => 'Trip completed Message',
  'user_will_get_message_key_trip_completed' => 'User will get message key trip completed',
  'user_will_not_get_message_key_trip_completed' => 'User will not get message key trip completed',
  'Your trip is cancelled.' => 'Your trip is cancelled.',
  'trip_canceled Message' => 'Trip canceled Message',
  'user_will_get_message_key_trip_canceled' => 'User will get message key trip canceled',
  'user_will_not_get_message_key_trip_canceled' => 'User will not get message key trip canceled',
  'Trip request is paused.' => 'Trip request is paused.',
  'trip_paused Message' => 'Trip paused Message',
  'user_will_get_message_key_trip_paused' => 'User will get message key trip paused',
  'user_will_not_get_message_key_trip_paused' => 'User will not get message key trip paused',
  'Trip request is resumed.' => 'Trip request is resumed.',
  'trip_resumed Message' => 'Trip resumed Message',
  'user_will_get_message_key_trip_resumed' => 'User will get message key trip resumed',
  'user_will_not_get_message_key_trip_resumed' => 'User will not get message key trip resumed',
  'Another driver already accepted the trip request.' => 'Another driver already accepted the trip request.',
  'another_driver_assigned Message' => 'Another driver assigned Message',
  'user_will_get_message_key_another_driver_assigned' => 'User will get message key another driver assigned',
  'user_will_not_get_message_key_another_driver_assigned' => 'User will not get message key another driver assigned',
  'Driver accepted your trip request.' => 'Driver accepted your trip request.',
  'driver_on_the_way Message' => 'Driver on the way Message',
  'user_will_get_message_key_driver_on_the_way' => 'User will get message key driver on the way',
  'user_will_not_get_message_key_driver_on_the_way' => 'User will not get message key driver on the way',
  'Driver sent a bid request' => 'Driver sent a bid request',
  'bid_request_from_driver Message' => 'Bid request from driver Message',
  'user_will_get_message_key_bid_request_from_driver' => 'User will get message key bid request from driver',
  'user_will_not_get_message_key_bid_request_from_driver' => 'User will not get message key bid request from driver',
  'Driver has canceled your ride.' => 'Driver has canceled your ride.',
  'driver_canceled_ride_request Message' => 'Driver canceled ride request Message',
  'user_will_get_message_key_driver_canceled_ride_request' => 'User will get message key driver canceled ride request',
  'user_will_not_get_message_key_driver_canceled_ride_request' => 'User will not get message key driver canceled ride request',
  '{paidAmount} payment successful on this trip by {methodName}.' => '{paidAmount} payment successful on this trip by {methodName}.',
  'payment_successful Message' => 'Payment successful Message',
  'user_will_get_message_key_payment_successful' => 'User will get message key payment successful',
  'user_will_not_get_message_key_payment_successful' => 'User will not get message key payment successful',
  'Driver Notification' => 'Driver Notification',
  'You have a new ride request.' => 'You have a new ride request.',
  'new_ride_request Message' => 'New ride request Message',
  'user_will_get_message_key_new_ride_request' => 'User will get message key new ride request',
  'user_will_not_get_message_key_new_ride_request' => 'User will not get message key new ride request',
  'Customer confirmed your bid.' => 'Customer confirmed your bid.',
  'bid_accepted Message' => 'Bid accepted Message',
  'user_will_get_message_key_bid_accepted' => 'User will get message key bid accepted',
  'user_will_not_get_message_key_bid_accepted' => 'User will not get message key bid accepted',
  'A trip request is cancelled.' => 'A trip request is cancelled.',
  'trip_request_canceled Message' => 'Trip request canceled Message',
  'user_will_get_message_key_trip_request_canceled' => 'User will get message key trip request canceled',
  'user_will_not_get_message_key_trip_request_canceled' => 'User will not get message key trip request canceled',
  'Customer just declined a request.' => 'Customer just declined a request.',
  'customer_canceled_trip Message' => 'Customer canceled trip Message',
  'user_will_get_message_key_customer_canceled_trip' => 'User will get message key customer canceled trip',
  'user_will_not_get_message_key_customer_canceled_trip' => 'User will not get message key customer canceled trip',
  'Customer has canceled your bid request.' => 'Customer has canceled your bid request.',
  'bid_request_canceled_by_customer Message' => 'Bid request canceled by customer Message',
  'user_will_get_message_key_bid_request_canceled_by_customer' => 'User will get message key bid request canceled by customer',
  'user_will_not_get_message_key_bid_request_canceled_by_customer' => 'User will not get message key bid request canceled by customer',
  'Customer has given the tips {tipsAmount} with payment.' => 'Customer has given the tips {tipsAmount} with payment.',
  'tips_from_customer Message' => 'Tips from customer Message',
  'user_will_get_message_key_tips_from_customer' => 'User will get message key tips from customer',
  'user_will_not_get_message_key_tips_from_customer' => 'User will not get message key tips from customer',
  'Received a new bid request.' => 'Received a new bid request.',
  'received_new_bid Message' => 'Received new bid Message',
  'user_will_get_message_key_received_new_bid' => 'User will get message key received new bid',
  'user_will_not_get_message_key_received_new_bid' => 'User will not get message key received new bid',
  'We regret to inform you that your bid request for trip ID {tripId} has been rejected by the customer.' => 'We regret to inform you that your bid request for trip ID {tripId} has been rejected by the customer.',
  'customer_rejected_bid Message' => 'Customer rejected bid Message',
  'user_will_get_message_key_customer_rejected_bid' => 'User will get message key customer rejected bid',
  'user_will_not_get_message_key_customer_rejected_bid' => 'User will not get message key customer rejected bid',
  'Driver Registration Notification' => 'Driver Registration Notification',
  'Admin approved your registration. You can login now.' => 'Admin approved your registration. You can login now.',
  'registration_approved Message' => 'Registration approved Message',
  'user_will_get_message_key_registration_approved' => 'User will get message key registration approved',
  'user_will_not_get_message_key_registration_approved' => 'User will not get message key registration approved',
  'Your vehicle is approved by admin.' => 'Your vehicle is approved by admin.',
  'vehicle_request_approved Message' => 'Vehicle request approved Message',
  'user_will_get_message_key_vehicle_request_approved' => 'User will get message key vehicle request approved',
  'user_will_not_get_message_key_vehicle_request_approved' => 'User will not get message key vehicle request approved',
  'Your vehicle request is denied.' => 'Your vehicle request is denied.',
  'vehicle_request_denied Message' => 'Vehicle request denied Message',
  'user_will_get_message_key_vehicle_request_denied' => 'User will get message key vehicle request denied',
  'user_will_not_get_message_key_vehicle_request_denied' => 'User will not get message key vehicle request denied',
  'Your identity image update request is rejected.' => 'Your identity image update request is rejected.',
  'identity_image_rejected Message' => 'Identity image rejected Message',
  'user_will_get_message_key_identity_image_rejected' => 'User will get message key identity image rejected',
  'user_will_not_get_message_key_identity_image_rejected' => 'User will not get message key identity image rejected',
  'Your identity image update request is approved.' => 'Your identity image update request is approved.',
  'identity_image_approved Message' => 'Identity image approved Message',
  'user_will_get_message_key_identity_image_approved' => 'User will get message key identity image approved',
  'user_will_not_get_message_key_identity_image_approved' => 'User will not get message key identity image approved',
  'Your vehicle status has been activated by admin.' => 'Your vehicle status has been activated by admin.',
  'vehicle_active Message' => 'Vehicle active Message',
  'user_will_get_message_key_vehicle_active' => 'User will get message key vehicle active',
  'user_will_not_get_message_key_vehicle_active' => 'User will not get message key vehicle active',
  'Other Notification' => 'Other Notification',
  'Customer got discount of.' => 'Customer got discount of.',
  'coupon_applied Message' => 'Coupon applied Message',
  'user_will_get_message_key_coupon_applied' => 'User will get message key coupon applied',
  'user_will_not_get_message_key_coupon_applied' => 'User will not get message key coupon applied',
  'Customer removed previously applied coupon.' => 'Customer removed previously applied coupon.',
  'coupon_removed Message' => 'Coupon removed Message',
  'user_will_get_message_key_coupon_removed' => 'User will get message key coupon removed',
  'user_will_not_get_message_key_coupon_removed' => 'User will not get message key coupon removed',
  ...
  'review_from_customer Message' => 'Review from customer Message',
  'user_will_get_message_key_review_from_customer' => 'User will get message key review from customer',
  'user_will_not_get_message_key_review_from_customer' => 'User will not get message key review from customer',
  ...
  'review_from_driver Message' => 'Review from driver Message',
  'user_will_get_message_key_review_from_driver' => 'User will get message key review from driver',
  'user_will_not_get_message_key_review_from_driver' => 'User will not get message key review from driver',
  ...
  'someone_used_your_code Message' => 'Someone used your code Message',
  'user_will_get_message_key_someone_used_your_code' => 'User will get message key someone used your code',
  'user_will_not_get_message_key_someone_used_your_code' => 'User will not get message key someone used your code',
  'You\'ve successfully received {referralRewardAmount} reward. You can use this amount on your next ride.' => 'You ve successfully received {referralRewardAmount} reward. You can use this amount on your next ride.',
  'referral_reward_received Message' => 'Referral reward received Message',
  'user_will_get_message_key_referral_reward_received' => 'User will get message key referral reward received',
  'user_will_not_get_message_key_referral_reward_received' => 'User will not get message key referral reward received',
  'Safety Alert Sent.' => 'Safety Alert Sent.',
  'safety_alert_sent Message' => 'Safety alert sent Message',
  'user_will_get_message_key_safety_alert_sent' => 'User will get message key safety alert sent',
  'user_will_not_get_message_key_safety_alert_sent' => 'User will not get message key safety alert sent',
  'Safety Problem Resolved.' => 'Safety Problem Resolved.',
  'safety_problem_resolved Message' => 'Safety problem resolved Message',
  'user_will_get_message_key_safety_problem_resolved' => 'User will get message key safety problem resolved',
  ...
  'terms_and_conditions_updated Message' => 'Terms and conditions updated Message',
  'user_will_get_message_key_terms_and_conditions_updated' => 'User will get message key terms and conditions updated',
  'user_will_not_get_message_key_terms_and_conditions_updated' => 'User will not get message key terms and conditions updated',
  'Admin just updated our privacy policy.' => 'Admin just updated our privacy policy.',
  'privacy_policy_updated Message' => 'Privacy policy updated Message',
  'user_will_get_message_key_privacy_policy_updated' => 'User will get message key privacy policy updated',
  'user_will_not_get_message_key_privacy_policy_updated' => 'User will not get message key privacy policy updated',
  'We have updated our legal.' => 'We have updated our legal.',
  'legal_updated Message' => 'Legal updated Message',
  'user_will_get_message_key_legal_updated' => 'User will get message key legal updated',
  'user_will_not_get_message_key_legal_updated' => 'User will not get message key legal updated',
  'You got a new message from {userName}.' => 'You got a new message from {userName}.',
  'new_message Message' => 'New message Message',
  'user_will_get_message_key_new_message' => 'User will get message key new message',
  'user_will_not_get_message_key_new_message' => 'User will not get message key new message',
  'You got a new message from admin.' => 'You got a new message from admin.',
  'admin_message Message' => 'Admin message Message',
  'user_will_get_message_key_admin_message' => 'User will get message key admin message',
  'user_will_not_get_message_key_admin_message' => 'User will not get message key admin message',
  'You have completed your challenges and reached level {levelName}.' => 'You have completed your challenges and reached level {levelName}.',
  ...
  'withdraw_request_settled Message' => 'Withdraw request settled Message',
  'user_will_get_message_key_withdraw_request_settled' => 'User will get message key withdraw request settled',
  'user_will_not_get_message_key_withdraw_request_settled' => 'User will not get message key withdraw request settled',
  'withdraw_request_reversed Message' => 'Withdraw request reversed Message',
  'user_will_get_message_key_withdraw_request_reversed' => 'User will get message key withdraw request reversed',
  'user_will_not_get_message_key_withdraw_request_reversed' => 'User will not get message key withdraw request reversed',
  'Trip Started' => 'Trip Started',
  'Trip Completed' => 'Trip Completed',
  'Trip Canceled' => 'Trip Canceled',
  'Trip Paused' => 'Trip Paused',
  'Trip Resumed' => 'Trip Resumed',
  'Another Driver Assigned' => 'Another Driver Assigned',
  'Driver On The Way' => 'Driver On The Way',
  'Bid Request From Driver' => 'Bid Request From Driver',
  'Driver Canceled Ride Request' => 'Driver Canceled Ride Request',
  'Payment Successful' => 'Payment Successful',
  'New Ride Request' => 'New Ride Request',
  'Bid Accepted' => 'Bid Accepted',
  'Trip Request Canceled' => 'Trip Request Canceled',
  'Customer Canceled Trip' => 'Customer Canceled Trip',
  'Bid Request Canceled By Customer' => 'Bid Request Canceled By Customer',
  'Tips From Customer' => 'Tips From Customer',
  'Received New Bid' => 'Received New Bid',
  'Customer Rejected Bid' => 'Customer Rejected Bid',
  ...
  'Identity Image Rejected' => 'Identity Image Rejected',
  'Identity Image Approved' => 'Identity Image Approved',
  'Vehicle Active' => 'Vehicle Active',
  'Coupon Applied' => 'Coupon Applied',
  'Coupon Removed' => 'Coupon Removed',
  'Review From Customer' => 'Review From Customer',
  'Review From Driver' => 'Review From Driver',
  'Someone Used Your Code' => 'Someone Used Your Code',
  'Referral Reward Received' => 'Referral Reward Received',
  'Safety Alert Sent' => 'Safety Alert Sent',
  'Safety Problem Resolved' => 'Safety Problem Resolved',
  ...
  'Withdraw Request Settled' => 'Withdraw Request Settled',
  'Withdraw Request Reversed' => 'Withdraw Request Reversed',
  ...
  'The waiting status field is required.' => 'The waiting status field is required.',
  ...
  'dewd' => 'Dewd',
  'driver_new_ride_request' => 'Driver new ride request',
  'new_request_has_been_placed' => 'New request has been placed',
  'new_request_notification' => 'New request notification',
  'def' => 'Def',
  'customer_another_driver_assigned' => 'Customer another driver assigned',
  ...
  'The ride request active time field is required.' => 'The ride request active time field is required.',
  ...
  ' ' => ' ',
  'The sequence has already been taken.' => 'The sequence has already been taken.',
  ...
  'Distance exceeded' => 'Distance exceeded',
  'Undefined variable ${"customer_id":30,"vehicle_category_id":"2","zone_id":1,"area_id":null,"actual_fare":107,"estimated_fare":107,"return_fee":0,"cancellation_fee":0,"extra_fare_fee":0,"extra_fare_amount":0,"rise_request_count":0,"estimated_distance":7.89,"payment_method":"cash","note":null,"type":"ride_request","entrance":null,"encoded_polyline":"{hipCepufPe@]eCkBc@[cCgB}AiACSMQUYKGAaBAKCMMwAAKGcAIgAEw@CaAkDlAk@RoE`BWF_A@u@IMCcAYUMa@G]AQCKGCECMCQQ_BUoB?M@O@IZm@FQ@OAGkC}ESS]i@b@mA|@gENgA?I?Q@iCHiFDiDFeCS{DCU^AFEDS?]Ky@k@y@u@aBMc@QiAGy@Ae@Ag@BmAFoCDeBDoBHeD?QBc@@wAIiAQy@K_@o@_BqA_CgAmB[k@]o@aCeE[m@Wi@wAiCmCwE[k@UGMScAiBiCsDKKoAiAEGGOGUAc@Be@XyBDKJYXU`@MXCj@Hj@R`@LrAr@JKn@t@TFN?JAfA_@bBk@BAlBm@pB[JAl@ErAGr@?~AA`A?X?hFI~AClB?R?hCEdCINAt@Cj@AD?B?LAhBCxDC`DEPAn@AbBG@?~BWbCUj@E`@C`@EvBQ~@KnEo@JAj@IzF_AdBUnC[dAMvAOxEg@ZC|C]zAOtAOP?pBURCVCnAKzASxC[fBUdAMjBQ`AOx@KlC[|@GdCYdEa@pBUC}CA{@MyA{@NIs@BCfCu@hAG","ref_id":100030,"updated_at":"2025-07-29T06:53:49.000000Z","created_at":"2025-07-29T06:53:49.000000Z","id":44}' => 'Undefined variable ${ customer id :30, vehicle category id : 2 , zone id :1, area id :null, actual fare :107, estimated fare :107, return fee :0, cancellation fee :0, extra fare fee :0, extra fare amount :0, rise request count :0, estimated distance :7.89, payment method : cash , note :null, type : ride request , entrance :null, encoded polyline : {hipCepufPe@]eCkBc@[cCgB}AiACSMQUYKGAaBAKCMMwAAKGcAIgAEw@CaAkDlAk@RoE`BWF A@u@IMCcAYUMa@G]AQCKGCECMCQQ BUoB?M@O@IZm@FQ@OAGkC}ESS]i@b@mA|@gENgA?I?Q@iCHiFDiDFeCS{DCU^AFEDS?]Ky@k@y@u@aBMc@QiAGy@Ae@Ag@BmAFoCDeBDoBHeD?QBc@@wAIiAQy@K @o@ BqA CgAmB[k@]o@aCeE[m@Wi@wAiCmCwE[k@UGMScAiBiCsDKKoAiAEGGOGUAc@Be@XyBDKJYXU`@MXCj@Hj@R`@LrAr@JKn@t@TFN?JAfA @bBk@BAlBm@pB[JAl@ErAGr@?~AA`A?X?hFI~AClB?R?hCEdCINAt@Cj@AD?B?LAhBCxDC`DEPAn@AbBG@?~BWbCUj@E`@C`@EvBQ~@KnEo@JAj@IzF AdBUnC[dAMvAOxEg@ZC|C]zAOtAOP?pBURCVCnAKzASxC[fBUdAMjBQ`AOx@KlC[|@GdCYdEa@pBUC}CA{@MyA{@NIs@BCfCu@hAG , ref id :100030, updated at : 2025-07-29T06:53:49.000000Z , created at : 2025-07-29T06:53:49.000000Z , id :44}',
  ...
  'Service Will be Provided' => 'Service Will be Provided',
  ...
  'You already have a running order. Please complete it before accepting a new ride.' => 'You already have a running order. Please complete it before accepting a new ride.',
  ...
  'Suscipit accusamus e' => 'Suscipit accusamus e',
  'Voluptas do consequa' => 'Voluptas do consequa',
  'customer_trip_paused' => 'Customer trip paused',
  'customer_trip_resumed' => 'Customer trip resumed',
  'Non tempore nisi la' => 'Non tempore nisi la',
  'Quo sed non iste com' => 'Quo sed non iste com',
  'Eiusmod totam volupt' => 'Eiusmod totam volupt',
  'Nihil voluptatibus m' => 'Nihil voluptatibus m',
  'customer_trip_completed' => 'Customer trip completed',
  'customer_payment_successful' => 'Customer payment successful',
  'customer_driver_on_the_way' => 'Customer driver on the way',
  'You have insufficient loyalty points' => 'You have insufficient loyalty points',
  'Quis perspiciatis v' => 'Quis perspiciatis v',
  'Bonus_In_Wallet' => 'Bonus In Wallet',
  'Set_up_the_reward_that_the_rider_will_receive_when_using_the_refer_code_in_signup.' => 'Set up the reward that the rider will receive when using the refer code in signup.',
  'Set_the_reward_for_the_rider_who_is_sharing_the_code_with_friends_&_family_to_refer_the_app.' => 'Set the reward for the rider who is sharing the code with friends & family to refer the app.',
  'Setup_Rider_Referral_Earning' => 'Setup Rider Referral Earning',
  'driver_registration_vehicle_request_approved' => 'Driver registration vehicle request approved',
  'Necessitatibus recus' => 'Necessitatibus recus',
  'driver_customer_canceled_trip' => 'Driver customer canceled trip',
  'Unde ut sapiente quo' => 'Unde ut sapiente quo',
  'Coupon applied successfully' => 'Coupon applied successfully',
  'Consectetur et optio' => 'Consectetur et optio',
  'Dolore irure consequ' => 'Dolore irure consequ',
  'Ullamco minima quam' => 'Ullamco minima quam',
  'General_settings' => 'General settings',
  'OTP is not matched' => 'OTP is not matched',
  'The selected ride otp confirmation is invalid.' => 'The selected ride otp confirmation is invalid.',
  ...
  'delivery_man_withdraws' => 'Delivery man withdraws',
  'rider deleted!' => 'Rider deleted!',
  ...
  'rider_withdraw_transactions' => 'Rider withdraw transactions',
  'Deserunt quis verita' => 'Deserunt quis verita',
  ...
  'booking already ignored' => 'Booking already ignored',
  'your_subscription_package_booking_limit_has_ended.' => 'Your subscription package booking limit has ended.',
  'booking status updated successfully' => 'Booking status updated successfully',
  'On Demand Dashboard' => 'On Demand Dashboard',
  ...
  'direct_provider_booking' => 'Direct provider booking',
  ...
  '6 am Tech' => '6 am Tech',
  'No Serviceman assigned' => 'No Serviceman assigned',
  'Booking_Status' => 'Booking Status',
  ...
  'other_review_from_customer' => 'Other review from customer',
  'The selected payment method is invalid.' => 'The selected payment method is invalid.',
  'Est qui eos nihil fu' => 'Est qui eos nihil fu',
  'Sapiente ad quas vol' => 'Sapiente ad quas vol',
  ...
  'Et odio quis ut volu' => 'Et odio quis ut volu',
  'other_referral_reward_received' => 'Other referral reward received',
  ...
  'want_to_disabled_this_ Service' => 'Want to disabled this  Service',
  'Voluptatem autem dol' => 'Voluptatem autem dol',
  'customer_trip_canceled' => 'Customer trip canceled',
  'other_withdraw_request_approved' => 'Other withdraw request approved',
  'Booking Id' => 'Booking Id',
  'Upcoming' => 'Upcoming',
  ...
  'The sub category id must be an integer.' => 'The sub category id must be an integer.',
  ...
  'The service_ids.0 must be a valid UUID.' => 'The service ids.0 must be a valid UUID.',
  'Updated' => 'Updated',
  ...
  'The ride request active time must be less than or equal 30.' => 'The ride request active time must be less than or equal 30.',
  ...
  'Repeat Booking Details' => 'Repeat Booking Details',
  'Repeat Booking Service Log' => 'Repeat Booking Service Log',
  'Single Booking Details' => 'Single Booking Details',
  ...
  'The booking schedule field is required.' => 'The booking schedule field is required.',
  'The reset token field is required.' => 'The reset token field is required.',
  'The confirm password field is required.' => 'The confirm password field is required.',
  'The session info field is required.' => 'The session info field is required.',
  ...
  'The routing number field is required.' => 'The routing number field is required.',
  ...
  'service_address must contain "contact_person_name" properties.' => 'Service address must contain  contact person name  properties.',
  'The service schedule field is required when service type is regular.' => 'The service schedule field is required when service type is regular.',
  ...
  'deny_provider' => 'Deny provider',
  'You want to deny this provider' => 'You want to deny this provider',
  'You want to approve this provider' => 'You want to approve this provider',
  ...
  'Onboarding Provider' => 'Onboarding Provider',
  'This provider is already approved' => 'This provider is already approved',
  'Provider is inactive' => 'Provider is inactive',
  'provider_is_inactive' => 'Provider is inactive',
  'Review ID' => 'Review ID',
  'The selected service id is invalid.' => 'The selected service id is invalid.',
  ...
  'The advertisement type field is required.' => 'The advertisement type field is required.',
  'The dates field is required.' => 'The dates field is required.',
  'Your profile image is missing' => 'Your profile image is missing',
  'The profile image must not be greater than 2048 kilobytes.' => 'The profile image must not be greater than 2048 kilobytes.',
  'The cover image must not be greater than 2048 kilobytes.' => 'The cover image must not be greater than 2048 kilobytes.',
  'The selected advertisement type is invalid.' => 'The selected advertisement type is invalid.',
  ...
  'delete_serviceman' => 'Delete serviceman',
  'you_want_to_remove_this_serviceman' => 'You want to remove this serviceman',
  'trade_license' => 'Trade license',
  ...
  'The is partial field is required.' => 'The is partial field is required.',
  ...
  'The offline payment id field is required.' => 'The offline payment id field is required.',
  ...
  'The zone_ids.0 must be a valid UUID.' => 'The zone ids.0 must be a valid UUID.',
  'Ride Statisticsss' => 'Ride Statisticsss',
  'Earning Statisticsss' => 'Earning Statisticsss',
  'Providers' => 'Providers',
  ...
  'The service time type field is required.' => 'The service time type field is required.',
  ...
  'service_report_and_analytics' => 'Service report and analytics',
  ...
  'The min bidding price field is required.' => 'The min bidding price field is required.',
  'The cover image must be a file of type: jpeg, jpg, png, gif.' => 'The cover image must be a file of type: jpeg, jpg, png, gif.',
  ...
  'Provider is not approved' => 'Provider is not approved',
  'transaction_reports' => 'Transaction reports',
  'Date_Range' => 'Date Range',
  ...
  'Booking verification list' => 'Booking verification list',
  ...
  'provider_withdraws' => 'Provider withdraws',
  'rider_deleted' => 'Rider deleted',
  'service_provider_withdraw_transaction' => 'Service provider withdraw transaction',
  'provider_withdraw_transactions' => 'Provider withdraw transactions',
  'Provider_Balance' => 'Provider Balance',
  'ex_:_search_provider_name' => 'Ex : search provider name',
  'rider_withdraw_request_denied' => 'Rider withdraw request denied',
  ...
  'Analytics Customer Search' => 'Analytics Customer Search',
  'Analytics Keyword Search' => 'Analytics Keyword Search',
  'Provider_Reports' => 'Provider Reports',
  'Provider_Report' => 'Provider Report',
  'Home Service' => 'Home Service',
  'we will fit everything in your home' => 'We will fit everything in your home',
  'Car Service' => 'Car Service',
  'Water Service' => 'Water Service',
  'room fittings' => 'Room fittings',
  ...
  'Coupon Cost Percentage' => 'Coupon Cost Percentage',
  'promotional_costing' => 'Promotional costing',
  'Campaign Cost Percentage' => 'Campaign Cost Percentage',
  'Discount Cost Percentage' => 'Discount Cost Percentage',
  'provider_is_not_approved' => 'Provider is not approved',
  'transidc' => 'Transidc',
  ...
  'pay' => 'Pay',
  'Currently you are bearing the mentioned percentage from the promotional cost' => 'Currently you are bearing the mentioned percentage from the promotional cost',
  'Promotional Cost Bearer' => 'Promotional Cost Bearer',
  ...
  'The maximum service time field is required.' => 'The maximum service time field is required.',
  'TEST' => 'TEST',
  'All_Riders' => 'All Riders',
  'rider_reviews' => 'Rider reviews',
  'ex_: search_by_booking_id' => 'Ex : search by booking id',
  'booking_list' => 'Booking list',
  'total_booking_amount' => 'Total booking amount',
  'review_lsit' => 'Review lsit',
  'service_time' => 'Service time',
  'Provider identity information' => 'Provider identity information',
  ...
  'minimum_service_time_is_required' => 'Minimum service time is required',
  'max_service_time_is_required' => 'Max service time is required',
  'Unlimited_product_uploads' => 'Unlimited product uploads',
  'product_uploads' => 'Product uploads',
  'Unlimited_Bookings' => 'Unlimited Bookings',
  'Unlimited_subscribe_sub_category' => 'Unlimited subscribe sub category',
  'Hi' => 'Hi',
  ...
  'Provider_Paid_From' => 'Provider Paid From',
  'By_Turning_OFF_review!' => 'By Turning OFF review!',
  'By_Turning_ON_review!' => 'By Turning ON review!',
  'The selected phone is invalid.' => 'The selected phone is invalid.',
  'The reset type field is required.' => 'The reset type field is required.',
  ...
  'Total booking served' => 'Total booking served',
  'Total service man' => 'Total service man',
  ...
  'role' => 'Role',
  'joining_date' => 'Joining date',
  'provider_employee_login_page' => 'Provider employee login page',
  'provider_employee_login_url' => 'Provider employee login url',
  'Add_dynamic_url_to_secure_provider_employee_login_access.' => 'Add dynamic url to secure provider employee login access.',
  'The provider employee login url has already been taken.' => 'The provider employee login url has already been taken.',
  'provider_employee' => 'Provider employee',
  'Provider_is_inactive' => 'Provider is inactive',
  'provider_employee_welcome_message' => 'Provider employee welcome message',
  'Provider info' => 'Provider info',
  ...
  'The minimum service time field is required.' => 'The minimum service time field is required.',
  'About' => 'About',
  'The service availability field is required.' => 'The service availability field is required.',
  'The maximum service time must be an integer.' => 'The maximum service time must be an integer.',
  'The minimum service time must be an integer.' => 'The minimum service time must be an integer.',
  ...
  'repeat' => 'Repeat',
  'search by booking ID' => 'Search by booking ID',
  'service from provider app3333' => 'Service from provider app3333',
  'lorem ipsum dollar' => 'Lorem ipsum dollar',
  'service from provider app' => 'Service from provider app',
  ...
  'The campaign image must be a file of type: png, jpg, jpeg, gif.' => 'The campaign image must be a file of type: png, jpg, jpeg, gif.',
  'The short description.0 field is required.' => 'The short description.0 field is required.',
  'The additional instructions must be an array.' => 'The additional instructions must be an array.',
  'The cover photo must be a file of type: jpeg, jpg, png, gif.' => 'The cover photo must be a file of type: jpeg, jpg, png, gif.',
  ...
  'test servicetest servicetest servicetest servicetest servicetest servicetest servicetest servicetest servicetest servicetest servicetest servicetest servicetest servicetest service' => 'Test servicetest servicetest servicetest servicetest servicetest servicetest servicetest servicetest servicetest servicetest servicetest servicetest servicetest servicetest service',
  'Your booking verification OTP is' => 'Your booking verification OTP is',
  'Notification has been failed to send' => 'Notification has been failed to send',
  'Monitor your service business' => 'Monitor your service business',
  ...
  'The tax must be a number.' => 'The tax must be a number.',
  ...
  'The banner title.0 field is required.' => 'The banner title.0 field is required.',
  'The discount title.0 field is required.' => 'The discount title.0 field is required.',
  'The discount amount field is required.' => 'The discount amount field is required.',
  'The max discount amount field is required.' => 'The max discount amount field is required.',
  'The coupon duration field is required.' => 'The coupon duration field is required.',
  'The limit per user must be a number.' => 'The limit per user must be a number.',
  'The campaign name.0 field is required.' => 'The campaign name.0 field is required.',
  'notification_status_updated' => 'Notification status updated',
  'Your cover image is missing' => 'Your cover image is missing',
  'please_add_at_least_one_variant' => 'Please add at least one variant',
  'The tax must not be greater than 100.' => 'The tax must not be greater than 100.',
  'The description.0 field is required.' => 'The description.0 field is required.',
  'you_must_have_at_least_one_variation' => 'You must have at least one variation',
  'variation_removed_successfully' => 'Variation removed successfully',
  'request_failed_try_again' => 'Request failed try again',
  'variation_delete_successfully' => 'Variation delete successfully',
  'Successfully reassign serviceman' => 'Successfully reassign serviceman',
  'Successfully assign serviceman' => 'Successfully assign serviceman',
  'The variant_keys.0 must be a string.' => 'The variant keys.0 must be a string.',
  'Provider address' => 'Provider address',
  'Customer has to go to Service location' => 'Customer has to go to Service location',
  'Provider location' => 'Provider location',
  ...
  'The title.0 field is required.' => 'The title.0 field is required.',
  'Title is required' => 'Title is required',
  'variation_required' => 'Variation required',
  'You_must_enable_instant_or_schedule_booking' => 'You must enable instant or schedule booking',
  ...
  'The identity_images.1 must be a file of type: jpeg, jpg, png, gif.' => 'The identity images.1 must be a file of type: jpeg, jpg, png, gif.',
  'No_active_servicemen_are_available' => 'No active servicemen are available',
  'booking already canceled' => 'Booking already canceled',
  'SparkleClean Ltd.' => 'SparkleClean Ltd.',
  ...
  'Customer Rejected Bid (EN)' => 'Customer Rejected Bid (EN)',
  ...
  'driver_received_new_bid' => 'Driver received new bid',
  'driver_customer_rejected_bid' => 'Driver customer rejected bid',
  ...
  'This post is already booked!' => 'This post is already booked!',
  'You already have a ongoing ride. Please complete it before accepting a new order.' => 'You already have a ongoing ride. Please complete it before accepting a new order.',
  'Last_Name' => 'Last Name',
  'Brand_list' => 'Brand list',
  'Brand_info' => 'Brand info',
  'The category use for field is required.' => 'The category use for field is required.',
  'The brand logo must be an image.' => 'The brand logo must be an image.',
  'The brand logo must be a file of type: png, jpg, jpeg.' => 'The brand logo must be a file of type: png, jpg, jpeg.',
  'Provider Not Found' => 'Provider Not Found',
  'Bid Accepted (EN)' => 'Bid Accepted (EN)',
  'driver_bid_accepted' => 'Driver bid accepted',
  'pdf,_doc,_jpg,_file_size_max_2_mb' => 'Pdf, doc, jpg, file size max 2 mb',
  'Provider_logo_&_cover_photos_are_required' => 'Provider logo & cover photos are required',
  'Provider_name_is_required' => 'Provider name is required',
  'Provider_address_is_required' => 'Provider address is required',
  'Valid_business_phone_number_is_required' => 'Valid business phone number is required',
  'pdf,_doc,_jpg_file_size_max_2_mb' => 'Pdf, doc, jpg file size max 2 mb',
  'Identification No' => 'Identification No',
  'Booking amount must be greater than minimum booking amount' => 'Booking amount must be greater than minimum booking amount',
  'The store id field is required when item id is not present.' => 'The store id field is required when item id is not present.',
  'The item id field is required when store id is not present.' => 'The item id field is required when store id is not present.',
  'business_email_address' => 'Business email address',
  'The vin number has already been taken.' => 'The vin number has already been taken.',
  'The licence plate number has already been taken.' => 'The licence plate number has already been taken.',
  ...
  'subscribe_sub_category' => 'Subscribe sub category',
  'characters' => 'Characters',
  'no_driver_found' => 'No driver found',
  'First_Name' => 'First Name',
  'level_status_updated' => 'Level status updated',
  'Level Up (EN)' => 'Level Up (EN)',
  'other_review_from_driver' => 'Other review from driver',
  'Insert_Owner\'s_business_information' => 'Insert Owner s business information',
  ...
  'Dhaka - Car Service' => 'Dhaka - Car Service',
  'description_required' => 'Description required',
  'JPG,_JPEG,_PNG,_GIF_Less_Than_1MB' => 'JPG, JPEG, PNG, GIF Less Than 1MB',
  'No review yet' => 'No review yet',
  'provider_max_cash_in_hand_limit' => 'Provider max cash in hand limit',
  ...
  'Change Servicerrrrrr Location' => 'Change Servicerrrrrr Location',
  'Change Servicetttttttttt Location' => 'Change Servicetttttttttt Location',
  ...
  'provider_is_suspended' => 'Provider is suspended',
  'Provider is suspended' => 'Provider is suspended',
  ...
  'provider_logo_and_covers' => 'Provider logo and covers',
  'Please select at least one vehicle approval option' => 'Please select at least one vehicle approval option',
  'PNG Less Than 1MB' => 'PNG Less Than 1MB',
  ...
  'one' => 'One',
  'extra_charge_message' => 'Extra charge message',
  ...
  'both_rider_&_deliveryman' => 'Both rider & deliveryman',
  'total_deliveryman' => 'Total deliveryman',
  ...
  'Unlimited_service_sub_category' => 'Unlimited service sub category',
  ...
  'aSafety_&_Precautions' => 'ASafety & Precautions',
  ...
  'Q & A deleted successfully' => 'Q & A deleted successfully',
  ...
  'If_you_want_to_delete_this_Topic & Answer,_please_confirm_your_decision.' => 'If you want to delete this Topic & Answer, please confirm your decision.',
  ...
  'Support_Center_Chatting_Setup' => 'Support Center Chatting Setup',
  'rider_Chatting_Setup' => 'Rider Chatting Setup',
  'view_save_answer' => 'View save answer',
  ...
  'No payment details provided' => 'No payment details provided',
  'Approve Payment' => 'Approve Payment',
  'Deny Payment' => 'Deny Payment',
  'Reason for Denial' => 'Reason for Denial',
  'Please specify the reason for denying this payment...' => 'Please specify the reason for denying this payment...',
  'Confirm Deny' => 'Confirm Deny',
  'You are about to approve this payment. This action cannot be undone.' => 'You are about to approve this payment. This action cannot be undone.',
  'Yes, approve it!' => 'Yes, approve it!',
  'Please provide a reason for denial' => 'Please provide a reason for denial',
  'An error occurred. Please try again.' => 'An error occurred. Please try again.',
  'Switch to Cash After Service' => 'Switch to Cash After Service',
  'Are you sure you want to switch this booking to cash after service?' => 'Are you sure you want to switch this booking to cash after service?',
  'Yes, switch it!' => 'Yes, switch it!',
  'Payment has been denied' => 'Payment has been denied',
  'Payment Denied' => 'Payment Denied',
  'No payment information has been submitted for this booking' => 'No payment information has been submitted for this booking',
  'Processing...' => 'Processing...',
  'Payment has been approved successfully' => 'Payment has been approved successfully',
  'Payment Verified' => 'Payment Verified',
  'Payment was approved on ' => 'Payment was approved on ',
  'Are you sure you want to accept this booking?' => 'Are you sure you want to accept this booking?',
  ...
  'Customized Requests Type' => 'Customized Requests Type',
  'Customized Booking Requests list' => 'Customized Booking Requests list',
  'search_bar_content' => 'Search bar content',
  ...
  'No Of Booking Served' => 'No Of Booking Served',
  'sl1' => 'Sl1',
  'sl2' => 'Sl2',
  'sl3' => 'Sl3',
  'sl4' => 'Sl4',
  ...
  'The question id field is required.' => 'The question id field is required.',
  ...
  'Identity_Documentss' => 'Identity Documentss',
  'Rider Rate Info' => 'Rider Rate Info',
  ...
  'AquaFlow Experts' => 'AquaFlow Experts',
  'Referral Reward Received (EN)' => 'Referral Reward Received (EN)',
  'Vehicle Request Approved (EN)' => 'Vehicle Request Approved (EN)',
  'type_your_identification_number' => 'Type your identification number',
  ...
  'The banner image must be an image.' => 'The banner image must be an image.',
  'The banner image must be a file of type: png, jpg, jpeg, webp.' => 'The banner image must be a file of type: png, jpg, jpeg, webp.',
  ...
  'The total number of bookings currently assigned to this serviceman. This includes all upcoming and ongoing appointments.' => 'The total number of bookings currently assigned to this serviceman. This includes all upcoming and ongoing appointments.',
  'The “All module” includes the Grocery, Pharmacy, Shop, and Food modules. The Admin can create and manage subscription packages that cover all four modules together.' => 'The “All module” includes the Grocery, Pharmacy, Shop, and Food modules. The Admin can create and manage subscription packages that cover all four modules together.',
  'When enabled, service providers will have the ability to cancel bookings made by customers.' => 'When enabled, service providers will have the ability to cancel bookings made by customers.',
  'When turned on, providers can edit the details of a booking, such as time, date, or service notes.' => 'When turned on, providers can edit the details of a booking, such as time, date, or service notes.',
  'Automatically suspends a provider’s account if their cash earnings exceed the configured limit.' => 'Automatically suspends a provider’s account if their cash earnings exceed the configured limit.',
  'Allows providers to register themselves on the platform without admin intervention.' => 'Allows providers to register themselves on the platform without admin intervention.',
  'Enables providers to delete their accounts from the system on their own.' => 'Enables providers to delete their accounts from the system on their own.',
  'Enables a commission-based earning model where providers pay a percentage of each booking to the admin.' => 'Enables a commission-based earning model where providers pay a percentage of each booking to the admin.',
  'Activates a subscription-based model for providers. They must subscribe to offer services.' => 'Activates a subscription-based model for providers. They must subscribe to offer services.',
  'When enabled, providers can respond to reviews left by customers on their services.' => 'When enabled, providers can respond to reviews left by customers on their services.',
  'Manage how you receive system notifications for various activities and updates.' => 'Manage how you receive system notifications for various activities and updates.',
  'If you disable this brand, it won’t appear in the user app.' => 'If you disable this brand, it won’t appear in the user app.',
  ...
  'Rider Review' => 'Rider Review',
  'If enabled, riders can rate and review customers after completing an order.' => 'If enabled, riders can rate and review customers after completing an order.',
  'If disable, riders can not rate and review customers after completing an order.' => 'If disable, riders can not rate and review customers after completing an order.',
  'Rider Level' => 'Rider Level',
  'When enabled, riders will be assigned to levels based on their performance metrics, such as completed orders and ratings.' => 'When enabled, riders will be assigned to levels based on their performance metrics, such as completed orders and ratings.',
  'When disabled, riders will not be assigned to levels based on their performance metrics, such as completed orders and ratings.' => 'When disabled, riders will not be assigned to levels based on their performance metrics, such as completed orders and ratings.',
  'Rider Loyalty Points' => 'Rider Loyalty Points',
  ' If enabled, riders will earn loyalty points for each completed order.' => ' If enabled, riders will earn loyalty points for each completed order.',
  ' If disabled, riders will not earn loyalty points for each completed order.' => ' If disabled, riders will not earn loyalty points for each completed order.',
  ...
  'Customer will have an option to  give tips to rider during checkout from the customer app & website. Admin has no commission over this tip. This feature is not available for service and rental module.' => 'Customer will have an option to  give tips to rider during checkout from the customer app & website. Admin has no commission over this tip. This feature is not available for service and rental module.',
  'With this feature, deliverymen can view their earnings for a specific order before accepting it. This option applies only to orders, not to rides.' => 'With this feature, deliverymen can view their earnings for a specific order before accepting it. This option applies only to orders, not to rides.',
  'With this feature, riders can register via the Customer App, Website, Rider App, or Admin Landing Page. The admin receives an email notification and can accept or reject the request. This feature is not available for the service module.' => 'With this feature, riders can register via the Customer App, Website, Rider App, or Admin Landing Page. The admin receives an email notification and can accept or reject the request. This feature is not available for the service module.',
  'The  Refer & Earn feature is available only for the  ride-sharing module.
Riders can use and share their referral code from app . Deliverymen who register only as delivery personnel will not see this feature in the Rider App.' => 'The  Refer & Earn feature is available only for the  ride-sharing module.
Riders can use and share their referral code from app . Deliverymen who register only as delivery personnel will not see this feature in the Rider App.',
  'Set_the_maximum_order_limit_a_Deliveryman_can_take_at_a_time. This feature applies only to orders, not to rides or trips.' => 'Set the maximum order limit a Deliveryman can take at a time. This feature applies only to orders, not to rides or trips.',
  'Admin_can_enable/disable_Rider’s_order_cancellation_option_in_the_respective_app. This feature applies only to orders, not to rides or trips.' => 'Admin can enable/disable Rider’s order cancellation option in the respective app. This feature applies only to orders, not to rides or trips.',
  'If_enabled,_deliverymen_will_see_an_option_to_take_pictures_of_the_delivered_products_when_he_swipes_the_delivery_confirmation_slide. This feature applies only to orders, not to rides or trips.' => 'If enabled, deliverymen will see an option to take pictures of the delivered products when he swipes the delivery confirmation slide. This feature applies only to orders, not to rides or trips.',
  'If_enabled,_delivery_men_will_be_automatically_suspended_by_the_system_when_their_‘Cash_in_Hand’_limit_is_exceeded. This feature applies only to orders, not to rides or trips.' => 'If enabled, delivery men will be automatically suspended by the system when their ‘Cash in Hand’ limit is exceeded. This feature applies only to orders, not to rides or trips.',
  'Deliveryman_can_not_accept_any_orders_when_the_Cash_In_Hand_limit_exceeds_and_must_deposit_the_amount_to_the_admin_before_accepting_new_orders. This feature applies only to orders, not to rides or trips.' => 'Deliveryman can not accept any orders when the Cash In Hand limit exceeds and must deposit the amount to the admin before accepting new orders. This feature applies only to orders, not to rides or trips.',
  'Enter_the_minimum_cash_amount_delivery_men_can_pay. This feature applies only to orders, not to rides or trips.' => 'Enter the minimum cash amount delivery men can pay. This feature applies only to orders, not to rides or trips.',
  'The “All module” includes the Grocery, Pharmacy, Shop, and Food modules. ' => 'The “All module” includes the Grocery, Pharmacy, Shop, and Food modules. ',
  'The “All module” option lets you view customer orders from Grocery, Pharmacy, Shop, and Food.' => 'The “All module” option lets you view customer orders from Grocery, Pharmacy, Shop, and Food.',
  'The “All module” option lets you view customer orders from Grocery, Pharmacy, Shop, and Food modules.' => 'The “All module” option lets you view customer orders from Grocery, Pharmacy, Shop, and Food modules.',
  'level_up' => 'Level up',
  ...
  'Allows servicemen to request changes to existing bookings, such as rescheduling or modifying service details. Requests may need approval before taking effect.' => 'Allows servicemen to request changes to existing bookings, such as rescheduling or modifying service details. Requests may need approval before taking effect.',
  'When enabled, servicemen are allowed to request the cancellation of a booking. The request may require admin or provider approval, depending on system settings.' => 'When enabled, servicemen are allowed to request the cancellation of a booking. The request may require admin or provider approval, depending on system settings.',
  ...
  'WEBP, JPG, PNG, JPEG, GIF Less Than 1MB' => 'WEBP, JPG, PNG, JPEG, GIF Less Than 1MB',
  'Service added to your cart successfully' => 'Service added to your cart successfully',
  'store_subscription' => 'Store subscription',
  'You have new ride request, Check Please.' => 'You have new ride request, Check Please.',
  'provider Info' => 'Provider Info',
  'review_from_customer' => 'Review from customer',
  'Service removed from your cart.' => 'Service removed from your cart.',
  'Provider updated in your cart successfully.' => 'Provider updated in your cart successfully.',
  'Booking Notification' => 'Booking Notification',
  'If_enabled,_the_Serviceman_app_download_button_will_be_visible_on_the_Landing_page.' => 'If enabled, the Serviceman app download button will be visible on the Landing page.',
  'Want_to_disable_the_App_Store_button_for_Serviceman_App?' => 'Want to disable the App Store button for Serviceman App?',
  'Want_to_enable_the_App_Store_button_for_Serviceman_App?' => 'Want to enable the App Store button for Serviceman App?',
  'Want_to_disable_the_Play_Store_button_for_Serviceman_App?' => 'Want to disable the Play Store button for Serviceman App?',
  'Want_to_enable_the_Play_Store_button_for_Serviceman_App?' => 'Want to enable the Play Store button for Serviceman App?',
  'provider App' => 'Provider App',
  'Serviceman App' => 'Serviceman App',
  'Rider App' => 'Rider App',
  'Total Service Man' => 'Total Service Man',
  'Total Provider' => 'Total Provider',
  'Download_Serviceman_App_Section' => 'Download Serviceman App Section',
  ...
  'Service details updated in your cart.' => 'Service details updated in your cart.',
  'Vehicle add request updated and pending for approval ' => 'Vehicle add request updated and pending for approval ',
  'Set predefined driver messages for ride delays.' => 'Set predefined driver messages for ride delays.',
  ...
  'Meter' => 'Meter',
  'The image must be a file of type: png.' => 'The image must be a file of type: png.',
  'My_Account' => 'My Account',
  'If_you_disable_this,ride_activities_will_be_handled_by_default_method.' => 'If you disable this,ride activities will be handled by default method.',
  'If_you_disable_this,_ride_activities_will_be_handled_by_default_method.' => 'If you disable this, ride activities will be handled by default method.',
