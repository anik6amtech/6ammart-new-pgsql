...
<div class="card mb-3">
    <div class="card-header">
        <h6 class="mb-0 font-medium">{{translate('Rider_Info')}}</h6>
    </div>
    <div class="card-body">
        ...
        <div class="rounded bg-light p-3 mt-3">
            <div class="key-val-list-item d-flex gap-3">
                <span>{{ translate('Rider_Balance') }}:</span>
                <span class="font-semibold text-primary fs-16"> {{ $withdraw->deliveryman->wallet->total_earning > 0 ? \App\CentralLogics\Helpers::format_currency($withdraw->deliveryman->wallet->total_earning) : 0}}</span>
            </div>
        </div>
    </div>
</div>
