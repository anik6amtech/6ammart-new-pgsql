...
@section('title', translate('Rider Preview'))
                ...
                <div class="d-flex gap-2">
                    ...
                    <div>
                        <h1 class="page-header-title text-break mb-1">
                            <span>
                                {{ translate('messages.rider_preview') }}
...
@endif
                <div class="d-flex flex-column flex-md-row align-items-center gap-3 border rounded p-3">
                            ...
                            <div class="col-12">
                                ...
                                <div class="fs-12 text-muted d-flex justify-content-center justify-content-md-start">
                                    @if ($deliveryMan->application_status == 'approved')
                                        ...
                                        <span class="d-block mx-sm-3 mx-1">|</span>
                            ...
                            <div class="col-md-6 col-xl-4 col-xxl-3">
                                <div class="d-flex justify-content-center justify-content-md-start gap-3">
                                    ...
                                    <div class="">
                                        ...
                                        <p class="mb-0 font-weight-normal">{{ translate($deliveryMan?->vehicle?->type == 'motor_bike' ? 'Bike' : ucwords($deliveryMan?->vehicle?->type) ) }}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-xl-4 col-xxl-3">
                    ...
                    @if ($deliveryMan->application_status == 'approved')
                        @php($order_total = $deliveryMan->reviews->count())
                        @php($ride_total = $deliveryMan->receivedReviews->count())
                        @php($total = $order_total + $ride_total)
                                ...
                                <div class="d-flex flex-column align-items-center justify-content-center px-4">
                                    ...
                                    <div class="d-block">
                                        <div class="rating--review">
                                            <h3 class="title mb-0">
                                                {{ $deliveryMan->combinedRating?->average != null ? number_format($deliveryMan->combinedRating?->average, 1) : 0 }}<span
                ...
                @if ($deliveryMan->application_status == 'approved')
                    <div class="d-flex gap-2 align-items-center mt-5">
                        <img src="{{ asset('public/assets/admin/img/entypo_image-inverted.png') }}" width="20" height="20"
                            alt="">
                            <h5 class="mb-0">{{ translate('Rider Rate Info') }}</h5>
                    </div>
                                ...
                                <div class="col-sm-8">
                                    <div class="d-flex justify-content-around flex-wrap gap-3">
                                        <div class="d-flex align-items-center flex-column gap-3">
                                            ...
                                            <h6 class="fw-semibold fs-12 max-w-80 mx-auto text-center" style="color: #107980">
                                        ...
                                        <div class="d-flex align-items-center flex-column gap-3">
                                            ...
                                            <h6 class="fw-semibold fs-12 text-capitalize positive-review-color max-w-80 mx-auto text-center" style="color: #0177CD">
                                        ...
                                        <div class="d-flex align-items-center flex-column gap-3">
                                            ...
                                            <h6 class="fw-semibold fs-12 text-capitalize success-rate-color max-w-80 mx-auto text-center" style="color: #00AA6D">
                                        ...
                                        <div class="d-flex align-items-center flex-column gap-3">
                                            ...
                                            <h6 class="fw-semibold fs-12 text-capitalize cancellation-rate-color max-w-80 mx-auto text-center" style="color: #FC4F4F">
                                        ...
                                        <div class="d-flex align-items-center flex-column gap-3">
                                            ...
                                            <h6 class="fw-semibold fs-12 max-w-80 mx-auto text-center" style="color: #FFA800">Today Idle Hour
                                                Rate</h6>
                                        </div>
                ...
                <div class="row g-3 mt-3">
                    ...
                    @endif
                    <div class="col-sm-6 col-lg-4">
                        <div class="bg-FAFAFA rounded p-xxl-4 p-3 h-100">
    ...
    <div class="content container-fluid pt-0">
        <div class="">
                     @include('admin-views.delivery-man.partials._info_review_tab_menu')
                 </div>
        <div class="card">
            <!-- Header -->
            <div class="card-header py-2 border-0 gap-3">
