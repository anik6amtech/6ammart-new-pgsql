...
@section('title',translate('messages.rider'))
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title">
                ...
                <span>{{translate('messages.rider')}}</span>
            </h1>
        </div>
        <!-- End Page Header -->
        <!-- Card -->
        <div class="card">
            ...
            <div class="card-header py-2 border-0">
                <div class="search--button-wrapper flex-wrap gap-1">
                    <h5 class="card-title mr-auto">
                        {{translate('messages.rider_list')}}<span class="badge badge-soft-dark ml-2" id="itemCount">{{$deliveryMen->total()}}</span>
                    </h5>
                    <div class="d-flex flex-xxl-nowrap align-items-center flex-wrap gap-2">
                        <div class="min--200">
                            ...
                            data-url="{{ url()->full() }}">
                                ...
                                <option {{  request()?->get('filter') == 'deliveryman' ? 'selected' : '' }}  value="deliveryman">{{ translate('messages.Deliveryman') }}</option>
                                <option {{  request()?->get('filter') == 'rider' ? 'selected' : '' }}  value="rider">{{ translate('messages.rider') }}</option>
                            </select>
                        </div>
                        <div class="min--200">
                ...
                <table id="columnSearchDatatable"
                    ...
                    @foreach($deliveryMen as $key=>$dm)
                        <tr>
                            ...
                            <td>
                                <a class="table-rest-info" href="{{ route('admin.users.delivery-man.preview', ['id'=>$dm['id']]) }}?tab=orders">
                                    ...
                                    <div class="info">
                                        ...
                                        <span class="d-block text-body">
                                            <span class="rating">
                                            <i class="tio-star"></i> {{ $dm->combinedRating?->average != null ? number_format($dm->combinedRating?->average, 1) : 0 }}
                                            </span>
                                        </span>
                                    </div>
                                </a>
                            ...
                            <td>
                                <div class="btn--container justify-content-center">
                                    <a class="btn action-btn btn--warning btn-outline-warning"
                                            href="{{ route('admin.users.delivery-man.preview', ['id'=>$dm['id']]) }}?tab=orders"
