...
@section('title', translate('messages.Add new rider'))
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title text-break">
                ...
                <span>{{ translate('messages.add_new_rider') }}</span>
            </h1>
        </div>
        <!-- End Page Header -->
                    ...
                    <div class="row g-4">
                                        ...
                                        <div class="d-flex flex-wrap form-control gap-3">
                                            @foreach(VEHICLE_CATEGORY_USE_CASE as $type)
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input mx-2 category-use-for-checkbox-{{ $type }}" type="checkbox" value="{{$type}}" name="serve_for[]">
                        ...
                        <div class="col-lg-4">
                            <div class="d-flex flex-column h-100">
                                <label class="text-center">{{ translate('messages.rider_image') }} <small
            ...
            <div class="card mt-3">
                <div class="card-header">
                    <h5 class="card-title">
                        <span class="card-title-icon"><i class="tio-user"></i></span>
                        <span>
                            {{ translate('identity_information') }}
                        </span>
                    </h5>
                </div>
                <div class="card-body">
