...
@section('content')
    <div class="content container-fluid">
            ...
            <div class="col-sm-12 col-lg-6">
                <a href="{{ route('admin.users.delivery-man.list',['zone_id' => $params['zone_id'] ?? null]) }}">
                    <div class="__user-dashboard-card" style="--theme-clr:#006AB4">
                        ...
                        {{-- <h3 class="title">{{$total_deliveryman}}</h3>
                        <h5 class="subtitle text-capitalize">{{translate('messages.total_delivery_man')}}</h5> --}}
                        <div class="row deliveryman-info-wrapper">
                            <div class="col-sm-4">
                                <div class="deliveryman-inner-box">
                                    <h3 class="count">{{ $total_rider_count }}</h3>
                                    <h5 class="subtitle text-capitalize">{{translate('messages.total_rider')}}</h5>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliveryman-inner-box">
                                    <h3 class="count">{{ $total_deliveryman_count }}</h3>
                                    <h5 class="subtitle text-capitalize">{{translate('messages.total_deliveryman')}}</h5>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliveryman-inner-box">
                                    <h3 class="count">{{ $total_rider_and_deliveryman_count }}</h3>
                                    <h5 class="subtitle text-capitalize">{{translate('messages.both_rider_&_deliveryman')}}</h5>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <h4 class="mb-md-3">{{ translate('Rider Statistics') }}</h4>
        <div class="row g-2">
            <div class="col-lg-8">
                <div class="row gap__10">
                    ...
                    <div class="col-md-3 col-sm-6">
                        ...
                        <div class="__customer-statistics-card h-100" style="--clr:#006AB4">
                            ...
                            <h4 class="subtitle text-capitalize">{{translate('messages.newly_joined_rider')}}</h4>
                        </div>
                    </a>
                    </div>
                    <div class="col-md-3 col-sm-6">
                    ...
                    <div class="map-pop-deliveryman">
                        <form action="javascript:" id="search-form" class="map-pop-deliveryman-inner">
                            ...
                            <div class="position-relative mx-auto">
                                ...
                                <input type="text" name="search" class="form-control" placeholder="{{translate('Search Rider ...')}}">
                            </div>
                            <a href="{{ route('admin.users.delivery-man.list') }}" class="link">{{ translate('View All Riders') }}</a>
                        </form>
                    </div>
