        ...
        <div class="card mb-3">
            <div class="card-body bg--3 ">
                <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                    <div class="d-flex gap-2 align-items-center w-50 fs-15 text-danger flex-grow-1">
                        <i class="tio-info-outined"></i>
                        <p class="mb-0">
                            {{ translate('The “All module” option lets you view customer orders from Grocery, Pharmacy, Shop, and Food modules.') }}
                        </p>
                    </div>
                </div>
            </div>
