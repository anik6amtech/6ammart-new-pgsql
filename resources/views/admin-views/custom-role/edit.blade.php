                            ...
                            <div class="check--item-wrapper">
                                <div class="check-item">
                                    <div class="form-group form-check form--check">
                                        ...
                                        <label class="form-check-label qcont text-dark" for="booking">{{translate('messages.booking')}}</label>
                                    </div>
                                </div>
                                <div class="check-item">
                                    <div class="form-group form-check form--check">
                                        <input type="checkbox" name="modules[]" value="service_provider" class="form-check-input"
                                               id="service_provider" {{in_array('service_provider',(array)json_decode($role['modules']))?'checked':''}}>
                                        <label class="form-check-label qcont text-dark" for="service_provider">{{translate('messages.Provider')}}</label>
                                    </div>
                                </div>
                                <div class="check-item">
                                    <div class="form-group form-check form--check">
                                        <input type="checkbox" name="modules[]" value="service_promotion" class="form-check-input"
                                               id="service_promotion" {{in_array('service_promotion',(array)json_decode($role['modules']))?'checked':''}}>
                                        <label class="form-check-label qcont text-dark" for="service_promotion">{{translate('messages.Promotion')}}</label>
                                    </div>
                                </div>
                                <div class="check-item">
                                    <div class="form-group form-check form--check">
                                        ...
                                        <label class="form-check-label qcont text-dark" for="service">{{translate('messages.service')}}</label>
                                    </div>
                                </div>
                                <div class="check-item">
                                    <div class="form-group form-check form--check">
                                        <input type="checkbox" name="modules[]" value="service_report" class="form-check-input"
                                               id="service_report" {{in_array('service_report',(array)json_decode($role['modules']))?'checked':''}}>
                                        <label class="form-check-label qcont text-dark" for="service_report">{{translate('messages.report')}}</label>
                                    </div>
                                </div>
                            </div>
                        @endif
