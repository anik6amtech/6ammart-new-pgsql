                                    ...
                                    <div class="form-group mb-0">
                                        <label
                                            ...
                                            <input type="checkbox"
                                                   ...
                                                   data-text-on="<p>{{ translate('messages.If_you_enable_this,_ride_activities_will_be_handled_by_websocket.') }}</p>"
                                                   data-text-off="<p>{{ translate('messages.If_you_disable_this,_ride_activities_will_be_handled_by_default_method.') }}</p>"
