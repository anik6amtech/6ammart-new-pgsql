                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <label for="deliveryman_count_numbers" class="form-label">{{translate('Total Rider Man')}}</label>
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <label for="provider_count_numbers" class="form-label">{{translate('Total Provider')}}</label>
                                <input id="provider_count_numbers" type="number" min="0" max="9999999999" name="provider_count_numbers" value="{{ $counter['provider_count_numbers'] ?? '' }}" placeholder="{{translate('Ex: 500')}}" class="form-control">
                            </div>
                            <div class="col-sm-6 col-lg-3">
                                <label for="serviceman_count_numbers" class="form-label">{{translate('Total Service Man')}}</label>
                                <input id="serviceman_count_numbers" type="number" min="0" max="9999999999" name="serviceman_count_numbers" value="{{ $counter['serviceman_count_numbers'] ?? '' }}" placeholder="{{translate('Ex: 500')}}" class="form-control">
                            </div>
                            <div class="col-sm-6 col-lg-3">
