...
//        dd($translate,$opm,!empty($opm) && $opm->translations->isNotEmpty(),$notificationMessages,$userNotification,$userNotification['key'],$notificationMessages[$user_type .'_'. $userNotification['key']]);
    @endphp
