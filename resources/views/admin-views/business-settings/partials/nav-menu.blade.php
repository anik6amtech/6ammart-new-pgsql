<div class="d-flex flex-wrap justify-content-between align-items-center mb-5 mt-4 __gap-12px">
    <div class="js-nav-scroller hs-nav-scroller-horizontal mt-2">
        ...
        <ul class="nav nav-tabs border-0 nav--tabs nav--pills">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('admin/business-settings/business-setup/deliveryman') ?'active':'' }}" href="{{ route('admin.business-settings.business-setup',  ['tab' => 'deliveryman']) }}"  aria-disabled="true">{{translate('messages.rider')}}</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('admin/business-settings/business-setup/chatting-setup*') ?'active':'' }}" href="{{ route('admin.business-settings.business-setup',  ['tab' => 'chatting-setup', 'subTab' => 'automated-message']) }}"  aria-disabled="true">{{translate('messages.chatting_setup')}}</a>
            </li>
        </ul>
        <!-- End Nav -->
    </div>
