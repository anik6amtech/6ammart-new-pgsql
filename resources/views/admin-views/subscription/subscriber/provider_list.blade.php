...
@section('content')
    ...
    <div class="content container-fluid">
        ...
        <ul class="nav nav-tabs border-0 nav--tabs nav--pills mb-4">
            <li class="nav-item">
                <a class="nav-link {{ request()?->type == null || request()?->type == 'store' ?  'active' : '' }}"
                   href="{{ url()->current() }}?type=store">
                    {{ translate('Store') }}
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ request()?->type == 'provider' ?  'active' : '' }}"
                   href="{{ url()->current() }}?type=provider">
                    {{ translate('Provider') }}
                </a>
            </li>
        </ul>
                ...
                <div class="table-responsive">
                    <table class="table table-borderless middle-align __txt-14px">
                        <thead class="thead-light white--space-false">
                            ...
                            <th class="border-top px-4 border-bottom"> {{ translate('provider Info') }}  </th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="px-4">
                                    <a href="{{route('admin.service.provider.details', $subscriber->id)}}" class="table-rest-info">
                                        <img src="{{ $subscriber->logo_full_url ?? asset('public/assets/admin/img/100x100/1.png') }}" >
                                        <div class="info">
                                            <span class="d-block text-title">
                                                {{ $subscriber->company_name }}<br>
