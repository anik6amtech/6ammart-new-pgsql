...
@section('content')
        ...
        <div class="content container-fluid">
            ...
            <ul class="nav nav-tabs border-0 nav--tabs nav--pills mb-4">
                <li class="nav-item">
                    <a class="nav-link {{ (!in_array(request()->module, [1,2])) ? 'active' : '' }}   " href="{{ route('admin.business-settings.subscriptionackage.index')  }}">{{ translate('All_Module') }}</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link {{ request()->module == 1 ?'active' : '' }} " href="{{ route('admin.business-settings.subscriptionackage.index',['module'=> 1])  }}">{{ translate('Rental_Module') }}</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link {{ request()->module == 2 ?'active' : '' }} " href="{{ route('admin.business-settings.subscriptionackage.index',['module'=> 2])  }}">{{ translate('Service_Module') }}</a>
                </li>
            </ul>
            @endif

            @if(!in_array(request()->module, [1,2]))
            <div class="mb-3">
                <div class="card">
                    <div class="bg--3 px-5 pb-2 card-body d-flex flex-wrap justify-content-around">
                        <p class="w-50 fs-15 text-danger flex-grow-1 ">
                            ...
                            {{translate('messages.The “All module” includes the Grocery, Pharmacy, Shop, and Food modules. The Admin can create and manage subscription packages that cover all four modules together.') }}
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-header border-0 px-3 py-2">
                        <div class="search--button-wrapper justify-content-end">
                            <form class="search-form">
                                ...
                                <div class="input--group input-group input-group-merge input-group-flush">
                                    ...
                                    <input class="form-control"
                                           ...
                                           name="search"
                                           style="border-left:0.530587px solid var(--border-clr);outline:none;box-shadow:none;"
                                           onfocus="this.style.borderLeft='0.530587px solid var(--primary-clr)'; this.style.boxShadow='none';"
                                           onblur="this.style.borderLeft='0.530587px solid var(--border-clr)'; this.style.boxShadow='none';">
                            ...
                            <a href="{{ route('admin.business-settings.subscriptionackage.create',[ 'module' => (request()->module == 1) ? 'rental' : ((request()->module == 2) ? 'service' : 'all') ]) }}" class="btn btn--primary border-0"><i class="tio-add"></i> {{translate('Add Subscription Package')}}</a>
                            <!-- Static Export Button -->
                        </div>
                    </div>
                    ...
                    <div class="card-body text-center py-5">
                        <div class="max-w-542 mx-auto py-sm-5 py-4">
                            ...
                            @if ( request()->module == 1)
                                ...
                                <a href="{{ route('admin.business-settings.subscriptionackage.create',[ 'module' => 'rental']) }}" class="btn btn--primary border-0"><i class="tio-add"></i> {{translate('Add Subscription Package')}}</a>
                            @elseif ( request()->module == 2)
                                <p class="mb-4">
                                    {{translate('Add new subscription packages to the list. So that Providers get more options to join the business for the growth and success.')}}<br>
                                </p>
                                <a href="{{ route('admin.business-settings.subscriptionackage.create',[ 'module' => 'service']) }}" class="btn btn--primary border-0"><i class="tio-add"></i> {{translate('Add Subscription Package')}}</a>
                            @else
                                <p class="mb-4">
