                ...
                <div class="check--grid-wrapper mt-3 max-w-850px">
                    ...
                    <div>
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <span class="form-check-label text-dark">
                                {{-- {{ $subscriptionackage->module_type == 'rental' ? translate('messages.unlimited_trips') : translate('messages.unlimited_orders') }} --}}
                                @if($subscriptionackage->module_type == 'rental') 
                                {{ translate('messages.unlimited_trips') }}
                                @elseif($subscriptionackage->module_type == 'service') 
                                {{ translate('messages.unlimited_booking_request') }}
                                @else
                            ...
                            <span class="form-check-label text-dark"> {{ $subscriptionackage->max_order }} 
                                {{-- {{ $subscriptionackage->module_type == 'rental' ? translate('messages.trips') : translate('messages.Orders') }} --}}
                                @if($subscriptionackage->module_type == 'rental') 
                    ...
                    <div>
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <span class="form-check-label text-dark">
                                {{-- {{  $subscriptionackage->module_type == 'rental' ? translate('messages.unlimited_Upload') : translate('messages.unlimited_item_Upload') }} --}}
                                @if($subscriptionackage->module_type == 'rental') 
                                {{ translate('messages.unlimited_Upload') }}
                                @elseif($subscriptionackage->module_type == 'service') 
                                {{ translate('messages.unlimited_service_sub_category_subscribe') }}
                                @else
                                {{ translate('messages.unlimited_item_Upload') }}
                                @endif
                                </span>
                            @else
                            <span class="form-check-label text-dark"> {{ $subscriptionackage->max_product }} 
                                {{-- {{ $subscriptionackage->module_type == 'rental' ? translate('messages.Vehicle_Upload') : translate('messages.product_Upload') }} --}}
                                @if($subscriptionackage->module_type == 'rental') 
                                {{ translate('messages.Vehicle_Upload') }}
                                @elseif($subscriptionackage->module_type == 'service')
                                {{ translate('messages.service_sub_category_subscribe') }}
                                @else
                    ...
                    @if ( $subscriptionackage->module_type == 'service')
                        <div>
                            <div class="d-flex align-items-center gap-2">
                                @if ( $subscriptionackage->scheduled_service == 1 )
                                <img src="{{asset('/public/assets/admin/img/subscription-plan/check.png')}}" alt="">
                                @else
                                <img src="{{asset('/public/assets/admin/img/subscription-plan/check-1.png')}}" alt="">
                                @endif
                        ...
                        <div>
                            <div class="d-flex align-items-center gap-2">
                                @if ( $subscriptionackage->service_request == 1 )
                                <img src="{{asset('/public/assets/admin/img/subscription-plan/check.png')}}" alt="">
                                @else
                                <img src="{{asset('/public/assets/admin/img/subscription-plan/check-1.png')}}" alt="">
                                @endif
                        ...
                        <div>
                            <div class="d-flex align-items-center gap-2">
                                @if ( $subscriptionackage->reports_and_analytics == 1 )
                                <img src="{{asset('/public/assets/admin/img/subscription-plan/check.png')}}" alt="">
                                @else
                                <img src="{{asset('/public/assets/admin/img/subscription-plan/check-1.png')}}" alt="">
                                @endif
                        ...
                        <div>
                            <div class="d-flex align-items-center gap-2">
                                @if ( $subscriptionackage->bidding == 1 )
                                <img src="{{asset('/public/assets/admin/img/subscription-plan/check.png')}}" alt="">
                                @else
                                <img src="{{asset('/public/assets/admin/img/subscription-plan/check-1.png')}}" alt="">
                                @endif
