            ...
            <div class="d-flex flex-wrap align-items-center gap-2">
                ...
                <div class="w-16rem">
                    <select name="delivery_man_id" data-url="{{ url()->current() }}" data-filter="delivery_man_id"
                        ...
                        <option value="all">{{ translate('messages.all_rider') }}</option>
            ...
            <div class="search--button-wrapper">
                ...
                <form class="search-form">
                    ...
                    <div class="input--group input-group input-group-merge input-group-flush">
                        <input class="form-control" value="{{ request()?->search  ?? null }}" placeholder="{{ translate('search_by_rider_info') }}" name="search">
