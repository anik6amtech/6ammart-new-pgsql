...
@section('title', translate('messages.Edit_Rider_Level'))
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title">
                ...
                <span>
                    {{ translate('messages.Edit_Rider_Level') }}
                </span>
            </h1>
        </div>

        <form action="{{route('admin.users.delivery-man.level.update', ['id' => $level->id])}}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="card mb-4">
                        ...
                        <div class="col-lg-6">
                            <div class="lang_form" id="default-form">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name[]" class="form-control" value="{{ $level?->getRawOriginal('name') }}" required placeholder="{{ translate('messages.Type_Level_Name') }}">
                                </div>
                            ...
                            @foreach ($language as $key => $lang)
                                <?php
                                    if(count($level['translations'])){
                                        $translate = [];
                                        foreach($level['translations'] as $t)
                                        {
                                ...
                                <div class="d-none lang_form" id="{{ $lang }}-form">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name[]" class="form-control" value="{{$translate[$lang]['name']??''}}" placeholder="{{ translate('messages.Type_Level_Name') }}">
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="sequence" disabled class="form-control"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <select name="reward_type" id="rewardType" class="form-control js-select2-custom"
                                            ...
                                            <option value="{{WALLET}}" {{ $level->reward_type == WALLET ? 'selected' : '' }}>{{translate('wallet')}}</option>
                                            <option
                                                value="{{LOYALTY_POINTS}}" {{ $level->reward_type == LOYALTY_POINTS ? 'selected' : '' }}>{{translate('loyalty_points')}}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-6" id="rewardAmountDiv">
                                    <div class="form-group mb-0">
                                        <label class="input-label text-capitalize" for="rewardAmount"><span id="rewardAmountLabel">{{ $level->reward_type == WALLET ? translate('reward_amount') . ' (' . (session()->get('currency_symbol') ?? '$') . ')' : translate('reward_points') }}</span> <span class="text-danger">*</span></label>
                                        <input type="number" name="reward_amount" value="{{$level->reward_amount}}" max="999999999" id="rewardAmount" class="form-control" placeholder="{{ translate('ex') }}: 500" step=".01">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="check-toggle-item bg-white p-10px rounded-10 user-select-none mb-3">
                                <label class="custom-control custom-checkbox mr-sm-2 mb-0">
                                    <input type="checkbox" class="custom-control-input" id="minimum_ride_complete" name="minimum_ride_complete"
                                    ...
                                    <div class="row g-4 mt-2">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input type="number" name="targeted_cancel_point"
                                                value="{{$level->targeted_cancel_point}}" id="points3" class="form-control" min="1"
