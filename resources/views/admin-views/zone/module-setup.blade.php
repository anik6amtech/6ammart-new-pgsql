                        ...
                        <div class="form-group">
                            <div class="d-flex justify-content-between align-items-center">
                                <label class="input-label text-capitalize d-inline-flex alig-items-center"
                                    ...
                                    <span class="line--limit-1">{{ translate('messages.extra_charge') }} (%)
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="d-flex justify-content-between align-items-center">
                                <label class="input-label text-capitalize d-inline-flex alig-items-center"
                                    for="increased_delivery_fee">
                                    <span class="line--limit-1">{{ translate('messages.extra_charge_message') }}
                ...
                <div class="col-md-12">
                    <div class="delivery_charge_options" id="delivery_charge_options">
                        ...
                        @if (count($zone->modules) > 0)
                            ...
                            @elseif ($module->module_type == 'rental' && addon_published_status('Rental') || $module->module_type == 'service' || $module->module_type == 'ride-share')
                            <div class="row gy-1 module-row" id="module_{{ $module->id }}">
                                <div class="col-sm-4"><input type="text" class="form-control"
                                        value="{{ $module->module_name }}"
                            ...
                            @elseif ($module->module_type == 'service' || $module->module_type == 'ride-share')
                            <div class="row gy-1 module-row" id="module_{{ $module->id }}">
                                <div class="col-sm-4"><input type="text" class="form-control"
                                        value="{{ $module->module_name }}"
                                        placeholder="{{ translate('messages.Not applicable') }}" readonly></div>
...
@push('script_2')
    ...
    <script>
        ...
        $('#choice_modules').on('change', function() {
            ...
            $.each($("#choice_modules option:selected"), function(index, element) {
                ...
                if (ids.includes($(this).val())) {
                    ...
                    else if (found.module_type == 'rental' || found.module_type == 'ride-share' || found.module_type == 'service'){
                        add_readonly_module($(this).val(), name.trim());
                    }
                    else{
        ...
        function add_rental_module(i, name) {
            add_readonly_module(i, name);
        }
        
        function add_readonly_module(i, name) {
            let n = name;
            $('#delivery_charge_options').append(
                '<div class="row gy-1 module-row" id="module_' + i +
                '"><div class="col-sm-4"><input type="text" class="form-control" value="' + n +
