<div class="row">
    <div class="col-lg-12 text-center "><h1 >{{ translate('rider_list') }}</h1></div>
    <div class="col-lg-12">
    ...
    <table>
        <thead>
            ...
            <tr>
                ...
                <th></th>
                <th>
                    {{ translate('total_rider')  }}- {{ $data['delivery_men']->count() }}
                    <br>
                    {{ translate('active_rider')  }}- {{ $data['delivery_men']->where('status',1)->count()}}
                    <br>
                    {{ translate('inactive_rider')  }}- {{ $data['delivery_men']->where('status',0)->count() }}
                </th>
                <th> </th>
                <th></th>
                <th></th>
