    ...
    <aside class="js-navbar-vertical-aside navbar navbar-vertical-aside navbar-vertical navbar-vertical-fixed navbar-expand-xl navbar-bordered  ">
        <div class="navbar-vertical-container">
            ...
            <div class="navbar-vertical-content bg--005555" id="navbar-vertical-content">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/users/delivery-man*') && !Request::is('admin/users/delivery-man/vehicle*') ? 'active' : '' }}">
                    ...
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub"  style="display:{{ Request::is('admin/users/delivery-man*') && !Request::is('admin/users/delivery-man/vehicle*') ? 'block' : 'none' }}">
                        <li class="nav-item {{ Request::is('admin/users/delivery-man') ||  Request::is('admin/users/delivery-man/edit*') ||  Request::is('admin/users/delivery-man/preview*') ? 'active' : '' }}">
                            <a class="nav-link " href="{{ route('admin.users.delivery-man.list') }}" title="{{ translate('messages.Rider_List') }}">
                                <span class="tio-circle nav-indicator-icon"></span>
                                <span class="text-truncate">{{ translate('messages.Rider_List') }}</span>
                            </a>
                        </li>
                        <li class="nav-item {{ Request::is('admin/users/delivery-man/add') ? 'active' : '' }}">
                            <a class="nav-link " href="{{ route('admin.users.delivery-man.add') }}" title="{{ translate('messages.Add_New_Rider') }}">
                                <span class="tio-circle nav-indicator-icon"></span>
                                <span class="text-truncate">{{ translate('messages.Add_New_Rider') }}</span>
                            </a>
                        </li>
                        <li class="nav-item {{ Request::is('admin/users/delivery-man/new') || Request::is('admin/users/delivery-man/deny')  ? 'active' : '' }}">
                            <a class="nav-link " href="{{ route('admin.users.delivery-man.new') }}" title="{{ translate('messages.New_Rider') }}">
                                <span class="tio-circle nav-indicator-icon"></span>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                        ...
                        <li class="nav-item {{ Request::is('admin/users/delivery-man/level') || Request::is('admin/users/delivery-man/level/edit*') ? 'active' : '' }}">
                            <a class="nav-link " href="{{ route('admin.users.delivery-man.level.index') }}" title="{{ translate('messages.rider_level') }}">
                                <span class="tio-circle nav-indicator-icon"></span>
                                <span class="text-truncate">{{ translate('messages.rider_level') }}</span>
                            </a>
                        </li>
                        <li class="nav-item {{ Request::is('admin/users/delivery-man/level/create') ? 'active' : '' }}">
                            <a class="nav-link " href="{{ route('admin.users.delivery-man.level.create') }}" title="{{ translate('messages.add_rider_level') }}">
                                <span class="tio-circle nav-indicator-icon"></span>
                                <span class="text-truncate">{{ translate('messages.add_rider_level') }}</span>
                            </a>
                        </li>
                        <li class="nav-item {{ Request::is('admin/users/delivery-man/reviews') ? 'active' : '' }}">
                            <a class="nav-link " href="{{ route('admin.users.delivery-man.reviews.list') }}" title="{{ translate('messages.reviews') }}">
                                <span class="tio-circle nav-indicator-icon"></span>
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/users/delivery-man/vehicle*') ? 'active' : '' }}">
                    ...
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub"  style="display:{{ Request::is('admin/users/delivery-man/vehicle*') ? 'block' : 'none' }}">
                        <li class="nav-item {{ Request::is('admin/users/delivery-man/vehicle/brand') || Request::is('admin/users/delivery-man/vehicle/category') || Request::is('admin/users/delivery-man/vehicle/model') ? 'active' : '' }}">
                            <a class="nav-link " href="{{ route('admin.users.delivery-man.vehicle.brand.index') }}" title="{{ translate('messages.Attribute_Setup') }}">
                                <span class="tio-circle nav-indicator-icon"></span>
                                <span class="text-truncate">{{ translate('messages.Attribute_Setup') }}</span>
                            </a>
                        </li>
                        <li class="nav-item {{ Request::is('admin/users/delivery-man/vehicle/create') ? 'active' : '' }}">
                            <a class="nav-link " href="{{ route('admin.users.delivery-man.vehicle.create') }}" title="{{ translate('messages.Add_Vehicle') }}">
                                <span class="tio-circle nav-indicator-icon"></span>
                                <span class="text-truncate">{{ translate('messages.Add_Vehicle') }}</span>
                            </a>
                        </li>
                        <li class="nav-item {{ Request::is('admin/users/delivery-man/vehicle') ? 'active' : '' }}">
                            <a class="nav-link " href="{{ route('admin.users.delivery-man.vehicle.index') }}" title="{{ translate('messages.Vehicle_List') }}">
                                <span class="tio-circle nav-indicator-icon"></span>
                                <span class="text-truncate">{{ translate('messages.Vehicle_List') }}</span>
                            </a>
                        </li>
                        <li class="nav-item {{ Request::is('admin/users/delivery-man/vehicle/request/list*') ? 'active' : '' }}">
                            <a class="nav-link " href="{{ route('admin.users.delivery-man.vehicle.request.list',['status'=>'pending']) }}" title="{{ translate('messages.Vehicle_Request') }}">
                                <span class="tio-circle nav-indicator-icon"></span>
                ...
                <li class="navbar-vertical-aside-has-menu {{ (Request::is('admin/users/customer/list') || Request::is('admin/users/customer/view*') || Request::is('admin/users/customer/rental-view*') || Request::is('admin/users/customer/ride-share-view*')) ? 'active' : '' }}">
