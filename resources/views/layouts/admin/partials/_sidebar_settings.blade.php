            ...
            <div class="navbar-vertical-content bg--005555" id="navbar-vertical-content">
                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    @if (addon_published_status('RideShare'))
                        <li class="nav-item">
                            <small class="nav-subtitle"
                                title="{{ translate('messages.additional_settings') }}">{{ translate('messages.ride_share_settings') }}</small>
                    ...
                    @if (addon_published_status('Service'))
                        <li class="nav-item">
                            <small class="nav-subtitle"
                                title="{{ translate('messages.service_settings') }}">{{ translate('messages.service_settings') }}</small>
                            <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                        </li>
                        @if (\App\CentralLogics\Helpers::module_permission_check('settings'))
                            <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/business-settings/service/business-setup*') ? 'active' : '' }}">
                                <a class="nav-link " href="{{ route('admin.business-settings.service.get-business-settings') }}"
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('module'))
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/business-settings/module') ? 'active' : '' }}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/business-settings/module') || Request::is('admin/business-settings/module/edit')  ? 'active' : '' }}">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                        ...
                        <li class="navbar-vertical-aside-has-menu @yield('subscription')">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li class="navbar-vertical-aside-has-menu  @yield('subscriberList')">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                       href="{{ route('admin.business-settings.subscriptionackage.subscriberList') }}?type=store"
...
{{--                                </li>--}}
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/business-settings/app-settings*') ? 'active' : '' }}">
                            ...
                            <li class="navbar-vertical-aside-has-menu @yield('notification_setup_type')">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="display:{{ Request::is('admin/business-settings/notification-setup*') || Request::is('admin/business-settings/service/notification-setup*') ? 'block' : 'none' }}">
                                    ...
                                    <li class="navbar-vertical-aside-has-menu @yield('notification_setup')">
                                        <a class="js-navbar-vertical-aside-menu-link nav-link"
                                           ...
                                           title="{{ translate('messages.All_Modules') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{ translate('messages.All_Modules') }}</span>
                                        </a>
                                    </li>
                                    ...
                                    @if (addon_published_status('Rental'))
                                        <li class="navbar-vertical-aside-has-menu @yield('notification_setup_rental')">
                                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                               ...
                                               title="{{ translate('messages.Rental_Module') }}">
                                                <span class="tio-circle nav-indicator-icon"></span>
                                                <span class="text-truncate">{{ translate('messages.Rental_Module') }}</span>
                                            </a>
                                        </li>
                                    @endif
                                    ...
                                    {{-- Service Module --}}
                                    @if (addon_published_status('Service'))
                                        <li class="navbar-vertical-aside-has-menu @yield('notification_setup_service')">
                                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                               href="{{ route('admin.business-settings.service.notification-setup', ['provider']) }}"
                                               title="{{ translate('messages.Service_Module') }}">
                                                <span class="tio-circle nav-indicator-icon"></span>
                                                <span class="text-truncate">{{ translate('messages.Service_Module') }}</span>
                                            </a>
                                        </li>
                                    @endif
