        ...
        <div class="navbar-vertical-container">
            ...
            <div class="navbar-vertical-content bg--005555" id="navbar-vertical-content">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/transactions/delivery-man/withdraw*') ? 'active' : '' }}">
                    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.transactions.delivery-man.withdraw_list') }}" title="{{ translate('messages.rider_withdraws') }}">
                        <i class="tio-table nav-icon"></i>
                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ translate('rider_withdraws') }}</span>
                    </a>
                </li>
                @endif
                @if (\App\CentralLogics\Helpers::module_permission_check('withdraw_list'))
                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/transactions/service/provider/withdraw*') ? 'active' : '' }}">
                    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.transactions.service.provider.withdraw_list') }}" title="{{ translate('messages.provider_withdraws') }}">
                        <i class="tio-table nav-icon"></i>
                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ translate('provider_withdraws') }}</span>
                    </a>
                </li>
                @endif
                <!-- End withdraw -->
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/transactions/provide-deliveryman-earnings*') ? 'active' : '' }}">
                    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.transactions.provide-deliveryman-earnings.index') }}" title="{{ translate('messages.deliverymen_earning_provide') }}">
                        ...
                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ translate('Rider Payments') }}</span>
                    </a>
                </li>
                @endif
                ...
                @endif
                    ...
                    @endif
                        ...
                        <!-- Rental Report -->
                         @if (\App\CentralLogics\Helpers::module_permission_check('ride_report'))
                            <li class="nav-item">
                                <small class="nav-subtitle" title="{{ translate('messages.ride_report_and_analytics') }}">{{ translate('messages.ride_report_and_analytics') }}</small>
                                <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                            </li>

                            <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/transactions/ride-share/transaction*') ? 'active' : '' }}">
                                <a class="nav-link " href="{{ route('admin.transactions.ride-share.transaction.index') }}" title="{{ translate('messages.transactions_&_reports') }}">
                                    <span class="tio-chart-pie-1 nav-icon"></span>
                                    <span class="text-truncate">{{ translate('messages.transactions_&_reports') }}</span>
                                </a>
                            </li>

                            <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/transactions/ride-share/report*') ? 'active' : '' }}">
                                <a class="nav-link " href="{{ route('admin.transactions.ride-share.report.earning') }}" title="{{ translate('messages.reports') }}">
                                    <span class="tio-chart-bar-1 nav-icon"></span>
                    ...
                    @endif
                        ...
                        <!-- Rental Report -->
                         @if (\App\CentralLogics\Helpers::module_permission_check('service_report'))
                            <li class="nav-item">
                                <small class="nav-subtitle" title="{{ translate('messages.service_report_and_analytics') }}">{{ translate('messages.service_report_and_analytics') }}</small>
                                <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                            </li>

                            <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/transactions/service/report/transaction*') ? 'active' : '' }}">
                                <a class="nav-link " href="{{route('admin.transactions.service.report.transaction', ['transaction_type'=>'all'])}}" title="{{ translate('messages.transactions_reports') }}">
                                    <span class="tio-chart-pie-1 nav-icon"></span>
                                    <span class="text-truncate">{{ translate('messages.transactions_reports') }}</span>
                                </a>
                            </li>

                            <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/transactions/service/report/business*') ? 'active' : '' }}">
                                <a class="nav-link " href="{{route('admin.transactions.service.report.business.overview')}}" title="{{ translate('messages.Business Reports') }}">
                                    <span class="tio-chart-bar-1 nav-icon"></span>
                                    <span class="text-truncate">{{ translate('messages.Business Reports') }}</span>
                                </a>
                            </li>
                            <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/transactions/service/report/booking*') ? 'active' : '' }}">
                                <a class="nav-link " href="{{route('admin.transactions.service.report.booking')}}" title="{{ translate('messages.Booking Reports') }}">
                                    <span class="tio-chart-bar-4  nav-icon"></span>
                                    <span class="text-truncate">{{ translate('messages.Booking Reports') }}</span>
                                </a>
                            </li>
                            <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/transactions/service/report/provider*') ? 'active' : '' }}">
                                <a class="nav-link " href="{{route('admin.transactions.service.report.provider')}}" title="{{ translate('messages.provider Reports') }}">
                                    <span class="tio-home nav-icon"></span>
                                    <span class="text-truncate">{{ translate('messages.provider Reports') }}</span>
                                </a>
                            </li>
                            <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/transactions/service/analytics/search/keyword*') ? 'active' : '' }}">
                                <a class="nav-link " href="{{route('admin.transactions.service.analytics.search.keyword')}}" title="{{ translate('messages.Analytics Keyword Search') }}">
                                    <span class="tio-search nav-icon"></span>
                                    <span class="text-truncate">{{ translate('messages.Analytics Keyword Search') }}</span>
                                </a>
                            </li>
                            <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/transactions/service/analytics/search/customer*') ? 'active' : '' }}">
                                <a class="nav-link " href="{{route('admin.transactions.service.analytics.search.customer')}}" title="{{ translate('messages.Analytics Customer Search') }}">
                                    <span class="tio-find-replace nav-icon"></span>
                                    <span class="text-truncate">{{ translate('messages.Analytics Customer Search') }}</span>
                                </a>
                            </li>
                         @endif
                    @endif
