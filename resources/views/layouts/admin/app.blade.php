...
<head>
    ...
    @endif
    @if(in_array($module_type, ['ride-share','settings', 'transactions']))
         <link rel="stylesheet" href="{{ asset('Modules/RideShare/public/assets/css/ride-share.css') }}">
         <link rel="stylesheet" href="{{ asset('Modules/RideShare/public/assets/css/webfonts/uicons-regular-rounded.css') }}">
        <link rel="stylesheet" href="{{ asset('Modules/RideShare/public/assets/css/webfonts/uicons-solid-rounded.css') }}">
    @endif
    @if(in_array($module_type, ['service','settings', 'transactions']))
...
@endif
    ...
    @if(in_array($module_type, ['rental', 'ride-share', 'service']))
    ...
    @elseif($module_type == 'ride-share')
        @include("ride-share::admin.partials._sidebar_{$module_type}")
    @elseif($module_type == 'service')
        @include("service::admin.partials._sidebar_{$module_type}")
    @else
        @include("layouts.admin.partials._sidebar_{$module_type}")
    @endif --}}
...
<script src="{{asset('public/assets/admin/js/view-pages/common.js')}}?v=1.2"></script>
...
$(document).on('keyup', 'input[type="tel"]', function () {
  ...
  //external configuration
    ...
    @if(in_array($module_type, ['ride-share','settings']))
