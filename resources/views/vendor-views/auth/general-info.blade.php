                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="row g-4 mb-30">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group mb-4" id="tax_div">
                                        ...
                                        <input type="number" id="tax" name="tax"
                                            ...
                                            step=".01" value="{{ old('tax') }}">
                                    </div>
                                    <div class="form-group" id="delivery_time_div">
                                    ...
                                    <div class="form-group d-none" id="service_delivery_time_div">
                                    </div>
                                    {{--<div class="form-group d-none" id="service_delivery_time_div">
                                        <label class="input-label module-select-time"
                                            for="minimum_service_delivery_time">{{ translate('messages.service_time') }}<span class="text-danger">*</span></label>
                                        <div class=" __form-control custom-group-btn">
                                            <div class="item flex-sm-grow-1">
                                                <div class="d-flex align-items-center gap-1">
                                                    <label class="floating-label"
                                                        for="min">{{ translate('messages.min') }}:</label>
                                                    <input type="number" id="minimum_service_delivery_time"
                                                        name="minimum_delivery_time" class="form-control p-0 border-0"
                                                        placeholder="10" value="{{ old('minimum_service_time') }}">
                                                </div>
                                            </div>
                                            <div class="item flex-sm-grow-1">
                                                <div class="d-flex align-items-center gap-1">
                                                    <label class="floating-label"
                                                        for="max">{{ translate('messages.max') }}:</label>
                                                    <input type="number" name="maximum_delivery_time"
                                                        id="max_service_delivery_time" class="form-control p-0 border-0"
                                                        placeholder="20" value="{{ old('maximum_service_time') }}">
                                                </div>
                                            </div>
                                            <div class="item flex-shrink-0">
                                                <select name="delivery_time_type"
                            ...
                            <div class="card __card bg-F8F9FC mb-4 d-none" id="business_information">
                                <div class="card-header">
                                    <div>
                                        ...
                                        <p class="fs-12 mb-0">
                                            {{ translate('messages.Insert_Owner\'s_business_information') }}
                                        </p>
                                    </div>
                                </div>
                                <div class="card-body p-4">
                                    <div class="row g-3">
                                        <div class="col-md-4 col-lg-4 col-sm-12">
                                            <div class="form-group">
                                                <label class="input-label"
                                                       for="business_email">{{ translate('messages.business_email') }}<span class="text-danger">*</span></label>
                                                <input type="email" id="business_email" name="business_email"
                                                       class="form-control __form-control"
                                                       placeholder="{{ translate('messages.Ex:') }} abc@abc.com"
                                        ...
                                        <div class="col-md-4 col-lg-4 col-sm-12">
                                            <div class="form-group">
                                                <label class="input-label"
                                                       for="business_phone">{{ translate('messages.business_phone') }}<span class="text-danger">*</span></label>
                                                <input type="tel" id="business_phone" name="business_phone"
                                                       class="form-control __form-control"
                                                       placeholder="{{ translate('messages.Ex:') }} 017********"
                                                       value="{{ old('business_phone') }}" required>
                                            </div>
                            ...
                            <div class="card __card bg-F8F9FC mb-4 d-none" id="identity_section">
                                <div class="card-header">
                                    <div>
                                        <h5 class="card-title mb-4">
                                            {{ translate('messages.identity_information') }}
                                        </h5>
                                        <p class="fs-12 mb-0">
                                            {{ translate('messages.Provider identity information') }}
                                        </p>
                                    </div>
                                </div>
                                <div class="card-body p-4">
                                    <div class="row g-4">
                                        <div class="col-md-6">
                                            <label for="identity_type" class="input-label">
                                                {{ translate('messages.identity_type') }}
                                            </label>
                                            <select name="identity_type" id="identity_type" class="form-control __form-control js-select2-custom"
                                                    data-placeholder="{{ translate('messages.select_zone') }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-0">
                                                <label for="identification_number" class="input-label">
                                                    {{ translate('messages.identification_number') }} <span class="text-danger">*</span>
                                                </label>
                                                <input type="text" class="form-control __form-control" name="identity_number" id="identification_number" placeholder="{{ translate('messages.type_your_identification_number') }}">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div>
                                                <div class="mb-xl-3 mb-2">
                                                    <h6 class="mb-1 fs-5">{{ translate('messages.identity_documents') }}</h6>
...
@push('script_2')
            ...
            $('#module_id').on('change', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#service_delivery_time_div').addClass('d-none');
                        $('#business_information').addClass('d-none');
                        ...
                        if (response.module_type === 'rental') {
                            ...
                            $('#service_delivery_time_div').removeClass('d-none');
                            $('#identity_section').removeClass('d-none');
                            $('#pickup-zone-container').hide();
                            $('#business_information').removeClass('d-none');
                        }else {
                            $('#pickup-zone-container').hide();
                            $('.multiple-select2').prop('disabled', true);
                            $('#identity_section').addClass('d-none');
                        }
                    },
    ...
    <script>
        ...
        $('#show-business-plan-div').on('click', function (e) {
            ...
            const coverPhoto = $('#coverImageUpload')[0]?.files.length || 0;
            const logo = $('#customFileEg1')[0]?.files.length || 0;

            if (coverPhoto === 0 || logo === 0) {
                toastr.error("{{ translate('Vendor_logo_&_cover_photos_are_required') }}");
                return;
            }

            if (getVal('#default_name') === '') {
            ...
            if (getVal('#latitude') === '' || getVal('#longitude') === '') {
                toastr.error("{{ translate('Must_click_on_the_map_for_lat/long') }}");
                return;
            }

            if (getVal('#tax') === '' && !$('#tax_div').hasClass('d-none')) {
                toastr.error("{{ translate('tax_is_required') }}");
                return;
            }

            if (getVal('#minimum_delivery_time') === '' && !$('#delivery_time_div').hasClass('d-none')) {
                toastr.error("{{ translate('minimum_delivery_time_is_required') }}");
                return;
            }

            if (getVal('#max_delivery_time') === '' && !$('#delivery_time_div').hasClass('d-none')) {
                toastr.error("{{ translate('max_delivery_time_is_required') }}");
                return;
            }

            if (getVal('#business_email') === '') {
                toastr.error("{{ translate('business_email_is_required') }}");
                return;
            }

            if (getVal('#business_phone').length < 5) {
                toastr.error("{{ translate('business_phone_is_required') }}");
                return;
            }
            ...
            if (getVal('#phone').length < 5) {
                toastr.error("{{ translate('valid_phone_number_is_required') }}");
                return;
            }

            const identityType = $('#identity_type').val();
            if (!identityType || identityType === '') {
                toastr.error("{{ translate('identity_type_is_required') }}");
                return;
            }

            if (getVal('#identification_number') === '') {
                toastr.error("{{ translate('identity_number_is_required') }}");
                return;
            }
            ...
            if (getVal('#exampleInputPassword') === '') {
                toastr.error("{{ translate('password_is_required') }}");
                return;
            }

            if (getVal('#exampleRepeatPassword') !== getVal('#exampleInputPassword')) {
        ...
        /*$('#show-business-plan-div').on('click', function(e) {
            ...
            fileInputs.forEach(input => {
                ...
                if (input.files.length === 0) {
                    ...
                    toastr.error("{{ translate('Must_click_on_the_map_for_lat/long') }}");
                    e.preventDefault();
                } else if ($('#tax').val().length === 0 && !$('#tax_div').hasClass('d-none')) {
                    toastr.error("{{ translate('tax_is_required') }}");
                    e.preventDefault();
                } else if ($('#minimum_delivery_time').val().length === 0 && !$('#delivery_time_div').hasClass('d-none')) {
                    toastr.error("{{ translate('minimum_delivery_time_is_required') }}");
                    e.preventDefault();
                } else if ($('#max_delivery_time').val().length === 0 && !$('#delivery_time_div').hasClass('d-none')) {
                    toastr.error("{{ translate('max_delivery_time_is_required') }}");
                    e.preventDefault();
                }/!*
                else if ($('#minimum_service_delivery_time').val().length === 0 && !$('#service_delivery_time_div').hasClass('d-none')) {
                    toastr.error("{{ translate('minimum_service_time_is_required') }}");
                    e.preventDefault();
                } else if ($('#max_service_delivery_time').val().length === 0 && !$('#service_delivery_time_div').hasClass('d-none')) {
                    toastr.error("{{ translate('max_service_time_is_required') }}");
                    e.preventDefault();
                }*!/
                    ...
                    toastr.error("{{ translate('last_name_is_required') }}");
                    e.preventDefault();
                } else if ($('#identity_type').val().length === 0) {
                    toastr.error("{{ translate('identity_type_is_required') }}");
                    e.preventDefault();
                } else if ($('#identification_number').val().length === 0) {
                    toastr.error("{{ translate('identity_number_is_required') }}");
                    e.preventDefault();
