                ...
                <ul class="info">
                    ...
                    @if ($package->max_order == 'unlimited')
                        <li>
                            ...
                            <img src="{{ asset('/public/assets/landing/img/check-2.svg') }}" class="check-white"
                                alt="">
                            <span>
                                @if(isset($module) && $module == 'rental')
                                    {{ translate('messages.Unlimited_Trips') }}
                                @elseif(isset($module) && $module == 'service')
                                    {{ translate('messages.Unlimited_Bookings') }}
                                @else
                    ...
                    @if ($package->max_product == 'unlimited')
                        <li>
                            ...
                            <span>
                                @if(isset($module) && $module == 'rental')
                                    {{ translate('messages.Unlimited_vehicle_uploads') }}
                                @elseif(isset($module) && $module == 'service')
                                    {{ translate('messages.Unlimited_subscribe_sub_category') }}
                                @else
                                    {{ translate('messages.Unlimited_product_uploads') }}
                                @endif
                            </span>
                        </li>
                    @else
                        <li>
                            ...
                            <img src="{{ asset('/public/assets/landing/img/check-2.svg') }}" class="check-white"
                                ...
                                {{ $package->max_product }}
                                @if(isset($module) && $module == 'rental')
                                    {{ translate('messages.vehicle_uploads') }}
                                @elseif(isset($module) && $module == 'service')
                                    {{ translate('messages.subscribe_sub_category') }}
                                @else
                                    {{ translate('messages.product_uploads') }}
                                @endif
                            </span>
                        </li>
                    @endif
