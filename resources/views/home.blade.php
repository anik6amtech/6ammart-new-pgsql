...
@section('content')
    ...
    <section class="earn-money-section z-2">
        ...
        <div class="container">
            ...
            <!-- Earn Money Item -->
            @php($join_as_provider = $landing_data['provider_app_earning_links'])
            <div class="earn-item wow fadeInUp">
                <div class="earn-item-img"
                    style="background: url({{ \App\CentralLogics\Helpers::get_full_url('earning', isset($landing_data['earning_provider_image']) ? $landing_data['earning_provider_image'] : null, isset($landing_data['earning_provider_image_storage']) ? $landing_data['earning_provider_image_storage'] : 'public') }}) no-repeat center center / cover;">
                    <div class="position-relative dropdown text-capitalize z-2">
                        @if (isset($join_as_provider['playstore_url_status']) &&
                                $join_as_provider['playstore_url_status'] == '1' &&
                                isset($join_as_provider['apple_store_url_status']) &&
                                $join_as_provider['apple_store_url_status'] == '1')
                            <button type="button" class="cmn--btn border-0" data-bs-toggle="dropdown">
                                {{ translate('provider App') }}
                                <svg class="ms-2" width="12" height="7" viewBox="0 0 12 7"
                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M6.00224 5.46105L1.33333 0.415128C1.21002 0.290383 1 0.0787335 1 0.0787335C1 0.0787335 0.708488 -0.0458817 0.584976 0.0788632L0.191805 0.475841C0.0680976 0.600389 7.43292e-08 0.766881 7.22135e-08 0.9443C7.00978e-08 1.12172 0.0680976 1.28801 0.191805 1.41266L5.53678 6.80682C5.66068 6.93196 5.82624 7.00049 6.00224 7C6.17902 7.00049 6.34439 6.93206 6.46839 6.80682L11.8082 1.41768C11.9319 1.29303 12 1.12674 12 0.949223C12 0.771804 11.9319 0.605509 11.8082 0.480765L11.415 0.0838844C11.1591 -0.174368 10.9225 0.222512 10.6667 0.480765L6.00224 5.46105Z"
                            ...
                            <div class="dropdown-menu dropdown-menu-end p-0">
                                <a href="{{ isset($join_as_provider['playstore_url']) ? $join_as_provider['playstore_url'] : '' }}"
                                    class="dropdown-item">
                                    <img src="{{ asset('/public/assets/landing/img/google-play.png') }}"
                                        alt="">
                                    {{ translate('google_play') }}
                                </a>
                                <a href="{{ isset($join_as_provider['apple_store_url']) ? $join_as_provider['apple_store_url'] : '' }}"
                                    class="dropdown-item">
                                    <img src="{{ asset('/public/assets/landing/img/apple-store.png') }}"
                                        alt="">
                                    {{ translate('apple_store') }}
                        ...
                        @elseif(isset($join_as_provider['playstore_url_status']) && $join_as_provider['playstore_url_status'] == '1')
                            <a type="button" class="cmn--btn border-0"
                                href="{{ isset($join_as_provider['playstore_url']) ? $join_as_provider['playstore_url'] : '' }}">
                                {{ translate('provider App') }}
                            </a>
                        @elseif(isset($join_as_provider['apple_store_url_status']) && $join_as_provider['apple_store_url_status'] == '1')
                            <a type="button" class="cmn--btn border-0"
                                href="{{ isset($join_as_provider['apple_store_url']) ? $join_as_provider['apple_store_url'] : '' }}">
                                {{ translate('provider App') }}
                            </a>
                        @endif
                    </div>
                ...
                <div class="earn-item-cont">
                    <div>
                        <h4 class="subtitle">{{ translate('messages.Become a best') }} </h4>
                        <h3 class="title">{{ translate('messages.provider') }}</h3>
                    </div>
                </div>
            </div>
            <!-- Earn Money Item -->
            @php($join_as_serviceman = $landing_data['serviceman_app_earning_links'])
            <div class="earn-item wow fadeInUp">
                <div class="earn-item-img"
                    style="background: url({{ \App\CentralLogics\Helpers::get_full_url('earning', isset($landing_data['earning_serviceman_image']) ? $landing_data['earning_serviceman_image'] : null, isset($landing_data['earning_serviceman_image_storage']) ? $landing_data['earning_serviceman_image_storage'] : 'public') }}) no-repeat center center / cover;">
                    <div class="position-relative dropdown text-capitalize z-2">

                        @if (isset($join_as_serviceman['playstore_url_status']) &&
                                $join_as_serviceman['playstore_url_status'] == '1' &&
                                isset($join_as_serviceman['apple_store_url_status']) &&
                                $join_as_serviceman['apple_store_url_status'] == '1')
                            <button type="button" class="cmn--btn border-0" data-bs-toggle="dropdown">
                                {{ translate('Serviceman App') }}
                                <svg class="ms-2" width="12" height="7" viewBox="0 0 12 7"
                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M6.00224 5.46105L1.33333 0.415128C1.21002 0.290383 1 0.0787335 1 0.0787335C1 0.0787335 0.708488 -0.0458817 0.584976 0.0788632L0.191805 0.475841C0.0680976 0.600389 7.43292e-08 0.766881 7.22135e-08 0.9443C7.00978e-08 1.12172 0.0680976 1.28801 0.191805 1.41266L5.53678 6.80682C5.66068 6.93196 5.82624 7.00049 6.00224 7C6.17902 7.00049 6.34439 6.93206 6.46839 6.80682L11.8082 1.41768C11.9319 1.29303 12 1.12674 12 0.949223C12 0.771804 11.9319 0.605509 11.8082 0.480765L11.415 0.0838844C11.1591 -0.174368 10.9225 0.222512 10.6667 0.480765L6.00224 5.46105Z"
                            ...
                            <div class="dropdown-menu p-0">
                                <a href="{{ isset($join_as_serviceman['playstore_url']) ? $join_as_serviceman['playstore_url'] : '' }}"
                                    class="dropdown-item">
                                    <img src="{{ asset('/public/assets/landing/img/google-play.png') }}"
                                        alt="">
                                    {{ translate('google_play') }}
                                ...
                                <a href="{{ isset($join_as_serviceman['apple_store_url']) ? $join_as_serviceman['apple_store_url'] : '' }}"
                                    class="dropdown-item">
                                    <img src="{{ asset('/public/assets/landing/img/apple-store.png') }}"
                                        alt="">
                                    {{ translate('apple_store') }}
                        ...
                        @elseif(isset($join_as_serviceman['playstore_url_status']) && $join_as_serviceman['playstore_url_status'] == '1')
                            <a type="button"
                                href="{{ isset($join_as_serviceman['playstore_url']) ? $join_as_serviceman['playstore_url'] : '' }}"
                                class="cmn--btn border-0">
                                {{ translate('Serviceman App') }}
                            </a>
                        @elseif(isset($join_as_serviceman['apple_store_url_status']) && $join_as_serviceman['apple_store_url_status'] == '1')
                            <a type="button"
                                href="{{ isset($join_as_serviceman['apple_store_url']) ? $join_as_serviceman['apple_store_url'] : '' }}"
                                class="cmn--btn border-0">
                                {{ translate('Serviceman App') }}
                            </a>
                        @endif
                ...
                <div class="earn-item-cont">
                    <div>
                        <h4 class="subtitle">{{ translate('messages.Become a smart') }}</h4>
                        <h3 class="title">{{ translate('messages.Serviceman') }}</h3>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="contact-wrapper-inner">
                        <div class="left-side">
                            ...
                            <div class="counter-item wow fadeInUp">
                                ...
                                <h4 class="title"> <span class=" odometer"
                                        data-odometer-final="{{ $counter['provider_count_numbers'] ?? 0 }}"></span>
                                    <span>+</span>
                                </h4>
                                <div class="text">{{ translate('messages.Provider') }}</div>
                            </div>
                            <div class="counter-item wow fadeInUp">
                                <div class="icon">
                                    <svg width="32" height="26" viewBox="0 0 32 26" fill="none"
                                ...
                                <h4 class="title"> <span class=" odometer"
                                        data-odometer-final="{{ $counter['serviceman_count_numbers'] ?? 0 }}"></span>
                                    <span>+</span>
                                </h4>
                                <div class="text">{{ translate('messages.Serviceman') }}</div>
                            </div>
                            <div class="counter-item wow fadeInUp">
                                <div class="icon">
                                    <svg width="32" height="26" viewBox="0 0 32 26" fill="none"
