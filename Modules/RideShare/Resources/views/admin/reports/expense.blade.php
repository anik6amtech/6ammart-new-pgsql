            ...
            <div class="d-flex mb-3">
                <ul class="nav nav--tabs p-1 rounded bg-white" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a href="{{route('admin.transactions.ride-share.report.earning')}}" class="nav-link">Earning</a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a href="{{route('admin.transactions.ride-share.report.expense')}}" class="nav-link active">Expense</a>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="card h-100">
                        <div class="card-header d-flex flex-wrap justify-content-between gap-10 border-0 align-items-center pb-0">
                            ...
                            <div class="d-flex flex-wrap flex-sm-nowrap gap-2 align-items-center">
                                <select class="form-control js-select" id="dateRangeForExpenseStatistics">
                                ...
                                <div class="d-flex justify-content-center">
                                    <div class="position-relative pie-chart">
                                        ...
                                        <div class="total--rides">
                                            <h4 class="text-uppercase mb-xxl-2">{{\App\CentralLogics\Helpers::currency_symbol()}}<span id="totalExpense"></span></h4>
                                ...
                                <div>
                                    ...
                                    {{-- <div class="expense-info bg-F6F6F6">
                                        ...
                                        <div class="w-0 flex-grow-1">
                                            ...
                                            <h5 class="m-0">{{\App\CentralLogics\Helpers::currency_symbol()}}<span id="parcelExpense"></span></h5>
                                        </div>
                                    </div> --}}
                                </div>
                            </div>
                ...
                <div class="col-md-7">
                    <div class="card h-100">
                        <div class="card-header d-flex flex-wrap justify-content-between gap-10 pb-0 border-0 align-items-center">
                            ...
                            <div class="d-flex flex-wrap flex-sm-nowrap gap-2 align-items-center">
                                <select class="form-control js-select" id="dateRange">
            ...
            <div class="card pt-2 mb-4">
                <div class="card-header py-2">
                        <div class="search--button-wrapper gap-20px">
                            <h5 class="card-title text--title flex-grow-1">{{ translate('messages.Ride Wise Expense') }}</h5>
                            ...
                            <div class="hs-unfold m-0">
                                ...
                                <div id="usersExportDropdown"
                                    ...
                                    <a id="export-excel" class="dropdown-item"
                                        href="{{route('admin.transactions.ride-share.report.expenseReportExport',['file' => 'excel', request()->getQueryString()])}}">
                    ...
                    <table id="columnSearchDatatable"
                        ...
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="text-end">{{translate("Total Ride Cost")}} ({{\App\CentralLogics\Helpers::currency_symbol()}}) </th>
                                <th class="text-end">{{translate("Ride Discount")}}({{\App\CentralLogics\Helpers::currency_symbol()}})</th>
                                <th class="text-end">{{translate("Coupon Discount")}}({{\App\CentralLogics\Helpers::currency_symbol()}})</th>
                                <th class="text-end">{{translate("Expense")}}({{\App\CentralLogics\Helpers::currency_symbol()}})</th>
                             ...
                             <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center gap-2 align-items-center">
                                            <a target="_blank" href="{{route('admin.transactions.ride-share.report.singleExpenseReportExport',$trip->id)}}" class="btn btn-outline-primary btn-action">
...
@push('script_2')
    ...
    <script>
        ...
        function dateZoneWiseExpenseStatistics(date) {
            $.get({
                url: '{{route('admin.transactions.ride-share.report.dateZoneWiseExpenseStatistics')}}',
                dataType: 'json',
                data: {date: date},
                beforeSend: function () {
        ...
        function dateRideTypeWiseExpenseStatistics(date) {
            $.get({
                url: '{{route('admin.transactions.ride-share.report.dateRideTypeWiseExpenseStatistics')}}',
                dataType: 'json',
                data: {date: date},
                beforeSend: function () {
                    $('#resource-loader').show();
