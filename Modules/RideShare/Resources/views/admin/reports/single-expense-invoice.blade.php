<html>
@php($businessName = App\CentralLogics\Helpers::get_business_settings('business_name'))
@php($businessLogo = App\CentralLogics\Helpers::get_business_settings('header_logo'))
@php($businessContactEmail = App\CentralLogics\Helpers::get_business_settings('business_contact_email'))
@php($businessContactPhone = App\CentralLogics\Helpers::get_business_settings('business_contact_phone'))
@php($businessAddress = App\CentralLogics\Helpers::get_business_settings('business_address'))
@php($copyrightText = App\CentralLogics\Helpers::get_business_settings('copyright_text'))
