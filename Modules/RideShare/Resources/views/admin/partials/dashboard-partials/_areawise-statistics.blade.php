...
<div class="top-providers top-provider-progress">
    @if($trips->count()>0)
                ...
                @foreach($trips as $key => $trip)
                    <li>
                        ...
                        <div class="progress" data-toggle="tooltip" data-html="true"
                             ...
                             data-title="<div class='progress-tooltip'><span class='dot ongoing'></span>{{ translate("Ongoing Trips") }} - {{$trip['ongoing_trips']}}</div>
