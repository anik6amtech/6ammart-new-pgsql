...
@push('css_or_js')
    ...
    <link rel="stylesheet" href="{{asset('Modules/RideShare/public/assets/js/swiper@11/swiper-bundle.min.css')}}"/>
                ...
                <div class="card-header d-flex flex-wrap gap-3">
                    ...
                    <div class="d-flex flex-grow-1 gap-4">
                        ...
                        <div class="overview-button-group">
                            <a href="{{route('admin.ride-share.heat-map')}}">{{translate("Overview")}}</a>
                            <a href="{{route('admin.ride-share.heat-map-compare')}}" class="active">{{translate("Compare")}}</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                            ...
                            <form class="mb-4" action="{{url()->full()}}" method="GET">
                                <div class="mb-3">
                                    <label for="zone" class="form-label">{{translate("Zone")}} <i
                                            class="bi bi-info-circle-fill text-primary" data-toggle="tooltip"
                                            title="{{translate("Specify the zone for heatmap analysis")}}"></i></label>
                                    <select class="form-select js-select form-control" id="zone" name="zone_id" required>
                                            ...
                                            <div class="swiper-slide" id="slider{{$key}}">
                                                <div class="zone-compare-slide-item">
                                                    ...
                                                    <div class="map-container">
                                                        <div data-target="#compare-modal{{$key}}"
                                                             data-toggle="modal"
                                                             class="full-screen-button">
                                                            {{-- <i class="bi bi-arrows-fullscreen"></i> --}}
                                                            <i class="tio-exit-fullscreen-1-1"></i>
                                                        </div>
...
@push('script_2')
    ...
    <script src="{{asset('Modules/RideShare/public/assets/js/swiper@11/swiper-bundle.min.js')}}"></script>
    <script src="{{asset('Modules/RideShare/public/assets/js/maps/date-range-picker.js')}}"></script>
    <script src="{{asset('Modules/RideShare/public/assets/js/maps/map-init.js')}}"></script>
