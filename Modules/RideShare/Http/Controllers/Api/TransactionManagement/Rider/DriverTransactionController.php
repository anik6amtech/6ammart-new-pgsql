...
namespace Modules\RideShare\Http\Controllers\Api\TransactionManagement\Rider;

use Illuminate\Http\Request;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Validator;
use Modules\RideShare\Http\Resources\TransactionManagement\TransactionResource;
...
class DriverTransactionController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        $criteria = ['user_id' => auth('delivery_men')->user()->id];
    ...
    public function payableTransactionHistory(Request $request)
    {
        ...
        $criteria = [
            'user_id' => auth('delivery_men')->user()->id,
    ...
    public function referralEarningHistory(Request $request)
    {
        ...
        $data = $this->transactionService->getBy(criteria: $criteria, limit: $request->limit, offset: $request->offset, orderBy: ['updated_at' => 'desc']);
        $transactions = TransactionResource::collection($data);
