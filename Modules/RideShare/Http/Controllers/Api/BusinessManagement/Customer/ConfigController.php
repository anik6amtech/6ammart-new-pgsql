...
namespace Modules\RideShare\Http\Controllers\Api\BusinessManagement\Customer;
...
class ConfigController extends Controller
{
    ...
    public function __construct(BusinessSettingServiceInterface          $businessSettingService, 
                                ...
                                // ParcelRefundReasonServiceInterface $parcelRefundReasonService,
    ...
    public function placeApiAutocomplete(Request $request): JsonResponse
    {
        ...
        $mapApiKey = $this->map_api_key ?? null;
