...
use Modules\RideShare\Http\Resources\VehicleManagement\VehicleResource;
use Modules\RideShare\Http\Resources\ZoneManagement\ZoneResource;
...
class TripRequestResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        $trip_request = [
            ...
            'driver_rating_count' => $this->driver_received_reviews_count,
            ...
            'ride_cancellation_reason' => $this->ride_cancellation_reason
        ];
