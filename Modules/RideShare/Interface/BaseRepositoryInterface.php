...
interface BaseRepositoryInterface
{
    ...
    public function findOne(string|int $id, array $relations = [], array $withAvgRelations = [], array $whereHasRelations = [],array $withCountQuery = [], bool $withTrashed = false, bool $onlyTrashed = false, array $withoutGlobalScope=[]): ?Model;
