...
namespace Modules\RideShare\Interface;
...
interface BaseServiceInterface
{
    ...
    public function update(string|int $id, array|Request $data = []): ?Model;

    public function updatedBy(array $criteria = [], array $whereInCriteria = [], array $data = [], bool $withTrashed = false);

    public function findOne(string|int $id, array $withAvgRelations = [], array $relations = [],array $whereHasRelations = [], array $withCountQuery = [], bool $withTrashed = false, bool $onlyTrashed = false, array $withoutGlobalScope = []): ?Model;
