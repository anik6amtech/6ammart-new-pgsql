...
class DriverLevelService extends BaseService implements DriverLevelServiceInterface
{
    ...
    public function index(array $criteria = [], array $relations = [], array $whereHasRelations = [], array $orderBy = [], int $limit = null, int $offset = null, array $withCountQuery = [], array $appends = [], array $groupBy = [], bool $allModule=false): Collection|LengthAwarePaginator
    {
        ...
        return $this->driverLevelRepository->getBy(criteria: $data, searchCriteria: $searchData, whereBetweenCriteria: $whereBetweenCriteria, relations: $relations, orderBy: $orderBy, limit: $limit, offset: $offset, withCountQuery: $withCountQuery); 
    }
