...
namespace Modules\RideShare\Service\TransactionManagement;
...
class TransactionService extends BaseService implements TransactionServiceInterface
{
    ...
    {
        return $this->index(criteria: $criteria,orderBy: ['created_at' => 'desc'],limit: $limit,offset: $offset)->map(function ($item) {
            return [
                ...
                'Transaction To' => $item->user?->f_name . ' ' . $item->user?->l_name,
    ...
    public function index(array $criteria = [], array $relations = [], array $whereHasRelations = [], array $orderBy = [], int $limit = null, int $offset = null, array $withCountQuery = [], array $appends = [], array $groupBy = [], bool $allModule=false): Collection|LengthAwarePaginator
    {
        ...
        $whereInCriteria = [];
        $whereBetweenCriteria = [];
        return $this->transactionRepository->getBy(criteria: $data, searchCriteria: $searchData, whereInCriteria: $whereInCriteria, whereBetweenCriteria: $whereBetweenCriteria, whereHasRelations: $whereHasRelations, relations: $relations, orderBy: $orderBy, limit: $limit, offset: $offset, withCountQuery: $withCountQuery); 
    }
}
