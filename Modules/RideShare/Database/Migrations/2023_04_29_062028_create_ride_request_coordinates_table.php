...
class CreateRideRequestCoordinatesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ride_request_coordinates', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('ride_request_coordinates');
    }
}
