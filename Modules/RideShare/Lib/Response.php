...
const ORDER_CONFLICT_409 = [
    ...
    'message' => 'You already have a running order. Please complete it before accepting a new ride.'
];
...
const VEHICLE_404 = [
    'response_code' => 'vehicle_404',
    'message' => 'No vehicle found. Please activate or create new vehicle'
];
