...
class SubCategoryExport implements FromView, ShouldAutoSize, WithStyles, WithColumnWidths, WithHeadings, WithEvents
{
    use Exportable;
    ...
    {
        return view('service::file-exports.sub-category-export', [
            'data' => $this->data,
        ]);
    }
    ...
    public function styles(Worksheet $sheet) {
        ...
        return [
            'A1:F' . ($this->data['subCategories']->count() + 3) => [
                'borders' => [
                    'allBorders' => [
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                $event->sheet->getStyle('A3:F' . ($this->data['subCategories']->count() + 3))
                    ->getAlignment()
                    ->setHorizontal(Alignment::HORIZONTAL_CENTER)
                    ->setVertical(Alignment::VERTICAL_CENTER);
