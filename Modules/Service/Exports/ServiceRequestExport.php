...
class ServiceRequestExport implements  FromView, ShouldAutoSize, WithStyles ,WithHeadings, WithEvents
{
    ...
    {
        return view('service::file-exports.service-request-export', [
            'data' => $this->data,
        ]);
    }
