                ...
                <div class="row">
                    ...
                    <div class="col company-details">
                        <h2 class="name">
                            ...
                            @php($business_name = business_data('business_name'))
                            @php($business_email = business_data('email_address'))
                            @php($business_phone = business_data('phone'))
                            @php($business_address = business_data('address'))
                            <a target="_blank" href="#">
                                {{$business_name}}
                            </a>
                        </h2>
            ...
            <main>
                <div class="row contacts">
                    <div class="col invoice-to">
                        ...
                        <h2 class="to">{{$booking->customer->f_name.' '.$booking->customer->l_name}}</h2>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0">
                        ...
                        @foreach($booking->detail as $index=>$item)
                            <tr>
                                ...
                                <td class="unit">{{\App\CentralLogics\Helpers::format_currency($item->service_cost)}}</td>
                                <td class="qty">{{$item->quantity}}</td>
                                <td class="total">{{\App\CentralLogics\Helpers::format_currency($item->total_cost)}}</td>
                            </tr>
