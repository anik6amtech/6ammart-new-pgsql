...
<div class="content container-fluid">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
        ...
        <div class="d-flex gap-1">
            ...
            <a href="{{ route('admin.service.advertisement.show', [$previousId]) }}"  data-toggle="tooltip"
            ...
            @endif
                ...
                @if ($nextId)
                <a href="{{ route('admin.service.advertisement.show', [$nextId] ) }}"  data-toggle="tooltip"
                            ...
                            <div class="mb-20">
                                <div class="d-flex align-items-center flex-wrap gap-2 justify-content-md-end approve-buttons">
                                    ...
                                    <span>{{ translate('Deny') }}</span>
                                        ...
                                        <form  id="data-add-{{ $advertisement->id }}_form" action="{{ route('admin.service.advertisement.status',['status' => 'paused' ,'id' => $advertisement->id]) }}" method="get">
                                            @csrf
                                            @method('get')
                                    ...
                                    <a href="{{  route('admin.service.advertisement.edit',[$advertisement->id ,'request_page_type'=> isset($request_page_type) ]) }}" class="btn btn--primary">
                                        <i class="tio-edit"></i>
            ...
            <div class="h-100 d-flex flex-column gap-3">
                <div class="card flex-grow">
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.service.advertisement.paidStatus')}}" id="is_paid_form" method="get">
                            ...
                            <div class="mb-20">
                                ...
                                <form  id="data-add-{{ $advertisement->id }}_form" action="{{ route('admin.service.advertisement.status',['status' => 'approved' ,'id' => $advertisement->id]) }}" method="get">
                                    @csrf
                                    @method('get')
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{route('admin.store.view', $advertisement->store_id)}}" class="media align-items-start deco-none resturant--information-single">
                            <div class="avatar avatar-circle">
                                @if($advertisement->module_type == 'service')
                                    <img class="avatar-img w-75px" src="{{ $advertisement->store['logo_full_path'] ?? asset('public/assets/admin/img/100x100/food-default-image.png') }}" alt="image">
                                @else
                            ...
                            <div class="media-body pl-3">
                                <span class="fz--14px text-title font-semibold text-hover-primary d-block">
                                    {{ $advertisement?->store?->company_name }}
                                    </span>
                                    <span class="text-body">
                                        <strong class="text-title font-semibold">
                                            {{ $advertisement?->store?->total_order ?? 0 }}

                                            </strong>
                                            {{ translate('Orders served') }}
                                            </span>
                                            <span class="text-title font-semibold d-block">
                                                <i class="tio-call-talking-quiet"></i> {{ $advertisement?->store?->company_phone }}
                                </span>
                                <span class="text-title">
                                    <i class="tio-poi"></i> {{ $advertisement?->store?->company_address }}
                                </span>
                            </div>
                        </a>
                    </div>
            ...
            <div class="modal-body pb-5 pt-0">
                <div class="max-349 mx-auto mb-20">
                    ...
                    <div class="btn--container justify-content-center">
                            <a href="{{  route('admin.service.advertisement.edit',[$advertisement->id ,'request_page_type'=> isset($request_page_type) ]) }}"  class="btn btn-success min-w-120" >{{translate("Edit & Approve")}}</a>
                            <a href="{{ route('admin.service.advertisement.status',['status' => 'approved' ,'id' => $advertisement->id ,'approved' => 1]) }}" type="button"  class="btn btn--secondary  min-w-120">{{translate('Only Approve')}}</a>
            ...
            <div class="modal-body pb-5 pt-0">
                <div class="max-349 mx-auto mb-20">
                    ...
                    <div class="btn--container justify-content-center">
                        ...
                        <a href="{{ route('admin.service.advertisement.status',['status' => 'approved' ,'id' => $advertisement->id ,'approved' => 1]) }}" type="button"  class="btn btn-primary min-w-120">{{translate('Approve')}}</a>
    ...
    <script>
        $(function() {
            ...
            $('input[name="dates"]').on('apply.daterangepicker', function(ev, picker) {
                ...
                location.href = '{{ route('admin.service.advertisement.updateDate',$advertisement->id) }}' + '?start_date=' + picker.startDate.format('M/D/Y') + '&end_date=' + picker.endDate.format('M/D/Y');
            });
