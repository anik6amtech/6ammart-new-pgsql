...
<div class="content container-fluid overflow-hidden">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="{{ route('admin.service.advertisement.create') }}" class="btn btn-primary">  <i class="tio-add"></i> {{ translate('New Advertisement') }}</a>
    </div>
    <!-- Title -->
                ...
                <table class="font-size-sm table table-borderless table-thead-bordered table-nowrap table-align-middle card-table min-h-225px">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> <a href="{{ route('admin.service.advertisement.show',$add->id) }}"> {{ $add->id }}</a></td>
                            ...
                            <td>
                                <div class="dropdown dropdown-2">
                                    ...
                                    <ul class="dropdown-menu" dir="ltr">
                                        <a class="dropdown-item d-flex gap-2 align-items-center" href="{{ route('admin.service.advertisement.show',$add->id) }}">
                                            <i class="tio-visible-outlined"></i>
                                            {{ translate('View Ads') }}
                                        </a>

                                        @if ($add->active == 0)
                                        <a class="dropdown-item d-flex gap-2 align-items-center" href="{{ route('admin.service.advertisement.edit',$add->id) }}">
                                            <i class="tio-edit"></i>
                                        ...
                                        @if($add->status == 'paused')
                                            ...
                                            <form  id="data-add-{{ $add->id }}_form" action="{{ route('admin.service.advertisement.status',['status' => 'approved' ,'id' => $add->id]) }}" method="get">
                                                @csrf
                                                @method('get')
                                        ...
                                        <a class="dropdown-item d-flex gap-2 align-items-center" href="{{ route('admin.service.advertisement.copyAdd', $add->id) }}" >
                                            <i class="tio-copy"></i>
                                            {{ translate('Copy_Ads') }}
                                            </a>
                                        ...
                                        id="delete-add-{{ $add->id }}"
                                            ...
                                            <form  id="delete-add-{{ $add->id }}_form" action="{{ route('admin.service.advertisement.destroy',$add->id) }}" method="post">
                                                @csrf
                                                @method('delete')
                                            </form>
    ...
    <div class="modal-dialog modal-dialog-centered status-warning-modal">
        <div class="modal-content">
            ...
            <div class="modal-body pb-5 pt-0">
                <form action="{{ route('admin.service.advertisement.priority') }}" method="get">
