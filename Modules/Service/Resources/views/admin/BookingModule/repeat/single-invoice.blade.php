...
<div id="invoice">
    <div class="invoice d-flex flex-column">
        <div>
            <table>
                ...
                <tr>
                    <td>
                        ...
                        <div>{{translate('Booking')}} #{{$booking->readable_id}} <img src="{{asset('/public/assets/admin/img/repeat2.png')}}" width="15px" height="15px" alt=""></div>
            ...
            @php($customer_name = $booking->booking->customer ? $booking?->booking?->customer?->f_name.' '.$booking?->booking?->customer?->l_name : $booking?->booking?->service_address?->contact_person_name)
                    ...
                    <tr>
                        ...
                        <td class="border-bottom">
                            <div class="text-right">
                                <div>{{translate('Invoice of')}} ({{\App\CentralLogics\Helpers::currency_code()}})</div>
                                <h5 style="font-size:20px; font-weight: 700;margin:0;color:#007bff">{{\App\CentralLogics\Helpers::format_currency($booking->total_booking_amount)}}</h5>
                            </div>
                        </td>
                    </tr>
                </table>
