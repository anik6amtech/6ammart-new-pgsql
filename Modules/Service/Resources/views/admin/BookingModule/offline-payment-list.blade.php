...
@section('title',translate('Offline payment booking list'))
...
@section('content')
    <div class="content container-fluid">
        ...
        <h2 class="h1 mb-sm-3 mb-2 text-capitalize d-flex align-items-center gap-2">
            {{translate('Offline payment booking list')}} <span class="rounded py-1 fz-12px px-2 mb-0 text-title" data-bg-color="#3342571A">{{ $bookings->total() }}</span>
        </h2>
            ...
            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                <div class="card">
                    <div class="data-table-top border-bottom d-flex flex-wrap gap-3 justify-content-between p-3">
                        <form action="{{url()->current()}}?booking_status={{$queryParams['booking_status']}}" method="post">
                            @csrf
