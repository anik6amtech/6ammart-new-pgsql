                                ...
                                <div class="media-body d-flex justify-content-between">
                                    <div>
                                        ...
                                        <ul class="list-info">
                                            ...
                                            @endif
                                                <li>
                                                    <i class="tio-map"></i><p id="customer_service_location" class="{{ empty($booking?->service_address?->address) ? 'text-danger' : '' }}">
                                ...
                                <div class="media gap-2 flex-wrap p-3 rounded bg-card mt-3">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <ul class="list-info">
                                            ...
                                            <li>
                                                <i class="tio-map"></i><p>{{ Str::limit($booking->provider->company_address ?? '', 100) }}</p>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
