...
@section('title',$provider->company_name."'s ".translate('messages.meta_data'))
    ...
    <div class="tab-content">
        <div class="tab-pane fade show active" id="vendor">
            <div class="card">
                ...
                @php($defaultLang = 'en')
                <div class="card-body">
                    <form action="{{route('admin.service.provider.update-meta-data',[$provider['id']])}}" method="post"
                                        ...
                                        id="default-form">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="meta_title[]" id="default_title"
                                                    class="form-control" placeholder="{{ translate('messages.meta_title') }}" value="{{$provider->getRawOriginal('meta_title')}}"
                                                >
                                            </div>
                                            ...
                                            <div class="form-group mb-0">
                                                ...
                                                <textarea type="text" name="meta_description[]" placeholder="{{translate('messages.meta_description')}}" class="form-control min-h-90px ckeditor">{{$provider->getRawOriginal('meta_description')}}</textarea>
                                            </div>
                                        </div>
                                            @foreach (json_decode($language) as $lang)
                                            <?php
                                            ...
                                            <label class="__custom-upload-img mr-lg-5">
                                                ...
                                                <div class="text-center">
                                                    <img class="img--110 min-height-170px min-width-170px onerror-image" id="viewer"
                                                        ...
                                                        src="{{ $provider->meta_image_full_url ??  asset('public/assets/admin/img/upload.png') }}"
