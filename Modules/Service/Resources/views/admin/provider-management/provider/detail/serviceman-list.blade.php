...
{{--                                    alt="{{ translate('messages.csv') }}">--}}
{{--                                {{ translate('messages.csv') }}--}}
{{--                            </a>--}}
{{--                        </div>--}}
{{--                    </div>--}}
                    <a href="{{ route('admin.service.provider.serviceman.create', ['id' => $provider->id]) }}" class="btn btn--primary">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <div class="__body">
                                                <a href="{{ route('admin.service.provider.serviceman.details', ['id' => $serviceman->service_provider_id, 'serviceman_id' => $serviceman->id]) }}">
...
{{--                                                </div>--}}
                                    ...
                                    <td>
                                        <div class="table-actions justify-content-end d-flex gap-2">
                                            ...
                                            <a href="{{ route('admin.service.provider.serviceman.edit', ['id' => $serviceman->service_provider_id, 'serviceman_id' => $serviceman->id]) }}"
                                            ...
                                            <a class="btn action-btn btn--danger btn-outline-danger form-alert" href="javascript:"
                                                data-id="vendor-{{$provider['id']}}" data-message="{{translate('You want to remove this serviceman')}}" title="{{translate('messages.delete_provider')}}"><i class="tio-delete-outlined"></i>
                                            </a>
                                            <form action="{{ route('admin.service.provider.serviceman.delete', ['id' => $serviceman->service_provider_id, 'serviceman_id' => $serviceman->id]) }}" method="post" id="vendor-{{$provider['id']}}">
                                                @csrf @method('delete')
                                            </form>
                                        </div>
                                    </td>
