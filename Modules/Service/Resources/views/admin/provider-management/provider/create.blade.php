...
@section('content')
    <div class="content container-fluid">
        ...
        <!-- End Page Header -->
        <form action="{{ route('admin.service.provider.store') }}" method="post" enctype="multipart/form-data" id="providerFormSubmit">
            @csrf
                                            ...
                                            <div class="card-body">
                                                ...
                                                @else
                                                    <div id="default-form">
                                                        ...
                                                        <div class="form-group mb-0">
                                                            <label class="input-label font-semibold"
                                                                for="exampleFormControlInput1">{{ translate('messages.address') }} <span class="text-danger">*</span>
                                                            </label>
                                                            <textarea type="text" name="address[]" placeholder="{{ translate('messages.address') }}" required
                                                                class="form-control min-h-90px ckeditor"></textarea>
                                                        </div>
                                                    </div>
                                                @endif
                                        ...
                                        <div class="row g-2">
                                            <div class="col-md-6">
                                                <div class="form-group mb-0 mt-3">
                                                    ...
                                                    <input type="email" id="business_email" name="business_email" value="{{ old('business_email') }}" class="form-control"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mb-0 mt-3">
                                                    ...
                                                    <input type="tel" id="business_phone" name="business_phone" value="{{ old('business_phone') }}" class="form-control business-phone-input"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="d-flex flex-column flex-sm-row gap-4">
                                            ...
                                            <div class="__custom-upload-img">
                                                ...
                                                @php($icon = $icon->value ?? '')
                                                <label class="form-label mb-1">
                                                    {{ translate('Cover') }} <span class="text-danger">*</span>
                                                </label>
                                                <div class="mb-20">
                                                    <p class="fs-12">
                            ...
                            <div class="card-body">
                                <div class="row g-3 my-0">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label class="input-label font-semibold"
                                                for="choice_zones">{{ translate('messages.business_zone') }} <span class="text-danger">*</span>
                                        ...
                                        {{--<div class="position-relative">
                                            <label class="input-label font-semibold"
                                                for="tax">{{ translate('Approx. Service Time') }} <span class="text-danger">*</span></label>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-4 col-sm-6">
                                        <div class="js-form-message form-group mb-0">
                                            <label class="input-label"
                                                for="signupSrPassword">{{ translate('password') }} <span class="text-danger">*</span><span
                                    ...
                                    <div class="col-md-4 col-sm-6">
                                        <div class="js-form-message form-group mb-0">
                                            <label class="input-label"
                                                for="signupSrConfirmPassword">{{ translate('messages.Confirm Password') }} <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-12">
                                        <div>
                                            <div class="mb-xl-3 mb-2">
                                                ...
                                                <span class="fz-12px">{{ translate('messages.pdf,_doc,_jpg_file_size_max_2_mb') }}</span>
                                            </div>
                                        ...
                                        <label class="business-plan-card-wrapper">
                                            ...
                                            <div class="business-plan-card">
                                                ...
                                                <p class="fs-14 text-title opacity-70 mb-0">
                                                    {{ translate('messages.You have to give a certain percentage of commission to admin for every Booking request.') }}
                                                </p>
                                            </div>
                                        </label>
                                    </div>
...
<div class="d-none" id="data-set"
     ...
     data-store-logo-required="{{ translate('Provider_logo_&_cover_photos_are_required') }}"
     data-store-name-required="{{ translate('Provider_name_is_required') }}"
     data-store-address-required="{{ translate('Provider_address_is_required') }}"

     data-store-business-phone-required="{{ translate('Valid_business_phone_number_is_required') }}"
...
{{--    data-min-delivery-time-required="{{ translate('minimum_service_time_is_required') }}"--}}
{{--    data-max-delivery-time-required="{{ translate('max_service_time_is_required') }}"--}}
...
@push('script_2')
    ...
    <script src="{{asset('Modules/Service/public/assets/js/admin/provider-create.js')}}"></script>
