...
@section('content')
    <div class="content container-fluid">
        ...
        <!-- End Page Header -->
        <form action="{{ route('admin.service.provider.serviceman.update', ['id' => $provider->id, 'serviceman_id' => $serviceman->id]) }}" method="post" enctype="multipart/form-data" id="providerFormSubmit">
            @csrf
            @method('put')
