        ...
        <div class="container-fluid">
            ...
            <div class="mb-4">
                <ul class="nav nav--tabs nav--tabs__style2">
                    <li class="nav-item">
                        <a href="{{route('admin.transactions.service.report.business.subscription-earning')}}"
                           class="nav-link active">{{translate('Subscription Earning')}}</a>
                    </li>
                    <li class="nav-item">
                        <a href="{{route('admin.transactions.service.report.business.commission-earning')}}"
                ...
                <div class="earning-details-card-wrapper">
                    <div class="card left-card">
                        <div class="card-body py-3">
                            <img class="position-absolute left-0 bottom-0" src="{{asset('/public/assets/admin/img/icons/mask-shape.png')}}" alt="">
                            <div class="text-center position-relative">
                                <img src="{{asset('/public/assets/admin/img/icons/wallet.png')}}" alt="">
                                <h3 class="text-primary fw-bold fs-4 mb-2 mt-4">{{ \App\CentralLogics\Helpers::format_currency( $subscriptionTotal ) }}</h3>
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="wallet-slider-card">
                                            ...
                                            <h4 class="fw-bold">{{ \App\CentralLogics\Helpers::format_currency( $package->subscriberPackageLogs->sum('package_price')) }}</h4>
                                        </div>
                                    </div>
                                    @endforeach
                                </div>
                        ...
                        <div class="d-flex flex-wrap align-items-center gap-3">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                                    <li><a class="dropdown-item" href="{{ route('admin.transactions.service.report.business.subscription.download',['search'=>$search]) }}">{{translate('Excel')}}</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="table align-middle">
                            ...
                            @forelse($packagesSubscribers as $key => $subscriber)
                                <tr>
                                    ...
                                    <td>{{ \App\CentralLogics\Helpers::format_currency($subscriber?->logs->sum('package_price') ) }}</td>
                                    <td>{{ \App\CentralLogics\Helpers::format_currency($subscriber?->logs->sum('vat_amount')) }}</td>
                                    <td>{{ \App\CentralLogics\Helpers::format_currency($subscriber?->logs->sum('package_price') - $subscriber?->logs->sum('vat_amount')) }}</td>
                                </tr>
                            @empty
                                <tr>
