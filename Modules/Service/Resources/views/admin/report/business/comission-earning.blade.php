                    ...
                    <div class="card h-100">
                        <div class="card-body">
                            <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                                ...
                                <div>
                                    <h4 class="">
                                        <span class="c1 fw-semibold">{{ \App\CentralLogics\Helpers::format_currency(array_sum($chartData)) }}</span>
                        ...
                        <div class="d-flex flex-wrap align-items-center gap-3">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                                    <li><a class="dropdown-item" href="{{ route('admin.transactions.service.report.business.commission.download',['search'=>$search]) }}">{{translate('Excel')}}</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="table align-middle">
                            ...
                            @forelse($commissionEarningList as $key => $earning)
                                <tr>
                                    ...
                                    <td class="text-end">{{ \App\CentralLogics\Helpers::format_currency($earning->booking->total_booking_amount) }}</td>
                                    <td class="text-end">{{ \App\CentralLogics\Helpers::format_currency($earning->admin_commission) }}</td>
                                </tr>
                            @empty
                                <tr>
