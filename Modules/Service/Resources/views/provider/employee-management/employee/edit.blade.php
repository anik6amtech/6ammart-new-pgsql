...
<div class="content container-fluid">
    ...
    <!-- Content Row -->
    <form action="" method="post" enctype="multipart/form-data" class="js-validate">
        @csrf
        <div class="card">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group mb-0">
                            ...
                            <select class="form-control w-100" id="role_id" name="role_id">
                                    ...
                                    @foreach($rls as $r)
                                        <option
                                            value="{{$r->id}}" {{$r['id']==$e['provider_role_id']?'selected':''}}>{{ucwords($r->name)}}</option>
                                    @endforeach
                            </select>
                        </div>
                    </div>
...
<script>
    ...
    $('#reset_btn').click(function(){
        $('#viewer').attr('src','{{asset('storage/app/public/provider')}}/{{$e['image']}}');
    });
