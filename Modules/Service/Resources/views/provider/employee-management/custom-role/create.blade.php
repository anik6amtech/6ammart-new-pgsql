                    ...
                    <div class="check-item">
                        <div class="form-group form-check form--check">
                            <input type="checkbox" name="modules[]" value="booking" class="form-check-input"
                                    id="booking">
                            <label class="form-check-label input-label " for="booking">{{translate('messages.bookings')}}</label>
                        </div>
                    </div>
                    <div class="check-item">
                        <div class="form-group form-check form--check">
                            ...
                            <td>
                                <div class="btn--container justify-content-center">
                                    <a class="btn action-btn btn--primary btn-outline-primary"
                                        href="{{route('provider.service.custom-role.edit',[$r['id']])}}" title="{{translate('messages.edit_role')}}"><i class="tio-edit"></i>
                                    </a>
                                ...
                                <form action="{{route('provider.service.custom-role.delete',[$r['id']])}}"
