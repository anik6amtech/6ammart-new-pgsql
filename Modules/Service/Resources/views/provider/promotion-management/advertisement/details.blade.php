...
<div class="content container-fluid">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
        ...
        <div class="d-flex gap-1">
            ...
            @if ($previousId)
            <a href="{{ route('provider.service.advertisement.show', [$previousId]) }}"  data-toggle="tooltip"
            ...
            @endif
                ...
                @if ($nextId)
                <a href="{{ route('provider.service.advertisement.show', [$nextId] ) }}"  data-toggle="tooltip"
                        ...
                        <div class="col-md-6">
                            <div class="mb-20">
                                <div class="d-flex align-items-center flex-wrap gap-2 justify-content-md-end approve-buttons">
                                    <a href="{{  route('provider.service.advertisement.edit',[$advertisement->id ,'request_page_type'=> isset($request_page_type) ]) }}" class="btn btn--primary">
                                        <i class="tio-edit"></i>
            ...
            <div class="h-100 d-flex flex-column gap-3">
                <div class="card flex-grow">
                    <div class="card-body">
                        ...
                        <a href="javascript:void(0)" class="media align-items-start deco-none resturant--information-single">
