...
@section('title', translate('Advertisement_Edit'))
    ...
    <script>
        $(document).on('ready', function() {
            $('#create-add-form').on('submit', function (event) {
                ...
                $.post({
                    url: `{{ route('provider.service.advertisement.update',$advertisement?->id) }}`,
                    ...
                    success: function (data) {
                        ...
                        if (data.errors) {
                            ...
                            setTimeout(function () {
                                location.href = '{{route('provider.service.advertisement.index')}}';
                            }, 2000);
                        }
                    }
                });
