...
@section('title', translate('messages.provider_registration'))
@push('css_or_js')
    ...
    <section class="m-0 py-5">
        <div class="container">
            ...
            <div class="section-header">
                <h2 class="title mb-2">{{ translate('messages.provider') }} <span class="text--base">{{translate('application')}}</span></h2>
            </div>
            <!-- End Page Header -->
