            ...
            <table>
                ...
                <tr>
                    <td>
                        ...
                        <div>{{translate('Booking')}} #{{$booking->id}} <img src="{{asset('/public/assets/admin/img/repeat2.png')}}" width="15px" height="15px" alt=""></div>
...
{{--                                </div>--}}
                    ...
                    <table cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            ...
                            <td>{{\App\CentralLogics\Helpers::format_currency($sub_total*count($booking->repeat))}}</td>
                        </tr>
                        <tr>
                            <td colspan="3"></td>
