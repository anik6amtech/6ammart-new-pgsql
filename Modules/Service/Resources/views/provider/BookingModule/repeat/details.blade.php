                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="card mb-3">
                                <div class="d-flex align-items-center justify-content-between gap-2 flex-wrap p-3 border-bottom">
                                    ...
                                    <a href="{{ route('provider.service.booking.repeat_single_details', [$booking?->nextService['id'], 'web_page' => 'details'])}}" class="btn btn--primary text-capitalize fw-semibold fz-14">
