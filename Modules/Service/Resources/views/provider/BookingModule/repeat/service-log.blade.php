...
@section('title',translate('Booking Service Log'))
...
@section('content')
        ...
        <div class="pb-3 d-flex justify-content-between align-items-center gap-3 flex-wrap">
            ...
            <div class="d-flex flex-wrap flex-xxl-nowrap gap-3">
                <div class="d-flex flex-wrap gap-3">
                    ...
                    @endif
                    <a href="{{route('provider.service.booking.full_repeat_invoice',[$booking->id])}}" class="btn d-flex align-items-center gap-1 btn--primary"  target="_blank">
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex flex-wrap justify-content-between align-content-center gap-3">
                                                        ...
                                                        <div class="d-flex gap-2 justify-content-center">
                                                            <a href="{{ route('provider.service.booking.single_invoice', [$booking->nextService['id']]) }}" type="button" target="_blank"
                                                               class="action-btn btn--light-primary text-primary fw-medium text-capitalize fz-14"
                                                               style="--size: 30px">
                                                                <i class="tio-file"></i>
                                                            </a>
                                                            <a href="{{ route('provider.service.booking.repeat_single_details', [$booking->nextService['id'], 'web_page' => 'details'])}}" type="button"
                                                               class="action-btn btn--light-primary text-primary fw-medium text-capitalize fz-14"
                                                               style="--size: 30px">
                                                ...
                                                <div class="card card-border w-100">
                                                    <div class="card-body">
                                                        <div class="d-flex flex-wrap justify-content-between align-content-center gap-3">
                                                            ...
                                                            <div class="d-flex gap-2 justify-content-center">
                                                                <a href="{{ route('provider.service.booking.single_invoice', [$data['id']]) }}" type="button"
                                                                   class="action-btn btn--light-primary text-primary fw-medium text-capitalize fz-14" target="_blank"
                                                                   style="--size: 30px">
                                                                    <i class="tio-file"></i>
                                                                </a>
                                                                <a href="{{ route('provider.service.booking.repeat_single_details', [$data['id'], 'web_page' => 'details'])}}" type="button"
                                                                   class="action-btn btn--light-primary text-primary fw-medium text-capitalize fz-14"
                                                                   style="--size: 30px">
                                                                    <i class="tio-visible"></i>
                                                                </a>
                                                            ...
                                                            <div class="dropstart">
                                                                ...
                                                                <ul class="dropdown-menu border-none dropdown-menu-right px-3" style="position:fixed; z-index:999999 !important; inset:auto;">
                                                                    @if($booking['booking_status'] != 'pending')
                                                                        <li><a class="dropdown-item d-flex align-items-center gap-1" type="button" class="btn btn-primary" data-toggle="modal" data-target="#reschedule-{{$upComing['id']}}"
                                                                               href="javascript:">
                                                                            <i class="tio-remaining-time"></i>
                                                                                {{ translate('Reschedule') }}
                                                                            </a>
                                                                        </li>
                                                                    @endif
                                                                    <li><a class="dropdown-item d-flex align-items-center gap-1" target="_blank"
                                                                           href="{{ route('provider.service.booking.single_invoice', [$upComing['id']]) }}">
                                                                    ...
                                                                    @if($booking['booking_status'] != 'pending')
                                                                        <li><button type="button"
                                                                            ...
                                                                            <form
                                                                                action="{{route('provider.service.booking.up_coming_booking_cancel',[$upComing['id']])}}"
                                            ...
                                            <div class="modal fade" id="reschedule-{{$upComing['id']}}" tabindex="-1" aria-labelledby="" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="{{ route('provider.service.booking.up_coming_booking_schedule_update', [$upComing['id']]) }}" method="post">
                                                            @csrf
                                ...
                                <div class="card-body">
                                    ...
                                    @else
                                        <div class="d-flex align-items-center gap-2">
                                            <button type="button" class="btn w-100 btn--cancel {{ env('APP_ENV') != 'demo' ? 'form-alert' : 'demo_check' }}"
                                            ...
                                            <button  type="button" class="btn w-100 btn--accept {{ env('APP_ENV') != 'demo' ? 'form-alert' : 'demo_check' }}"
                                        ...
                                        <form
                                            action="{{route('provider.service.booking.ignore',[$booking['id']])}}"
                                        ...
                                        <form
                                            action="{{route('provider.service.booking.accept',[$booking['id']])}}"
    ...
    <div class="modal fade" id="serviceAddressModal--{{$booking['id']}}" tabindex="-1"
         ...
         aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <form action="{{route('provider.service.booking.service_address_update', [$booking['id']])}}">
                <div class="modal-content">
            ...
            <div class="modal-dialog modal-xl modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body px-4">
                        ...
                        <form action="{{ route('provider.service.booking.service.update_repeat_booking_service') }}"
    ...
    @include('service::provider.BookingModule.partials.details._repeat-details-service-location-modal')

    @include('service::provider.BookingModule.partials.details._update-customer-address-modal')
@endsection
    ...
    <script type="text/javascript">
        ...
        $("#booking_status").change(function () {
            ...
            if (parseInt(booking_status) !== 0) {
                var route = '{{route('provider.service.booking.status_update',[$booking->id])}}' + '?booking_status=' + booking_status;
        ...
        function payment_status_change(paymentStatus) {
            let route = '{{route('provider.service.booking.payment_update',[$booking->id])}}' + '?payment_status=' + paymentStatus;
        ...
        function service_schedule_update() {
            ...
            var route = '{{route('provider.service.booking.schedule_update',[$booking->id])}}' + '?service_schedule=' + service_schedule;
        ...
        function update_booking_details(route, message, componentId, updatedValue, type = 'get') {
            Swal.fire({
                ...
                if (result.value) {
                    let evidence_status = {{ (business_config('service_complete_photo_evidence', 'service_business_settings'))->value == 1 ? 'true' : 'false' }};
                    let booking_otp_status = {{ (business_config('otp_for_complete_service', 'service_business_settings'))->value == 1 ? 'true' : 'false' }};
                    if (componentId === 'booking_status' && updatedValue === 'completed') {
                        if (evidence_status) {
                            ...
                            $('#uploadPictureForm').on('submit', function (e) {
                                ...
                                $.ajax({
                                    url: "{{route('provider.service.booking.evidence_photos_upload',[$booking->id])}}",
                                    data: formData,
                                    processData: false,
                                    contentType: false,
                                    type: 'POST',
