                    ...
                    <div class="media-body">
                        ...
                        <div class="provider-devider">
                            <ol class="breadcrumb fs-12 mb-0">
                                <li class="breadcrumb-item active">{{translate('Bookings')}} - {{$matchedServiceman->total_booking ?? 0}}</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <div class="d-flex gap-2 justify-content-between align-items-center mt-4 pb-3 flex-wrap">
                <div class="media gap-2">
                    ...
                    <div class="media-body">
                        ...
                        <div class="provider-devider">
                            <ol class="breadcrumb fs-12 mb-0">
                                <li class="breadcrumb-item active">{{translate('Bookings')}} - {{$serviceman->total_booking ?? 0}}</li>
                            </ol>
                        </div>
                    </div>
                </div>
