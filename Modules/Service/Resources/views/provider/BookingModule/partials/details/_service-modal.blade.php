            ...
            <div class="modal-body px-4">
                <div class="row">
                    <div class="col-md-6 col-lg-4">
                        <div class="mb-30" data-toggle="tooltip" data-placement="top"
                             title="{{translate('Can not change Category')}}">
                            <select class="form-control w-100 disabled" id="category_selector__select"
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="mb-30" data-toggle="tooltip" data-placement="top"
                            ...
                            <select class="form-control w-100 disabled" id="sub_category_selector__select"
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="mb-30">
                            <select class="form-control w-100" id="service_selector__select" name="service_id"
                                    required>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="mb-30">
                            <select class="form-control w-100" id="service_variation_selector__select"
...
{{--                            <button type="reset" class="btn btn--secondary">{{translate('reset')}}</button>--}}
                ...
                <form action="{{route('provider.service.booking.service.update_booking_service')}}" method="POST"
                                ...
                                <tr id="service-row--{{$detail?->variant_key}}">
                                    <td class="text-wrap ps-lg-3">
                                        @if(isset($detail->service))
                                            <div class="d-flex flex-column">
                                                <a href="{{route('provider.service.service.service-details',[$detail->service->id])}}"
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center">
                                            <i class="tio-delete text-danger cursor-pointer remove-service-row" data-row="service-row--{{$detail['variant_key']}}"> </i>
                                        </div>
                                    </td>
