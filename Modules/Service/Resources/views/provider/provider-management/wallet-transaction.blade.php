...
@section('title', translate('messages.Provider Subscription Refund Transaction'))
    ...
    <div class="content container-fluid">
        ...
        <div class="js-nav-scroller hs-nav-scroller-horizontal mb-4">
            <ul class="nav nav-tabs border-0 nav--tabs nav--pills">
                <li class="nav-item">
                    <a href="{{ route('provider.service.subscriptionackage.subscriberDetail',$provider->id) }}" class="nav-link ">{{ translate('Subscription_Details') }} </a>
                </li>
                <li class="nav-item">
