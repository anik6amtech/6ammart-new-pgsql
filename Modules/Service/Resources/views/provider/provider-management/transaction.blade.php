...
@section('title', translate('messages.Provider Subscription Transaction'))
    ...
    <div class="content container-fluid">
        ...
        <div class="js-nav-scroller hs-nav-scroller-horizontal mb-4">
            <ul class="nav nav-tabs border-0 nav--tabs nav--pills">
                <li class="nav-item">
                    <a href="{{ route('provider.service.subscriptionackage.subscriberDetail',$id) }}" class="nav-link ">{{ translate('Subscription_Details') }} </a>
                </li>
                <li class="nav-item">
        ...
        <div class="card mb-20">
            ...
            <form action="{{ route('provider.service.subscriptionackage.subscriberTransactions',$id) }}" method="get">
                <div class="card-body">
                    <div class="row">
                    ...
                    <div class="hs-unfold">
                        ...
                        <div id="usersExportDropdown"
                            ...
                            <a id="export-excel" class="dropdown-item"
                                href="{{ route('provider.service.subscriptionackage.subscriberTransactionExport', ['export_type' => 'excel', request()->getQueryString()]) }}">
                            ...
                            <tr>
                                ...
                                <td class="px-4">
                                    <div class="btn--container justify-content-center">
                                        <button class="btn action-btn btn--warning btn-outline-warning printButton" data-url={{ route('provider.service.subscriptionackage.invoice',$transaction->id) }} >
                                            <i class="tio-print"></i>
                                    </div>
                                </td>
                            </tr>
