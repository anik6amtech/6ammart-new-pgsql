                ...
                <div class="col-12">
                    ...
                    <div class="mb-3">
                        <ul class="nav nav--tabs nav--pills nav--tabs__style2">
                            <li class="nav-item">
                                <a href="{{route('provider.service.report.business.overview')}}" class="nav-link">{{translate('Overview')}}</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{route('provider.service.report.business.earning')}}" class="nav-link">{{translate('Earning_Report')}}</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{route('provider.service.report.business.expense')}}" class="nav-link active">{{translate('Expense_Report')}}</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="card mb-1">
                        <div class="card-body">
                            ...
                            <form action="{{route('provider.service.report.business.expense')}}" method="POST">
                                @csrf
                                <div class="row">
                        ...
                        <div class="col-xl-3">
                            <div class="d-flex flex-wrap gap-2">
                                <div class="card justify-content-center flex-row gap-3 p-30 flex-wrap flex-grow-1">
                                    ...
                                    <div class="">
                                        <h2 class="fs-24 lh-1 m-0">{{\App\CentralLogics\Helpers::format_currency($totalPromotionalCost['total_expense'])}}</h2>
                                        <span class="fs-12">{{translate('Total_Expenses')}}</span>
                                    </div>
                                </div>

                                <div class="card justify-content-center flex-row gap-3 p-30 flex-wrap flex-grow-1">
                                    <img width="35" class="avatar" src="{{asset('public/assets/admin')}}/img/discount-box.png" alt="">
                                    <div class="">
                                        <h2 class="fs-24 lh-1 m-0">{{\App\CentralLogics\Helpers::format_currency($totalPromotionalCost['discount'])}}</h2>
                                ...
                                <div class="card justify-content-center flex-row gap-3 p-30 flex-wrap flex-grow-1">
                                    <img width="35" class="avatar" src="{{asset('public/assets/admin')}}/img/discount-box.png" alt="">
                                    <div class="">
                                        <h2 class="fs-24 lh-1 m-0">{{\App\CentralLogics\Helpers::format_currency($totalPromotionalCost['campaign'])}}</h2>
                                ...
                                <div class="card justify-content-center flex-row gap-3 p-30 flex-wrap flex-grow-1">
                                    <img width="35" class="avatar" src="{{asset('public/assets/admin')}}/img/discount-box.png" alt="">
                                    <div class="">
                                        <h2 class="fs-24 lh-1 m-0">{{\App\CentralLogics\Helpers::format_currency($totalPromotionalCost['coupon'])}}</h2>
                                    ...
                                    <div class="d-flex flex-wrap align-items-center gap-3">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu z--2 bg-white dropdown-menu-lg dropdown-menu-right">
                                               <li><a class="dropdown-item" href="{{route('provider.service.report.business.expense.download').'?'.http_build_query($queryParams)}}">{{translate('Excel')}}</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <table class="table align-middle table-borderless align-middle-cus m-0">
                                    ...
                                    @forelse($filteredBookingAmounts as $key=>$amount)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$amount->booking->id}}</td>
                                            <td>{{\App\CentralLogics\Helpers::format_currency($amount['discount_by_provider'])}}</td>
                                            <td>{{\App\CentralLogics\Helpers::format_currency($amount['coupon_discount_by_provider'])}}</td>
                                            <td>{{\App\CentralLogics\Helpers::format_currency($amount['campaign_discount_by_provider'])}}</td>
