            ...
            <div class="navbar-nav-wrap-content-right">
                ...
                <ul class="navbar-nav align-items-center flex-row">
                    <li class="nav-item max-sm-m-0 w-xxl-200px ml-auto mr-2 flex-grow-0">
                        <button type="button" id="" class="title-color bg--secondary border-0 rounded justify-content-between w-100 align-items-center py-2 px-2 px-md-3 d-flex gap-1" data-toggle="modal" data-target="#staticBackdrop">
                    ...
                    <li class="nav-item ml-3 max-sm-m-0">
                        <div class="hs-unfold">
                            <div>
                                @php($local = session()->has('provider_local')?session('provider_local'):null)
                    ...
                    <li class="nav-item d-none d-sm-inline-block mr-4">
                        ...
                        <div class="hs-unfold">
                            <a class="js-hs-unfold-invoker btn btn-icon btn-soft-secondary rounded-circle"
                               href="{{route('provider.service.message.list')}}">
                                <i class="tio-messages-outlined"></i>
                                @php($message=\App\Models\Conversation::whereUser(\App\CentralLogics\Helpers::get_provider_id())->where('unread_message_count','>','0')->count())
                                @if($message!=0)
                    ...
                    <li class="nav-item">
                        ...
                        <div class="hs-unfold">
                            <a class="js-hs-unfold-invoker navbar-dropdown-account-wrapper" href="javascript:;"
                               data-hs-unfold-options='{
                                ...
                                <div class="cmn--media right-dropdown-icon d-flex align-items-center">
                                    <div class="media-body pl-0 pr-2">
                                        <span class="card-title h5 text-right">
                                            {{\App\CentralLogics\Helpers::get_provider_data()->full_name}}
                                        </span>
                                        <span class="card-text">{{\App\CentralLogics\Helpers::get_provider_data()->email}}</span>
                                    </div>
                                    <div class="avatar avatar-sm avatar-circle">
                                        <img class="avatar-img  onerror-image aspect-1-1"  data-onerror-image="{{asset('public/assets/admin/img/160x160/img1.jpg')}}"
                                        src="{{ \App\CentralLogics\Helpers::get_provider_data()->toArray()['logo_full_path'] }}"
                                ...
                                <div class="cmn--media right-dropdown-icon d-flex align-items-center">
                                    <div class="media-body pl-0 pr-2">
                                        <span class="card-title h5 text-right">
                                            {{\App\CentralLogics\Helpers::get_provider_loggedin_user()->f_name}}
                                            {{\App\CentralLogics\Helpers::get_provider_loggedin_user()->l_name}}
                                        </span>
                                        <span class="card-text">{{\App\CentralLogics\Helpers::get_provider_loggedin_user()->email}}</span>
                                    </div>
                                    <div class="avatar avatar-sm avatar-circle">
                                        <img class="avatar-img  onerror-image aspect-1-1"  data-onerror-image="{{asset('public/assets/admin/img/160x160/img1.jpg')}}"
                                             src="{{ \App\CentralLogics\Helpers::get_provider_loggedin_user()->toArray()['image_full_url'] }}"
                                             alt="Image Description">
                                        <span class="avatar-status avatar-sm-status avatar-status-success"></span>
                                    </div>
                                </div>
                            ...
                            <div id="accountNavbarDropdown"
                                ...
                                <div class="dropdown-item-text">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            <span class="card-title h5">{{\App\CentralLogics\Helpers::get_provider_data()->full_name}}</span>
                                            <span class="card-text">{{\App\CentralLogics\Helpers::get_provider_data()->email}}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <a class="dropdown-item" href="{{route('provider.service.profile.update')}}">
        ...
        <div class="modal-content modal-content__search border-0">
            <div class="d-flex flex-column gap-3 rounded-20 bg-card py-2 px-3">
                <div class="d-flex gap-2 align-items-center position-relative">
                    <form class="flex-grow-1" id="searchForm" action="{{ route('provider.search.routing') }}">
                        @csrf
