            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div class="card">
                    ...
                    <div class="card-body p-0 initial--11"  id="conversation-list">
                        ...
                        @include('service::provider.messages.data')
                    </div>
                    <!-- End Body -->
                </div>
                <!-- End Card -->
...
<script src="{{ asset('public/assets/admin/js/spartan-multi-image-picker.js') }}"></script>
    <script>
        ...
        function viewConvs(url, id_to_active, conv_id, sender_id) {
            ...
            let new_url= "{{ route('provider.service.message.list') }}" + '?conversation=' + conv_id+ '&user=' + sender_id;
            $.get({
                url: url,
        ...
        function loadMoreData(page) {
            $.ajax({
                    url: "{{ route('provider.service.message.list') }}" + '?page=' + page,
                    type: "get",
                    beforeSend: function() {
        ...
        function fetch_data(page, query) {
            $.ajax({
                url: "{{ route('provider.service.message.list') }}" + '?page=' + page + "&key=" + query,
                success: function(data) {
