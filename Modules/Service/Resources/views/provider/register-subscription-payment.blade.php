...
@section('content')
    <section class="m-0 py-5">
        <div class="container">
            ...
            <form class="reg-form js-validate" action="{{ route('service.provider.payment') }}" method="post">
                @csrf
                ...
                <div class="card __card mb-3 pt-4">
                    ...
                    <div class="card-body p-4 pt-0">
                        ...
                        <div class="text-end pt-5 d-flex flex-wrap justify-content-end gap-3">
                            <a  href="{{ route('restaurant.back',['provider_id' => $provider_id] ) }}" type="button" class="cmn--btn btn--secondary shadow-none rounded-md border-0 outline-0">{{ translate('Back')
                                }}</a>
