...
<div class="content container-fluid">
    ...
    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-20">
        ...
        <div class="d-flex gap-2 align-items-center flex-wrap">
            ...
            <a href="{{ route('provider.service.serviceman.edit', ['id' => $serviceman->id]) }}" class="btn btn--primary">
...
{{--                            <span class="" data-text-color="#1C8EFF" data-toggle="tooltip" data-placement="left" data-original-title="{{translate('messages.content_need')}}">--}}
{{--                                <i class="tio-info"></i>--}}
{{--                            </span>--}}
                        </div>
                    </div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            @if(is_array($serviceman?->identification_images) && count($serviceman?->identification_images) > 0)
                <h4 class="mb-20">{{ translate('messages.identity_image') }}</h4>
                <div class="row g-3">
                    @foreach($serviceman?->identification_images as $image)
...
@push('script_2')
    ...
    <script>
        ...
        $("#date-range").change(function () {
            location.href = "{{ route('provider.service.serviceman.details', [$serviceman->id]) }}?date_range=" + $(this).val();
        });
