...
@section('title', translate('messages.Edit Serviceman'))
...
@section('content')
    <div class="content container-fluid">
            ...
            <div class="d-flex justify-content-between flex-wrap gap-3">
                <div>
                    <h1 class="page-header-title text-break">
                        ...
                        <span>{{ translate('messages.Edit Serviceman') }}
                    </span> </h1>
        ...
        <!-- End Page Header -->
        <form action="{{ route('provider.service.serviceman.update', ['id' => $serviceman->id]) }}" method="post" enctype="multipart/form-data" id="providerFormSubmit">
            @csrf
            @method('put')
                                    ...
                                    <div class="col-lg-6">
                                                ...
                                                <div class="lang_form" id="default-form">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="first_name" id="first_name"
                                                            class="form-control"
                                                            placeholder="{{ translate('messages.first_name') }}" value="{{ $serviceman->first_name }}" required>
                                                    </div>
                                                    <div class="form-group mb-0">
                                                        ...
                                                        <input type="text" name="last_name" id="last_name"
                                                            class="form-control"
                                                            placeholder="{{ translate('messages.last_name') }}" value="{{ $serviceman->last_name }}" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group mb-0 mt-3">
                                            ...
                                            <input type="email" name="email" class="form-control" id="email"
                                                   ...
                                                   value="{{ $serviceman->email }}" required>
                                        </div>
                                ...
                                <div class="row g-4">
                                    <div class="col-md-6">
                                        ...
                                        <select name="identity_type" id="identity_type" class="form-control js-select2-custom"
                                            ...
                                            <option value="passport"
                                                {{ $serviceman->identification_type == 'passport' ? 'selected': ''}}>
                                                {{translate('Passport')}}</option>
                                            <option value="driving_license"
                                                {{ $serviceman->identification_type == 'driving_license' ? 'selected': ''}}>
                                                {{translate('Driving_License')}}</option>
                                            <option value="nid"
                                                {{ $serviceman->identification_type == 'nid' ? 'selected': ''}}>
                                                {{translate('nid')}}</option>
                                            <option value="trade_license"
                                                {{ $serviceman->identification_type == 'trade_license' ? 'selected': ''}}>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-0">
                                            ...
                                            <input type="text" class="form-control h--45px" name="identity_number" value="{{ $serviceman->identification_number }}" id="identification_number" placeholder="{{ translate('messages.type_your_identification_number') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div>
                                            ...
                                            <div class="row">
                                                @if(count($serviceman?->identification_image_full_path ?? []) > 0)
                                                    <div class="col-lg-6">
                                                        <h5>{{ translate('messages.available_images') }}</h5>
                                                        <div class="row">
                                                            @foreach($serviceman?->identification_image_full_path ?? [] as $img)
                                ...
                                <div class="row g-3">
                                    <div class="col-md-4 col-sm-6">
                                        <div class="form-group mb-0">
                                            ...
                                            <input type="tel" id="phone" name="phone" value="{{ $serviceman->phone }}" class="form-control"
                                        ...
                                        <div class="js-form-message form-group mb-0">
                                            ...
                                            <div class="input-group input-group-merge">
                                                <input type="password" class="js-toggle-password form-control"
                                                    ...
                                                    placeholder="{{ translate('messages.8+ characters') }}"
