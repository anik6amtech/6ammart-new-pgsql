...
class Service extends Model
{
    ...
    protected $table = 'service_services';
    ...
    public function getThumbnailFullPathAttribute()
    {
        ...
        $defaultPath = request()->is('*/edit/*') ? asset('public/assets/admin/img/media/upload-file.png') : asset('public/assets/admin/img/placeholder.png');
        ...
        static::addGlobalScope('zone_wise_data', function (Builder $builder) {
            if (request()->is('api/*/customer?*') || request()->is('api/*/customer/*')) {
                $builder->whereHas('category.zones', function ($query) {
                    $query->where('zone_id', request()->headers->get('zoneId'));
