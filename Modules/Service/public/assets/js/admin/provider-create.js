        ...
        $(document).on('ready', function() {
            ...
            $('#nextStep').on('click', function (e) {
                ...
                const messages = {
                    ...
                    storeBusinessPhoneRequired: dataSet.getAttribute("data-store-business-phone-required"),
                    ...
                    identityTypeRequired: dataSet.getAttribute("data-identity-type-required"),
                    identificationNumberRequired: dataSet.getAttribute("data-identification-number-required"),

                };

                let hasError = false;
                // const fileInputs = document.querySelectorAll('input[type="file"]');
                const fileInputs = document.querySelectorAll('.req-file[type="file"]');
                ...
                if ($('#business_phone').val().length  < 5) {
                    toastr.error(messages.storeBusinessPhoneRequired);
                    hasError = true;
                }
                if (!$('#choice_zones').val()) {
               ...
               //  }
                ...
                if ($('#identity_type').val().length === 0) {
                    toastr.error(messages.identityTypeRequired);
                    hasError = true;
                }
                if ($('#identification_number').val().length === 0) {
                    toastr.error(messages.identificationNumberRequired);
                    hasError = true;
                }
                if ($('#signupSrPassword').val().length === 0) {
                    toastr.error(messages.passwordRequired);
                    hasError = true;
                }
                if ($('#signupSrConfirmPassword').val() !== $('#signupSrPassword').val()) {
