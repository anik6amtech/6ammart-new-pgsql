...
class ExpenseReportController extends Controller
{
    ...
    public function getBusinessExpenseReport(Request $request)
    {
        ...
        return view('service::provider.report.business.expense', compact('zones', 'categories', 'subCategories', 'filteredBookingAmounts', 'chartData', 'totalPromotionalCost', 'deterministic', 'queryParams'));
    }
