...
namespace Modules\Service\Http\Controllers\Web\Provider\Report\Business;
...
class EarningReportController extends Controller
{
    ...
    public function getBusinessEarningReport(Request $request)
    {
        ...
        return view('service::provider.report.business.earning', compact('zones', 'categories', 'subCategories', 'bookings', 'chartData', 'queryParams'));
    }
