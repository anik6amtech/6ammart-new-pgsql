...
class OverviewReportController extends Controller
{
    ...
    public function getBusinessOverviewReport(Request $request)
    {
        ...
        return view('service::provider.report.business.overview', compact('zones', 'categories', 'subCategories', 'amounts', 'chartData', 'totalPromotionalCost', 'deterministic', 'queryParams'));
    }
