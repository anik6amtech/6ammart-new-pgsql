...
use Modules\Service\Http\Requests\Admin\PromotionManagement\AdvertisementStoreRequest;
use Modules\Service\Http\Requests\Admin\PromotionManagement\AdvertisementUpdateRequest;
...
class AdvertisementController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view("service::admin.promotion-management.advertisement.list",compact('adds','total_adds','ads_count'));
    }
    ...
    public function requestList(Request $request)
    {
        ...
        ->count();
        return view("service::admin.promotion-management.advertisement.request-list",compact('adds','count','type'));
    }
    ...
    public function create()
    {
        ...
        ->count()+1;
        return view("service::admin.promotion-management.advertisement.create",compact('total_adds','defaultLang','language'));
    }
    ...
    public function store(AdvertisementStoreRequest $request)
    {
        ...
        try {
            ...
            if( Helpers::getNotificationStatusData('store','store_advertisement_create_by_admin','push_notification_status' ,$advertisement?->store?->id) && $advertisement?->store?->vendor?->firebase_token ){
                ...
                Helpers::send_push_notif_to_device($advertisement->store->fcm_token, $data);
                DB::table('user_notifications')->insert([
                    'data' => json_encode($data),
                    'vendor_id' => $advertisement->store->id,
                    'created_at' => now(),
                    'updated_at' => now()
                ]);
            }
    ...
    public function show($advertisement,Request $request)
    {
        ...
        $advertisement= Advertisement::where('id',$advertisement)->withoutGlobalScope('translate')->with('translations')->firstOrFail();
        return view("service::admin.promotion-management.advertisement.details",compact('advertisement','nextId','previousId','request_page_type','language','defaultLang'));
    }
    ...
    public function edit(Request $request,Advertisement $advertisement)
    {
        ...
        ->count()+1;
        return view("service::admin.promotion-management.advertisement.edit",compact('advertisement','total_adds','request_page_type','language','defaultLang'));
    }
    ...
    public function status(Request $request)
    {
        ...
        try {
            if( $push_notification_status  && $advertisement?->store?->fcm_token ){
    ...
    public function update(AdvertisementUpdateRequest $request, Advertisement $advertisement)
    {
        ...
        try {
            if(  Helpers::getNotificationStatusData('store','store_advertisement_approval','push_notification_status' ,$advertisement?->store?->id)  && $advertisement?->store?->fcm_token && $request?->request_page_type ){
    ...
    public function copyAdd(Advertisement $advertisement)
    {
        ...
        ->count()+1;
        return view("service::admin.promotion-management.advertisement.edit",compact('advertisement','total_adds','language','defaultLang'));
    }
    ...
    public function copyAddPost(Advertisement $advertisement , AdvertisementUpdateRequest $request)
    {
        ...
        $newAdvertisement->module_id= $this->currentModuleId();
        $newAdvertisement->module_type= 'service';
        ...
        try {
            ...
            if( Helpers::getNotificationStatusData('store','store_advertisement_create_by_admin','push_notification_status',$newAdvertisement?->store?->id ) && $newAdvertisement?->store?->fcm_token ){
                ...
                Helpers::send_push_notif_to_device($newAdvertisement->store->fcm_token, $data);
                DB::table('user_notifications')->insert([
                    'data' => json_encode($data),
                    'vendor_id' => $newAdvertisement->store->id,
                    'created_at' => now(),
                    'updated_at' => now()
                ]);
            }
