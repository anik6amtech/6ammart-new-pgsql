...
namespace Modules\Service\Http\Controllers\Web\Admin\Report\Business;
...
class EarningReportController extends Controller
{
    ...
    protected StoreSubscription $packageSubscriber;

    public function __construct(Zone $zone, SubscriptionPackage $subscriptionPackage, StoreSubscription $packageSubscriber, Provider $provider, Category $categories, Service $service, Booking $booking, UserAccount $account, User $user, Transaction $transaction, BookingDetailsAmount $bookingDetailsAmount)
    {
        $this->zone = $zone;
...
// Merge logic here remains unchanged
        ...
        return view('service::admin.report.business.earning', compact('zones', 'categories', 'sub_categories', 'bookings', 'chart_data', 'queryParams'));
    }
    ...
    public function getBusinessSubscriptionEarningReport(Request $request): Renderable
    {
        ...
        return view('service::admin.report.business.subscription-earning', compact('subscriptionPackages', 'packagesSubscribers', 'subscriptionTotal', 'chartData', 'categories', 'pieChartData', 'packagesSubscriber', 'search', 'filter', 'barFilter'));
    }
    ...
    public function getBusinessCommissionEarningReport(Request $request)
    {
        ...
        $activeProvider = $allProvidersQuery->clone()->active()->count();
        ...
        return view('service::admin.report.business.comission-earning', compact('commissionEarning', 'commissionEarningList', 'providers','categories', 'chartData', 'barFilter', 'filter', 'search'));
    }
