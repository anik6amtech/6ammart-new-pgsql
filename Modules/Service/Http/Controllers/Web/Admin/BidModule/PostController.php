...
namespace Modules\Service\Http\Controllers\Web\Admin\BidModule;

use Brian2694\Toastr\Facades\Toastr;
use Illuminate\Contracts\Support\Renderable;
use Maatwebsite\Excel\Facades\Excel;
use Modules\Service\Exports\BidModuleExport;
...
use Modules\Service\Entities\BidModule\PostAdditionalInformation;
...
//        private PushNotification $pushNotification,
    ...
    public function index(Request $request)
    {
        ...
        return view('service::admin.BidModule.list', compact('posts', 'type', 'search', 'category_id', 'start_date', 'end_date', 'select_date', 'queryParams', 'categories','filterCounter'));
    }
    ...
    public function export(Request $request)
    {
        ...
        return Excel::download(new BidModuleExport($data), 'Customized-Requests.xlsx');
    }
    ...
    public function details($post_id): Renderable|RedirectResponse
    {
        ...
        return view('service::admin.BidModule.details', compact('post', 'distance'));
    }
    ...
    public function delete($post_id, Request $request): RedirectResponse
    {
        ...
        if (!isset($post)) {
            Toastr::success(translate(DEFAULT_404['message']));
            return redirect()->route('admin.service.booking.post.list');
        }
...
//        TODO: need to add push notification store for post deletion
...
//        $pushNotification->save();
        ...
        if (!is_null($fcmToken) && $permission) {
            $title = get_push_notification_message('user_customized_booking_request_delete', $languageKey);
        ...
        return redirect()->route('admin.service.booking.post.list',  ['type'=>'all']);
    }
