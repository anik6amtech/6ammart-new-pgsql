...
class TransactionReportController extends Controller
{
    ...
    public function getTransactionReport(Request $request): JsonResponse
    {
        ...
        $zones = $this->zone->active()->select('id', 'name')->whereIn('id', $providerZones)->get();
        ...
        $filteredTransactions = $this->transaction
            ...
            ->where(function ($query) use ($request) {
                $query->where('to_user_id', $request->user('provider')->id)->orWhere('from_user_id', $request->user('provider')->id);
            })
        ...
        $accountInfo = UserAccount::where('user_id', $request->user('provider')->id)->first();
