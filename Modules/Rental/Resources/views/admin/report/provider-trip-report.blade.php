                ...
                <div class="card h-100 bg-white payment-statistics-shadow">
                    ...
                    <div class="card-body px-0 pt-0">
                        ...
                        <div class="earning-statistics-content mt-3">
                            @if($trips->count() > 0)
                            <a href="{{ route('admin.rental.trip.list', ['status' =>'all', 'module_id' => $trips->first()->module_id]) }}" class="trx-btn">{{ translate('View All Trips') }}</a>
                            @else
                                <a href="#" class="trx-btn">{{ translate('View All Trips') }}</a>
                            @endif
                        </div>
                    </div>
                </div>
