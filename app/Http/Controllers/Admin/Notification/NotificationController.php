...
class NotificationController extends BaseController
{
    ...
    private function getAddView($request): View
    {
        ...
        $userTypes = $this->notificationService->getUserTypes();
        return view(NotificationViewPath::INDEX[VIEW], compact('notifications','zones','userTypes'));
    }
    ...
    public function getUpdateView(string|int $id): View
    {
        ...
        $zones = $this->zoneRepo->getList();
        $userTypes = $this->notificationService->getUserTypes();
        return view(NotificationViewPath::UPDATE[VIEW], compact('notification','zones','userTypes'));
    }
