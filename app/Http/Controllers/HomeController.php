...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $landing_data = [
            ...
            'earning_provider_image' => (isset($settings['earning_provider_image']))  ? $settings['earning_provider_image'] : null,
            'earning_provider_image_storage' => (isset($settings['earning_provider_image_storage']))  ? $settings['earning_provider_image_storage'] : 'public',
            'earning_serviceman_image' => (isset($settings['earning_serviceman_image']))  ? $settings['earning_serviceman_image'] : null,
            'earning_serviceman_image_storage' => (isset($settings['earning_serviceman_image_storage']))  ? $settings['earning_serviceman_image_storage'] : 'public',
            ...
            'provider_app_earning_links' => (isset($settings['provider_app_earning_links']))  ? json_decode($settings['provider_app_earning_links'], true) : null,
            'serviceman_app_earning_links' => (isset($settings['serviceman_app_earning_links']))  ? json_decode($settings['serviceman_app_earning_links'], true) : null,
