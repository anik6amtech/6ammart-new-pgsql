...
class ConfigController extends Controller
{
    ...
    public function configuration()
    {
        ...
        $advancedBooking = [
            'advanced_booking_restriction_value_status' => (int)business_config('time_restriction_on_schedule_booking', 'service_business_settings')?->value ?? 0,
            'advanced_booking_restriction_value' => (int)business_config('time_restriction_on_schedule_booking_value', 'service_business_settings')?->value ?? 0,
            'advanced_booking_restriction_type' => business_config('time_restriction_on_schedule_booking_value_type', 'service_business_settings')?->value ?? 'hours',
        ];
        ...
        return response()->json([
            ...
            'ride_vat' => isset($rideConfigs['ride_vat']) ? (float)($rideConfigs['ride_vat'] ?? 0) : 0,
            ...
            'rider_level_feature_status' => isset($rideConfigs['rider_level_feature_status']) ? (int)($rideConfigs['rider_level_feature_status'] ?? 0) : 0,
            'driver_can_review_customer' => isset($rideConfigs['driver_can_review_customer']) ? (int)($rideConfigs['driver_can_review_customer'] ?? 0) : 0,
            'ride_request_active_time' => isset($rideConfigs['ride_request_active_time']) ? (int)($rideConfigs['ride_request_active_time'] ?? 0) : 0,

            'service_at_provider_place' => (int)((business_config('service_at_provider_place', 'service_business_settings'))->value ?? 0),
            'repeat_booking' => (int)((business_config('repeat_booking', 'service_business_settings'))->value ?? 0),
            'schedule_booking' => (int)((business_config('schedule_booking', 'service_business_settings'))->value ?? ''),
            'instant_booking' => ((business_config('instant_booking', 'service_business_settings'))->value ?? ''),
            'direct_provider_booking' => (int)((business_config('direct_provider_booking', 'service_business_settings'))->value ?? 0),
            'max_booking_amount' => ((business_config('maximum_booking_amount', 'service_business_settings'))->value ?? 0.00),
            'min_booking_amount' => ((business_config('minimum_booking_amount', 'service_business_settings'))->value ?? 0.00),
            'confirm_otp_for_complete_service' => (int)((business_config('otp_for_complete_service', 'service_business_settings'))->value ?? 0),
            'bidding_status' => (int)((business_config('bidding_system', 'service_business_settings'))->value ?? 0),
            'advanced_booking' => $advancedBooking,

            'service_default_commission' => (int)((business_config('default_commission', 'service_business_settings'))->value ?? 0),
            'provider_commission_base' => (int)((business_config('provider_commission_base', 'service_business_settings'))->value ?? 0),
            'provider_subscription_base' => (int)((business_config('provider_subscription_base', 'service_business_settings'))->value ?? 0),
            'provider_can_cancel_booking' => (int)((business_config('provider_can_cancel_booking', 'service_business_settings'))->value ?? 0),
            'provider_self_registration' => (int)((business_config('provider_self_registration', 'service_business_settings'))->value ?? 0),
            'provider_self_delete' => (int)((business_config('provider_self_delete', 'service_business_settings'))->value ?? 0),
            'provider_minimum_payable_amount' => (int)((business_config('provider_minimum_payable_amount', 'service_business_settings'))->value ?? 0.00),
            'provider_can_edit_booking' => (int)((business_config('provider_can_edit_booking', 'service_business_settings'))->value ?? 0),
            'provider_max_cash_in_hand_limit' => (int)((business_config('provider_max_cash_in_hand_limit', 'service_business_settings'))->value ?? 0),
            'provider_suspend_on_exceed_cash_limit' => (int)((business_config('provider_suspend_on_exceed_cash_limit', 'service_business_settings'))->value ?? 0),
            'provider_see_other_providers_offers' => (int)((business_config('see_other_providers_offers', 'service_business_settings'))->value ?? 0),
            'provider_otp_for_complete_service' => (int)((business_config('otp_for_complete_service', 'service_business_settings'))->value ?? 0),
            'provider_service_complete_photo_evidence' => (int)((business_config('service_complete_photo_evidence', 'service_business_settings'))->value ?? 0),
            'serviceman_can_edit_booking' => (int)((business_config('serviceman_edit_booking', 'service_business_settings'))->value ?? 0),
            'provider_can_reply_review' => (int)((business_config('provider_can_reply_review', 'service_business_settings'))->value ?? 0),
            'service_at_provider_place' => (int)((business_config('service_at_provider_place', 'service_business_settings'))->value ?? 0),
            'serviceman_can_cancel_booking' => (int)((business_config('serviceman_can_cancel_booking', 'service_business_settings'))->value ?? 0),
            'rider_referral_earning_status' => (int)($rideConfigs['driver_referral_earning_status'] ?? 0),
            'ride_otp_confirmation' => (int)($rideConfigs['ride_otp_confirmation'] ?? 0),
            'rider_loyalty_point_exchange_rate' => (int)(isset($settings['dm_loyalty_point_exchange_rate']) ? $settings['dm_loyalty_point_exchange_rate'] : 0),
            'rider_faqs' => QuestionAnswer::where('question_answer_for', DRIVER)->get(),
        ]);
    }

    public function rideConfigs() {
        $keys = [
            'driver_can_review_customer',
            ...
            'bid_on_fare',
            'driver_referral_earning_status',
            'ride_otp_confirmation',
            'rider_level_feature_status',
    ...
    {
        $data = RiderVehicleCategory::active()->get();
    ...
    public function deliveryman_faq() {

        $automated_message = QuestionAnswer::where('question_answer_for', DRIVER)->get();
        return response()->json($automated_message, 200);
