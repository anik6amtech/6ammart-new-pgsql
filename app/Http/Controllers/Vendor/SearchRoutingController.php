    ...
    public function index(Request $request)
    {
        ...
        if (is_numeric($searchKeyword) &&   $searchKeyword > 0) {
            ...
            if ($store_data->store_business_model !== 'commission') {
                //subscriber
                $storeSubscription = StoreSubscription::where('store_id', $store_id)->where('store_type', 'store')->find($searchKeyword);
                ...
                //subscriber
                $storeSubscriptionBillingAndRefundHistory = SubscriptionBillingAndRefundHistory::where('store_id', $store_id)->where('store_type', 'store')->find($searchKeyword);
            ...
            if ($store_data->store_business_model !== 'commission') {
                ...
                //Store Subscription
                $storeSubscriptions = StoreSubscription::with('package')->where('store_id', $store_id)->where('store_type', 'store')
