...
class Store extends Model
{
    ...
    {
        return $this->hasOne(StoreSubscription::class)->where('status',1)->where('store_type', 'store')->latestOfMany();
    }
    /**
     * @return HasMany
     */
    ...
    {
        return $this->hasMany(StoreSubscription::class,'store_id')->where('store_type', 'store');
    }
    /**
     * @return HasOne
     */
    ...
    {
        return $this->hasOne(SubscriptionTransaction::class)->where('store_type', 'store')->latest();
    }
    public function store_all_sub_trans(): HasMany
    {
        return $this->hasMany(SubscriptionTransaction::class)->where('store_type', 'store');
    }
    /**
     * @return HasOne
     */
    ...
    {
        return $this->hasOne(StoreSubscription::class)->where('store_type', 'store')->latestOfMany();
    }
