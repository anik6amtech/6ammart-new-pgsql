...
use App\Http\Controllers\Admin\ChattingSetupQuestionAnswerController;
use App\Http\Controllers\Admin\ChattingSetupSupportCenterController;
...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin', 'current-module']], function () {
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.', 'middleware' => ['module:settings', 'actch']], function () {
            Route::get('business-setup/{tab?}/{subTab?}', 'BusinessSettingsController@business_index')->name('business-setup');
            ...
            Route::group(['prefix' => 'chatting-setup/question-answer', 'as' => 'chatting-setup.question-answer.'], function () {
                Route::post('store', [ChattingSetupQuestionAnswerController::class, 'store'])->name('store');
                Route::post('update/{id}', [ChattingSetupQuestionAnswerController::class, 'update'])->name('update');
                Route::delete('delete/{id}', [ChattingSetupQuestionAnswerController::class, 'destroy'])->name('delete');
                Route::get('status', [ChattingSetupQuestionAnswerController::class, 'status'])->name('status');
            });
            Route::group(['prefix' => 'chatting-setup/support-center', 'as' => 'chatting-setup.support-center.'], function () {
                Route::post('store', [ChattingSetupSupportCenterController::class, 'store'])->name('store');
                Route::post('update/{id}', [ChattingSetupSupportCenterController::class, 'update'])->name('update');
                Route::delete('delete/{id}', [ChattingSetupSupportCenterController::class, 'destroy'])->name('delete');
                Route::get('status', [ChattingSetupSupportCenterController::class, 'status'])->name('status');
            });
        ...
        Route::group(['prefix' => 'users', 'as' => 'users.'], function () {
            ...
            Route::group(['prefix' => 'customer', 'as' => 'customer.', 'middleware' => ['module:customer_management']], function () {
                ...
                Route::get('view/{user_id}', 'CustomerController@view')->name('view');
                Route::get('ride-share-view/{user_id}', 'CustomerController@rideShareView')->name('ride-share.view');
                Route::get('service-view/{user_id}', 'CustomerController@serviceView')->name('service.view');
                Route::post('search', 'CustomerController@search')->name('search');
            ...
            Route::group(['prefix' => 'delivery-man', 'as' => 'delivery-man.', 'middleware' => ['module:deliveryman']], function () {
                Route::group(['prefix' => 'vehicle', 'as' => 'vehicle.'], function () {
                    Route::get('/', 'RiderVehicleController@index')->name('index');
                    Route::get('create', 'RiderVehicleController@create')->name('create');
                    Route::post('store', 'RiderVehicleController@store')->name('store');
                    Route::get('edit/{id}', 'RiderVehicleController@edit')->name('edit');
                    Route::put('update/{id}', 'RiderVehicleController@update')->name('update');
                    Route::delete('delete/{id}', 'RiderVehicleController@destroy')->name('delete');
                    Route::get('status', 'RiderVehicleController@status')->name('status');
                    Route::get('show/{id}', 'RiderVehicleController@show')->name('show');
                    Route::get('export', 'RiderVehicleController@export')->name('export');
                    Route::delete('permanent-delete/{id}', 'RiderVehicleController@permanentDelete')->name('permanent-delete');
                    Route::group(['prefix' => 'request', 'as' => 'request.'], function () {
                        Route::get('list/{status}', 'RiderVehicleController@newVehicleRequestList')->name('list');
                        Route::get('export', 'RiderVehicleController@exportVehicleRequest')->name('export');
                        Route::get('details/{id}', 'RiderVehicleController@requestedVehicleInfo')->name('details');
                        Route::get('edit/{id}', 'RiderVehicleController@editVehicleRequest')->name('edit');
                        Route::put('approved/{id}', 'RiderVehicleController@approvedVehicleRequest')->name('approved');
                        Route::put('denied/{id}', 'RiderVehicleController@deniedVehicleRequest')->name('denied');
                    });
                    Route::group(['prefix' => 'update', 'as' => 'update.'], function () {
                        Route::get('list', 'RiderVehicleController@newVehicleUpdateList')->name('list');
                        Route::get('export', 'RiderVehicleController@exportVehicleUpdate')->name('export');
                        Route::get('details/{id}', 'RiderVehicleController@updatedVehicleInfo')->name('details');
                        Route::get('edit/{id}', 'RiderVehicleController@editVehicleUpdate')->name('edit');
                        Route::put('approved/{id}', 'RiderVehicleController@approvedVehicleUpdate')->name('approved');
                        Route::put('denied/{id}', 'RiderVehicleController@deniedVehicleUpdate')->name('denied');
                    });
                    Route::group(['prefix' => 'brand', 'as' => 'brand.'], function () {
                        Route::get('/', 'RiderVehicleBrandController@index')->name('index');
                        Route::post('store', 'RiderVehicleBrandController@store')->name('store');
                        Route::get('edit/{id}', 'RiderVehicleBrandController@edit')->name('edit');
                        Route::put('update/{id}', 'RiderVehicleBrandController@update')->name('update');
                        Route::delete('delete/{id}', 'RiderVehicleBrandController@destroy')->name('delete');
                        Route::get('status', 'RiderVehicleBrandController@status')->name('status');
                        Route::get('export', 'RiderVehicleBrandController@export')->name('export');
                        Route::get('all-brands', 'RiderVehicleBrandController@getAllAjax')->name('all-brands');
                    });
                    Route::group(['prefix' => 'model', 'as' => 'model.'], function () {
                        Route::get('/', 'RiderVehicleModelController@index')->name('index');
                        Route::post('store', 'RiderVehicleModelController@store')->name('store');
                        Route::get('edit/{id}', 'RiderVehicleModelController@edit')->name('edit');
                        Route::put('update/{id}', 'RiderVehicleModelController@update')->name('update');
                        Route::delete('delete/{id}', 'RiderVehicleModelController@destroy')->name('delete');
                        Route::get('status', 'RiderVehicleModelController@status')->name('status');
                        Route::get('export', 'RiderVehicleModelController@export')->name('export');
                        Route::get('all-models', 'RiderVehicleModelController@getAllAjax')->name('all-models');
                        Route::get('ajax-models/{id}', 'RiderVehicleModelController@ajax_models')->name('ajax-models');
                    });
                    Route::group(['prefix' => 'category', 'as' => 'category.'], function () {
                        Route::get('/', 'RiderVehicleCategoryController@index')->name('index');
                        Route::post('store', 'RiderVehicleCategoryController@store')->name('store');
                        Route::get('edit/{id}', 'RiderVehicleCategoryController@edit')->name('edit');
                        Route::put('update/{id}', 'RiderVehicleCategoryController@update')->name('update');
                        Route::delete('delete/{id}', 'RiderVehicleCategoryController@destroy')->name('delete');
                        Route::get('status', 'RiderVehicleCategoryController@status')->name('status');
                        Route::get('export', 'RiderVehicleCategoryController@export')->name('export');
                        Route::get('all-categories', 'RiderVehicleCategoryController@getAllAjax')->name('all-categories');
                    });
                });

                Route::group(['prefix' => 'level', 'as' => 'level.'], function () {
                    Route::get('/', 'RiderLevelController@index')->name('index');
                    Route::get('create', 'RiderLevelController@create')->name('create');
                    Route::post('store', 'RiderLevelController@store')->name('store');
                    Route::get('edit/{id}', 'RiderLevelController@edit')->name('edit');
                    Route::delete('delete/{id}', 'RiderLevelController@destroy')->name('delete');
                    Route::put('update/{id}', 'RiderLevelController@update')->name('update');
                    Route::get('status', 'RiderLevelController@status')->name('status');
                    Route::get('statistics', 'RiderLevelController@statistics')->name('statistics');
                    Route::get('export', 'RiderLevelController@export')->name('export');

                    Route::group(['prefix' => 'access', 'as' => 'access.'], function () {
                        Route::get('store', 'LevelAccessController@store')->name('store');
                    });
                });
            });
